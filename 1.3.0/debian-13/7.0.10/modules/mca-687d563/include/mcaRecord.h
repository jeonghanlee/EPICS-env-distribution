...
static int mcaRecordSizeOffset(dbRecordType *prt)
{
    ...
    prt->papFldDes[mcaRecordNAME]->offset = (unsigned short)offsetof(mcaRecord, name);
    prt->papFldDes[mcaRecordDESC]->size = sizeof(prec->desc);
    prt->papFldDes[mcaRecordDESC]->offset = (unsigned short)offsetof(mcaRecord, desc);
    prt->papFldDes[mcaRecordASG]->size = sizeof(prec->asg);
    prt->papFldDes[mcaRecordASG]->offset = (unsigned short)offsetof(mcaRecord, asg);
    prt->papFldDes[mcaRecordSCAN]->size = sizeof(prec->scan);
    prt->papFldDes[mcaRecordSCAN]->offset = (unsigned short)offsetof(mcaRecord, scan);
    prt->papFldDes[mcaRecordPINI]->size = sizeof(prec->pini);
    prt->papFldDes[mcaRecordPINI]->offset = (unsigned short)offsetof(mcaRecord, pini);
    prt->papFldDes[mcaRecordPHAS]->size = sizeof(prec->phas);
    prt->papFldDes[mcaRecordPHAS]->offset = (unsigned short)offsetof(mcaRecord, phas);
    prt->papFldDes[mcaRecordEVNT]->size = sizeof(prec->evnt);
    prt->papFldDes[mcaRecordEVNT]->offset = (unsigned short)offsetof(mcaRecord, evnt);
    prt->papFldDes[mcaRecordTSE]->size = sizeof(prec->tse);
    prt->papFldDes[mcaRecordTSE]->offset = (unsigned short)offsetof(mcaRecord, tse);
    prt->papFldDes[mcaRecordTSEL]->size = sizeof(prec->tsel);
    prt->papFldDes[mcaRecordTSEL]->offset = (unsigned short)offsetof(mcaRecord, tsel);
    prt->papFldDes[mcaRecordDTYP]->size = sizeof(prec->dtyp);
    prt->papFldDes[mcaRecordDTYP]->offset = (unsigned short)offsetof(mcaRecord, dtyp);
    prt->papFldDes[mcaRecordDISV]->size = sizeof(prec->disv);
    prt->papFldDes[mcaRecordDISV]->offset = (unsigned short)offsetof(mcaRecord, disv);
    prt->papFldDes[mcaRecordDISA]->size = sizeof(prec->disa);
    prt->papFldDes[mcaRecordDISA]->offset = (unsigned short)offsetof(mcaRecord, disa);
    prt->papFldDes[mcaRecordSDIS]->size = sizeof(prec->sdis);
    prt->papFldDes[mcaRecordSDIS]->offset = (unsigned short)offsetof(mcaRecord, sdis);
    prt->papFldDes[mcaRecordMLOK]->size = sizeof(prec->mlok);
    prt->papFldDes[mcaRecordMLOK]->offset = (unsigned short)offsetof(mcaRecord, mlok);
    prt->papFldDes[mcaRecordMLIS]->size = sizeof(prec->mlis);
    prt->papFldDes[mcaRecordMLIS]->offset = (unsigned short)offsetof(mcaRecord, mlis);
    prt->papFldDes[mcaRecordBKLNK]->size = sizeof(prec->bklnk);
    prt->papFldDes[mcaRecordBKLNK]->offset = (unsigned short)offsetof(mcaRecord, bklnk);
    prt->papFldDes[mcaRecordDISP]->size = sizeof(prec->disp);
    prt->papFldDes[mcaRecordDISP]->offset = (unsigned short)offsetof(mcaRecord, disp);
    prt->papFldDes[mcaRecordPROC]->size = sizeof(prec->proc);
    prt->papFldDes[mcaRecordPROC]->offset = (unsigned short)offsetof(mcaRecord, proc);
    prt->papFldDes[mcaRecordSTAT]->size = sizeof(prec->stat);
    prt->papFldDes[mcaRecordSTAT]->offset = (unsigned short)offsetof(mcaRecord, stat);
    prt->papFldDes[mcaRecordSEVR]->size = sizeof(prec->sevr);
    prt->papFldDes[mcaRecordSEVR]->offset = (unsigned short)offsetof(mcaRecord, sevr);
    prt->papFldDes[mcaRecordAMSG]->size = sizeof(prec->amsg);
    prt->papFldDes[mcaRecordAMSG]->offset = (unsigned short)offsetof(mcaRecord, amsg);
    prt->papFldDes[mcaRecordNSTA]->size = sizeof(prec->nsta);
    prt->papFldDes[mcaRecordNSTA]->offset = (unsigned short)offsetof(mcaRecord, nsta);
    prt->papFldDes[mcaRecordNSEV]->size = sizeof(prec->nsev);
    prt->papFldDes[mcaRecordNSEV]->offset = (unsigned short)offsetof(mcaRecord, nsev);
    prt->papFldDes[mcaRecordNAMSG]->size = sizeof(prec->namsg);
    prt->papFldDes[mcaRecordNAMSG]->offset = (unsigned short)offsetof(mcaRecord, namsg);
    prt->papFldDes[mcaRecordACKS]->size = sizeof(prec->acks);
    prt->papFldDes[mcaRecordACKS]->offset = (unsigned short)offsetof(mcaRecord, acks);
    prt->papFldDes[mcaRecordACKT]->size = sizeof(prec->ackt);
    prt->papFldDes[mcaRecordACKT]->offset = (unsigned short)offsetof(mcaRecord, ackt);
    prt->papFldDes[mcaRecordDISS]->size = sizeof(prec->diss);
    prt->papFldDes[mcaRecordDISS]->offset = (unsigned short)offsetof(mcaRecord, diss);
    prt->papFldDes[mcaRecordLCNT]->size = sizeof(prec->lcnt);
    prt->papFldDes[mcaRecordLCNT]->offset = (unsigned short)offsetof(mcaRecord, lcnt);
    prt->papFldDes[mcaRecordPACT]->size = sizeof(prec->pact);
    prt->papFldDes[mcaRecordPACT]->offset = (unsigned short)offsetof(mcaRecord, pact);
    prt->papFldDes[mcaRecordPUTF]->size = sizeof(prec->putf);
    prt->papFldDes[mcaRecordPUTF]->offset = (unsigned short)offsetof(mcaRecord, putf);
    prt->papFldDes[mcaRecordRPRO]->size = sizeof(prec->rpro);
    prt->papFldDes[mcaRecordRPRO]->offset = (unsigned short)offsetof(mcaRecord, rpro);
    prt->papFldDes[mcaRecordASP]->size = sizeof(prec->asp);
    prt->papFldDes[mcaRecordASP]->offset = (unsigned short)offsetof(mcaRecord, asp);
    prt->papFldDes[mcaRecordPPN]->size = sizeof(prec->ppn);
    prt->papFldDes[mcaRecordPPN]->offset = (unsigned short)offsetof(mcaRecord, ppn);
    prt->papFldDes[mcaRecordPPNR]->size = sizeof(prec->ppnr);
    prt->papFldDes[mcaRecordPPNR]->offset = (unsigned short)offsetof(mcaRecord, ppnr);
    prt->papFldDes[mcaRecordSPVT]->size = sizeof(prec->spvt);
    prt->papFldDes[mcaRecordSPVT]->offset = (unsigned short)offsetof(mcaRecord, spvt);
    prt->papFldDes[mcaRecordRSET]->size = sizeof(prec->rset);
    prt->papFldDes[mcaRecordRSET]->offset = (unsigned short)offsetof(mcaRecord, rset);
    prt->papFldDes[mcaRecordDSET]->size = sizeof(prec->dset);
    prt->papFldDes[mcaRecordDSET]->offset = (unsigned short)offsetof(mcaRecord, dset);
    prt->papFldDes[mcaRecordDPVT]->size = sizeof(prec->dpvt);
    prt->papFldDes[mcaRecordDPVT]->offset = (unsigned short)offsetof(mcaRecord, dpvt);
    prt->papFldDes[mcaRecordRDES]->size = sizeof(prec->rdes);
    prt->papFldDes[mcaRecordRDES]->offset = (unsigned short)offsetof(mcaRecord, rdes);
    prt->papFldDes[mcaRecordLSET]->size = sizeof(prec->lset);
    prt->papFldDes[mcaRecordLSET]->offset = (unsigned short)offsetof(mcaRecord, lset);
    prt->papFldDes[mcaRecordPRIO]->size = sizeof(prec->prio);
    prt->papFldDes[mcaRecordPRIO]->offset = (unsigned short)offsetof(mcaRecord, prio);
    prt->papFldDes[mcaRecordTPRO]->size = sizeof(prec->tpro);
    prt->papFldDes[mcaRecordTPRO]->offset = (unsigned short)offsetof(mcaRecord, tpro);
    prt->papFldDes[mcaRecordBKPT]->size = sizeof(prec->bkpt);
    prt->papFldDes[mcaRecordBKPT]->offset = (unsigned short)offsetof(mcaRecord, bkpt);
    prt->papFldDes[mcaRecordUDF]->size = sizeof(prec->udf);
    prt->papFldDes[mcaRecordUDF]->offset = (unsigned short)offsetof(mcaRecord, udf);
    prt->papFldDes[mcaRecordUDFS]->size = sizeof(prec->udfs);
    prt->papFldDes[mcaRecordUDFS]->offset = (unsigned short)offsetof(mcaRecord, udfs);
    prt->papFldDes[mcaRecordTIME]->size = sizeof(prec->time);
    prt->papFldDes[mcaRecordTIME]->offset = (unsigned short)offsetof(mcaRecord, time);
    prt->papFldDes[mcaRecordUTAG]->size = sizeof(prec->utag);
    prt->papFldDes[mcaRecordUTAG]->offset = (unsigned short)offsetof(mcaRecord, utag);
    prt->papFldDes[mcaRecordFLNK]->size = sizeof(prec->flnk);
    prt->papFldDes[mcaRecordFLNK]->offset = (unsigned short)offsetof(mcaRecord, flnk);
    prt->papFldDes[mcaRecordVERS]->size = sizeof(prec->vers);
    prt->papFldDes[mcaRecordVERS]->offset = (unsigned short)offsetof(mcaRecord, vers);
    prt->papFldDes[mcaRecordVAL]->size = sizeof(prec->val);
    prt->papFldDes[mcaRecordVAL]->offset = (unsigned short)offsetof(mcaRecord, val);
    prt->papFldDes[mcaRecordBPTR]->size = sizeof(prec->bptr);
    prt->papFldDes[mcaRecordBPTR]->offset = (unsigned short)offsetof(mcaRecord, bptr);
    prt->papFldDes[mcaRecordBG]->size = sizeof(prec->bg);
    prt->papFldDes[mcaRecordBG]->offset = (unsigned short)offsetof(mcaRecord, bg);
    prt->papFldDes[mcaRecordPBG]->size = sizeof(prec->pbg);
    prt->papFldDes[mcaRecordPBG]->offset = (unsigned short)offsetof(mcaRecord, pbg);
    prt->papFldDes[mcaRecordPSTATUS]->size = sizeof(prec->pstatus);
    prt->papFldDes[mcaRecordPSTATUS]->offset = (unsigned short)offsetof(mcaRecord, pstatus);
    prt->papFldDes[mcaRecordHOPR]->size = sizeof(prec->hopr);
    prt->papFldDes[mcaRecordHOPR]->offset = (unsigned short)offsetof(mcaRecord, hopr);
    prt->papFldDes[mcaRecordLOPR]->size = sizeof(prec->lopr);
    prt->papFldDes[mcaRecordLOPR]->offset = (unsigned short)offsetof(mcaRecord, lopr);
    prt->papFldDes[mcaRecordNMAX]->size = sizeof(prec->nmax);
    prt->papFldDes[mcaRecordNMAX]->offset = (unsigned short)offsetof(mcaRecord, nmax);
    prt->papFldDes[mcaRecordNORD]->size = sizeof(prec->nord);
    prt->papFldDes[mcaRecordNORD]->offset = (unsigned short)offsetof(mcaRecord, nord);
    prt->papFldDes[mcaRecordPREC]->size = sizeof(prec->prec);
    prt->papFldDes[mcaRecordPREC]->offset = (unsigned short)offsetof(mcaRecord, prec);
    prt->papFldDes[mcaRecordFTVL]->size = sizeof(prec->ftvl);
    prt->papFldDes[mcaRecordFTVL]->offset = (unsigned short)offsetof(mcaRecord, ftvl);
    prt->papFldDes[mcaRecordSTRT]->size = sizeof(prec->strt);
    prt->papFldDes[mcaRecordSTRT]->offset = (unsigned short)offsetof(mcaRecord, strt);
    prt->papFldDes[mcaRecordERST]->size = sizeof(prec->erst);
    prt->papFldDes[mcaRecordERST]->offset = (unsigned short)offsetof(mcaRecord, erst);
    prt->papFldDes[mcaRecordSTOP]->size = sizeof(prec->stop);
    prt->papFldDes[mcaRecordSTOP]->offset = (unsigned short)offsetof(mcaRecord, stop);
    prt->papFldDes[mcaRecordACQG]->size = sizeof(prec->acqg);
    prt->papFldDes[mcaRecordACQG]->offset = (unsigned short)offsetof(mcaRecord, acqg);
    prt->papFldDes[mcaRecordREAD]->size = sizeof(prec->read);
    prt->papFldDes[mcaRecordREAD]->offset = (unsigned short)offsetof(mcaRecord, read);
    prt->papFldDes[mcaRecordRDNG]->size = sizeof(prec->rdng);
    prt->papFldDes[mcaRecordRDNG]->offset = (unsigned short)offsetof(mcaRecord, rdng);
    prt->papFldDes[mcaRecordRDNS]->size = sizeof(prec->rdns);
    prt->papFldDes[mcaRecordRDNS]->offset = (unsigned short)offsetof(mcaRecord, rdns);
    prt->papFldDes[mcaRecordERAS]->size = sizeof(prec->eras);
    prt->papFldDes[mcaRecordERAS]->offset = (unsigned short)offsetof(mcaRecord, eras);
    prt->papFldDes[mcaRecordCHAS]->size = sizeof(prec->chas);
    prt->papFldDes[mcaRecordCHAS]->offset = (unsigned short)offsetof(mcaRecord, chas);
    prt->papFldDes[mcaRecordNUSE]->size = sizeof(prec->nuse);
    prt->papFldDes[mcaRecordNUSE]->offset = (unsigned short)offsetof(mcaRecord, nuse);
    prt->papFldDes[mcaRecordSEQ]->size = sizeof(prec->seq);
    prt->papFldDes[mcaRecordSEQ]->offset = (unsigned short)offsetof(mcaRecord, seq);
    prt->papFldDes[mcaRecordDWEL]->size = sizeof(prec->dwel);
    prt->papFldDes[mcaRecordDWEL]->offset = (unsigned short)offsetof(mcaRecord, dwel);
    prt->papFldDes[mcaRecordPSCL]->size = sizeof(prec->pscl);
    prt->papFldDes[mcaRecordPSCL]->offset = (unsigned short)offsetof(mcaRecord, pscl);
    prt->papFldDes[mcaRecordPRTM]->size = sizeof(prec->prtm);
    prt->papFldDes[mcaRecordPRTM]->offset = (unsigned short)offsetof(mcaRecord, prtm);
    prt->papFldDes[mcaRecordPLTM]->size = sizeof(prec->pltm);
    prt->papFldDes[mcaRecordPLTM]->offset = (unsigned short)offsetof(mcaRecord, pltm);
    prt->papFldDes[mcaRecordPCT]->size = sizeof(prec->pct);
    prt->papFldDes[mcaRecordPCT]->offset = (unsigned short)offsetof(mcaRecord, pct);
    prt->papFldDes[mcaRecordPCTL]->size = sizeof(prec->pctl);
    prt->papFldDes[mcaRecordPCTL]->offset = (unsigned short)offsetof(mcaRecord, pctl);
    prt->papFldDes[mcaRecordPCTH]->size = sizeof(prec->pcth);
    prt->papFldDes[mcaRecordPCTH]->offset = (unsigned short)offsetof(mcaRecord, pcth);
    prt->papFldDes[mcaRecordPSWP]->size = sizeof(prec->pswp);
    prt->papFldDes[mcaRecordPSWP]->offset = (unsigned short)offsetof(mcaRecord, pswp);
    prt->papFldDes[mcaRecordMODE]->size = sizeof(prec->mode);
    prt->papFldDes[mcaRecordMODE]->offset = (unsigned short)offsetof(mcaRecord, mode);
    prt->papFldDes[mcaRecordCALO]->size = sizeof(prec->calo);
    prt->papFldDes[mcaRecordCALO]->offset = (unsigned short)offsetof(mcaRecord, calo);
    prt->papFldDes[mcaRecordCALS]->size = sizeof(prec->cals);
    prt->papFldDes[mcaRecordCALS]->offset = (unsigned short)offsetof(mcaRecord, cals);
    prt->papFldDes[mcaRecordCALQ]->size = sizeof(prec->calq);
    prt->papFldDes[mcaRecordCALQ]->offset = (unsigned short)offsetof(mcaRecord, calq);
    prt->papFldDes[mcaRecordEGU]->size = sizeof(prec->egu);
    prt->papFldDes[mcaRecordEGU]->offset = (unsigned short)offsetof(mcaRecord, egu);
    prt->papFldDes[mcaRecordTTH]->size = sizeof(prec->tth);
    prt->papFldDes[mcaRecordTTH]->offset = (unsigned short)offsetof(mcaRecord, tth);
    prt->papFldDes[mcaRecordERTM]->size = sizeof(prec->ertm);
    prt->papFldDes[mcaRecordERTM]->offset = (unsigned short)offsetof(mcaRecord, ertm);
    prt->papFldDes[mcaRecordELTM]->size = sizeof(prec->eltm);
    prt->papFldDes[mcaRecordELTM]->offset = (unsigned short)offsetof(mcaRecord, eltm);
    prt->papFldDes[mcaRecordDTIM]->size = sizeof(prec->dtim);
    prt->papFldDes[mcaRecordDTIM]->offset = (unsigned short)offsetof(mcaRecord, dtim);
    prt->papFldDes[mcaRecordIDTIM]->size = sizeof(prec->idtim);
    prt->papFldDes[mcaRecordIDTIM]->offset = (unsigned short)offsetof(mcaRecord, idtim);
    prt->papFldDes[mcaRecordSTIM]->size = sizeof(prec->stim);
    prt->papFldDes[mcaRecordSTIM]->offset = (unsigned short)offsetof(mcaRecord, stim);
    prt->papFldDes[mcaRecordRTIM]->size = sizeof(prec->rtim);
    prt->papFldDes[mcaRecordRTIM]->offset = (unsigned short)offsetof(mcaRecord, rtim);
    prt->papFldDes[mcaRecordACT]->size = sizeof(prec->act);
    prt->papFldDes[mcaRecordACT]->offset = (unsigned short)offsetof(mcaRecord, act);
    prt->papFldDes[mcaRecordNACK]->size = sizeof(prec->nack);
    prt->papFldDes[mcaRecordNACK]->offset = (unsigned short)offsetof(mcaRecord, nack);
    prt->papFldDes[mcaRecordINP]->size = sizeof(prec->inp);
    prt->papFldDes[mcaRecordINP]->offset = (unsigned short)offsetof(mcaRecord, inp);
    prt->papFldDes[mcaRecordHIHI]->size = sizeof(prec->hihi);
    prt->papFldDes[mcaRecordHIHI]->offset = (unsigned short)offsetof(mcaRecord, hihi);
    prt->papFldDes[mcaRecordLOLO]->size = sizeof(prec->lolo);
    prt->papFldDes[mcaRecordLOLO]->offset = (unsigned short)offsetof(mcaRecord, lolo);
    prt->papFldDes[mcaRecordHIGH]->size = sizeof(prec->high);
    prt->papFldDes[mcaRecordHIGH]->offset = (unsigned short)offsetof(mcaRecord, high);
    prt->papFldDes[mcaRecordLOW]->size = sizeof(prec->low);
    prt->papFldDes[mcaRecordLOW]->offset = (unsigned short)offsetof(mcaRecord, low);
    prt->papFldDes[mcaRecordHHSV]->size = sizeof(prec->hhsv);
    prt->papFldDes[mcaRecordHHSV]->offset = (unsigned short)offsetof(mcaRecord, hhsv);
    prt->papFldDes[mcaRecordLLSV]->size = sizeof(prec->llsv);
    prt->papFldDes[mcaRecordLLSV]->offset = (unsigned short)offsetof(mcaRecord, llsv);
    prt->papFldDes[mcaRecordHSV]->size = sizeof(prec->hsv);
    prt->papFldDes[mcaRecordHSV]->offset = (unsigned short)offsetof(mcaRecord, hsv);
    prt->papFldDes[mcaRecordLSV]->size = sizeof(prec->lsv);
    prt->papFldDes[mcaRecordLSV]->offset = (unsigned short)offsetof(mcaRecord, lsv);
    prt->papFldDes[mcaRecordHYST]->size = sizeof(prec->hyst);
    prt->papFldDes[mcaRecordHYST]->offset = (unsigned short)offsetof(mcaRecord, hyst);
    prt->papFldDes[mcaRecordLALM]->size = sizeof(prec->lalm);
    prt->papFldDes[mcaRecordLALM]->offset = (unsigned short)offsetof(mcaRecord, lalm);
    prt->papFldDes[mcaRecordSIOL]->size = sizeof(prec->siol);
    prt->papFldDes[mcaRecordSIOL]->offset = (unsigned short)offsetof(mcaRecord, siol);
    prt->papFldDes[mcaRecordSIML]->size = sizeof(prec->siml);
    prt->papFldDes[mcaRecordSIML]->offset = (unsigned short)offsetof(mcaRecord, siml);
    prt->papFldDes[mcaRecordSIMM]->size = sizeof(prec->simm);
    prt->papFldDes[mcaRecordSIMM]->offset = (unsigned short)offsetof(mcaRecord, simm);
    prt->papFldDes[mcaRecordSIMS]->size = sizeof(prec->sims);
    prt->papFldDes[mcaRecordSIMS]->offset = (unsigned short)offsetof(mcaRecord, sims);
    prt->papFldDes[mcaRecordMMAP]->size = sizeof(prec->mmap);
    prt->papFldDes[mcaRecordMMAP]->offset = (unsigned short)offsetof(mcaRecord, mmap);
    prt->papFldDes[mcaRecordRMAP]->size = sizeof(prec->rmap);
    prt->papFldDes[mcaRecordRMAP]->offset = (unsigned short)offsetof(mcaRecord, rmap);
    prt->papFldDes[mcaRecordNEWV]->size = sizeof(prec->newv);
    prt->papFldDes[mcaRecordNEWV]->offset = (unsigned short)offsetof(mcaRecord, newv);
    prt->papFldDes[mcaRecordNEWR]->size = sizeof(prec->newr);
    prt->papFldDes[mcaRecordNEWR]->offset = (unsigned short)offsetof(mcaRecord, newr);
    prt->papFldDes[mcaRecordR0LO]->size = sizeof(prec->r0lo);
    prt->papFldDes[mcaRecordR0LO]->offset = (unsigned short)offsetof(mcaRecord, r0lo);
    prt->papFldDes[mcaRecordR0HI]->size = sizeof(prec->r0hi);
    prt->papFldDes[mcaRecordR0HI]->offset = (unsigned short)offsetof(mcaRecord, r0hi);
    prt->papFldDes[mcaRecordR0BG]->size = sizeof(prec->r0bg);
    prt->papFldDes[mcaRecordR0BG]->offset = (unsigned short)offsetof(mcaRecord, r0bg);
    prt->papFldDes[mcaRecordR0IP]->size = sizeof(prec->r0ip);
    prt->papFldDes[mcaRecordR0IP]->offset = (unsigned short)offsetof(mcaRecord, r0ip);
    prt->papFldDes[mcaRecordR1LO]->size = sizeof(prec->r1lo);
    prt->papFldDes[mcaRecordR1LO]->offset = (unsigned short)offsetof(mcaRecord, r1lo);
    prt->papFldDes[mcaRecordR1HI]->size = sizeof(prec->r1hi);
    prt->papFldDes[mcaRecordR1HI]->offset = (unsigned short)offsetof(mcaRecord, r1hi);
    prt->papFldDes[mcaRecordR1BG]->size = sizeof(prec->r1bg);
    prt->papFldDes[mcaRecordR1BG]->offset = (unsigned short)offsetof(mcaRecord, r1bg);
    prt->papFldDes[mcaRecordR1IP]->size = sizeof(prec->r1ip);
    prt->papFldDes[mcaRecordR1IP]->offset = (unsigned short)offsetof(mcaRecord, r1ip);
    prt->papFldDes[mcaRecordR2LO]->size = sizeof(prec->r2lo);
    prt->papFldDes[mcaRecordR2LO]->offset = (unsigned short)offsetof(mcaRecord, r2lo);
    prt->papFldDes[mcaRecordR2HI]->size = sizeof(prec->r2hi);
    prt->papFldDes[mcaRecordR2HI]->offset = (unsigned short)offsetof(mcaRecord, r2hi);
    prt->papFldDes[mcaRecordR2BG]->size = sizeof(prec->r2bg);
    prt->papFldDes[mcaRecordR2BG]->offset = (unsigned short)offsetof(mcaRecord, r2bg);
    prt->papFldDes[mcaRecordR2IP]->size = sizeof(prec->r2ip);
    prt->papFldDes[mcaRecordR2IP]->offset = (unsigned short)offsetof(mcaRecord, r2ip);
    prt->papFldDes[mcaRecordR3LO]->size = sizeof(prec->r3lo);
    prt->papFldDes[mcaRecordR3LO]->offset = (unsigned short)offsetof(mcaRecord, r3lo);
    prt->papFldDes[mcaRecordR3HI]->size = sizeof(prec->r3hi);
    prt->papFldDes[mcaRecordR3HI]->offset = (unsigned short)offsetof(mcaRecord, r3hi);
    prt->papFldDes[mcaRecordR3BG]->size = sizeof(prec->r3bg);
    prt->papFldDes[mcaRecordR3BG]->offset = (unsigned short)offsetof(mcaRecord, r3bg);
    prt->papFldDes[mcaRecordR3IP]->size = sizeof(prec->r3ip);
    prt->papFldDes[mcaRecordR3IP]->offset = (unsigned short)offsetof(mcaRecord, r3ip);
    prt->papFldDes[mcaRecordR4LO]->size = sizeof(prec->r4lo);
    prt->papFldDes[mcaRecordR4LO]->offset = (unsigned short)offsetof(mcaRecord, r4lo);
    prt->papFldDes[mcaRecordR4HI]->size = sizeof(prec->r4hi);
    prt->papFldDes[mcaRecordR4HI]->offset = (unsigned short)offsetof(mcaRecord, r4hi);
    prt->papFldDes[mcaRecordR4BG]->size = sizeof(prec->r4bg);
    prt->papFldDes[mcaRecordR4BG]->offset = (unsigned short)offsetof(mcaRecord, r4bg);
    prt->papFldDes[mcaRecordR4IP]->size = sizeof(prec->r4ip);
    prt->papFldDes[mcaRecordR4IP]->offset = (unsigned short)offsetof(mcaRecord, r4ip);
    prt->papFldDes[mcaRecordR5LO]->size = sizeof(prec->r5lo);
    prt->papFldDes[mcaRecordR5LO]->offset = (unsigned short)offsetof(mcaRecord, r5lo);
    prt->papFldDes[mcaRecordR5HI]->size = sizeof(prec->r5hi);
    prt->papFldDes[mcaRecordR5HI]->offset = (unsigned short)offsetof(mcaRecord, r5hi);
    prt->papFldDes[mcaRecordR5BG]->size = sizeof(prec->r5bg);
    prt->papFldDes[mcaRecordR5BG]->offset = (unsigned short)offsetof(mcaRecord, r5bg);
    prt->papFldDes[mcaRecordR5IP]->size = sizeof(prec->r5ip);
    prt->papFldDes[mcaRecordR5IP]->offset = (unsigned short)offsetof(mcaRecord, r5ip);
    prt->papFldDes[mcaRecordR6LO]->size = sizeof(prec->r6lo);
    prt->papFldDes[mcaRecordR6LO]->offset = (unsigned short)offsetof(mcaRecord, r6lo);
    prt->papFldDes[mcaRecordR6HI]->size = sizeof(prec->r6hi);
    prt->papFldDes[mcaRecordR6HI]->offset = (unsigned short)offsetof(mcaRecord, r6hi);
    prt->papFldDes[mcaRecordR6BG]->size = sizeof(prec->r6bg);
    prt->papFldDes[mcaRecordR6BG]->offset = (unsigned short)offsetof(mcaRecord, r6bg);
    prt->papFldDes[mcaRecordR6IP]->size = sizeof(prec->r6ip);
    prt->papFldDes[mcaRecordR6IP]->offset = (unsigned short)offsetof(mcaRecord, r6ip);
    prt->papFldDes[mcaRecordR7LO]->size = sizeof(prec->r7lo);
    prt->papFldDes[mcaRecordR7LO]->offset = (unsigned short)offsetof(mcaRecord, r7lo);
    prt->papFldDes[mcaRecordR7HI]->size = sizeof(prec->r7hi);
    prt->papFldDes[mcaRecordR7HI]->offset = (unsigned short)offsetof(mcaRecord, r7hi);
    prt->papFldDes[mcaRecordR7BG]->size = sizeof(prec->r7bg);
    prt->papFldDes[mcaRecordR7BG]->offset = (unsigned short)offsetof(mcaRecord, r7bg);
    prt->papFldDes[mcaRecordR7IP]->size = sizeof(prec->r7ip);
    prt->papFldDes[mcaRecordR7IP]->offset = (unsigned short)offsetof(mcaRecord, r7ip);
    prt->papFldDes[mcaRecordR8LO]->size = sizeof(prec->r8lo);
    prt->papFldDes[mcaRecordR8LO]->offset = (unsigned short)offsetof(mcaRecord, r8lo);
    prt->papFldDes[mcaRecordR8HI]->size = sizeof(prec->r8hi);
    prt->papFldDes[mcaRecordR8HI]->offset = (unsigned short)offsetof(mcaRecord, r8hi);
    prt->papFldDes[mcaRecordR8BG]->size = sizeof(prec->r8bg);
    prt->papFldDes[mcaRecordR8BG]->offset = (unsigned short)offsetof(mcaRecord, r8bg);
    prt->papFldDes[mcaRecordR8IP]->size = sizeof(prec->r8ip);
    prt->papFldDes[mcaRecordR8IP]->offset = (unsigned short)offsetof(mcaRecord, r8ip);
    prt->papFldDes[mcaRecordR9LO]->size = sizeof(prec->r9lo);
    prt->papFldDes[mcaRecordR9LO]->offset = (unsigned short)offsetof(mcaRecord, r9lo);
    prt->papFldDes[mcaRecordR9HI]->size = sizeof(prec->r9hi);
    prt->papFldDes[mcaRecordR9HI]->offset = (unsigned short)offsetof(mcaRecord, r9hi);
    prt->papFldDes[mcaRecordR9BG]->size = sizeof(prec->r9bg);
    prt->papFldDes[mcaRecordR9BG]->offset = (unsigned short)offsetof(mcaRecord, r9bg);
    prt->papFldDes[mcaRecordR9IP]->size = sizeof(prec->r9ip);
    prt->papFldDes[mcaRecordR9IP]->offset = (unsigned short)offsetof(mcaRecord, r9ip);
    prt->papFldDes[mcaRecordR10LO]->size = sizeof(prec->r10lo);
    prt->papFldDes[mcaRecordR10LO]->offset = (unsigned short)offsetof(mcaRecord, r10lo);
    prt->papFldDes[mcaRecordR10HI]->size = sizeof(prec->r10hi);
    prt->papFldDes[mcaRecordR10HI]->offset = (unsigned short)offsetof(mcaRecord, r10hi);
    prt->papFldDes[mcaRecordR10BG]->size = sizeof(prec->r10bg);
    prt->papFldDes[mcaRecordR10BG]->offset = (unsigned short)offsetof(mcaRecord, r10bg);
    prt->papFldDes[mcaRecordR10IP]->size = sizeof(prec->r10ip);
    prt->papFldDes[mcaRecordR10IP]->offset = (unsigned short)offsetof(mcaRecord, r10ip);
    prt->papFldDes[mcaRecordR11LO]->size = sizeof(prec->r11lo);
    prt->papFldDes[mcaRecordR11LO]->offset = (unsigned short)offsetof(mcaRecord, r11lo);
    prt->papFldDes[mcaRecordR11HI]->size = sizeof(prec->r11hi);
    prt->papFldDes[mcaRecordR11HI]->offset = (unsigned short)offsetof(mcaRecord, r11hi);
    prt->papFldDes[mcaRecordR11BG]->size = sizeof(prec->r11bg);
    prt->papFldDes[mcaRecordR11BG]->offset = (unsigned short)offsetof(mcaRecord, r11bg);
    prt->papFldDes[mcaRecordR11IP]->size = sizeof(prec->r11ip);
    prt->papFldDes[mcaRecordR11IP]->offset = (unsigned short)offsetof(mcaRecord, r11ip);
    prt->papFldDes[mcaRecordR12LO]->size = sizeof(prec->r12lo);
    prt->papFldDes[mcaRecordR12LO]->offset = (unsigned short)offsetof(mcaRecord, r12lo);
    prt->papFldDes[mcaRecordR12HI]->size = sizeof(prec->r12hi);
    prt->papFldDes[mcaRecordR12HI]->offset = (unsigned short)offsetof(mcaRecord, r12hi);
    prt->papFldDes[mcaRecordR12BG]->size = sizeof(prec->r12bg);
    prt->papFldDes[mcaRecordR12BG]->offset = (unsigned short)offsetof(mcaRecord, r12bg);
    prt->papFldDes[mcaRecordR12IP]->size = sizeof(prec->r12ip);
    prt->papFldDes[mcaRecordR12IP]->offset = (unsigned short)offsetof(mcaRecord, r12ip);
    prt->papFldDes[mcaRecordR13LO]->size = sizeof(prec->r13lo);
    prt->papFldDes[mcaRecordR13LO]->offset = (unsigned short)offsetof(mcaRecord, r13lo);
    prt->papFldDes[mcaRecordR13HI]->size = sizeof(prec->r13hi);
    prt->papFldDes[mcaRecordR13HI]->offset = (unsigned short)offsetof(mcaRecord, r13hi);
    prt->papFldDes[mcaRecordR13BG]->size = sizeof(prec->r13bg);
    prt->papFldDes[mcaRecordR13BG]->offset = (unsigned short)offsetof(mcaRecord, r13bg);
    prt->papFldDes[mcaRecordR13IP]->size = sizeof(prec->r13ip);
    prt->papFldDes[mcaRecordR13IP]->offset = (unsigned short)offsetof(mcaRecord, r13ip);
    prt->papFldDes[mcaRecordR14LO]->size = sizeof(prec->r14lo);
    prt->papFldDes[mcaRecordR14LO]->offset = (unsigned short)offsetof(mcaRecord, r14lo);
    prt->papFldDes[mcaRecordR14HI]->size = sizeof(prec->r14hi);
    prt->papFldDes[mcaRecordR14HI]->offset = (unsigned short)offsetof(mcaRecord, r14hi);
    prt->papFldDes[mcaRecordR14BG]->size = sizeof(prec->r14bg);
    prt->papFldDes[mcaRecordR14BG]->offset = (unsigned short)offsetof(mcaRecord, r14bg);
    prt->papFldDes[mcaRecordR14IP]->size = sizeof(prec->r14ip);
    prt->papFldDes[mcaRecordR14IP]->offset = (unsigned short)offsetof(mcaRecord, r14ip);
    prt->papFldDes[mcaRecordR15LO]->size = sizeof(prec->r15lo);
    prt->papFldDes[mcaRecordR15LO]->offset = (unsigned short)offsetof(mcaRecord, r15lo);
    prt->papFldDes[mcaRecordR15HI]->size = sizeof(prec->r15hi);
    prt->papFldDes[mcaRecordR15HI]->offset = (unsigned short)offsetof(mcaRecord, r15hi);
    prt->papFldDes[mcaRecordR15BG]->size = sizeof(prec->r15bg);
    prt->papFldDes[mcaRecordR15BG]->offset = (unsigned short)offsetof(mcaRecord, r15bg);
    prt->papFldDes[mcaRecordR15IP]->size = sizeof(prec->r15ip);
    prt->papFldDes[mcaRecordR15IP]->offset = (unsigned short)offsetof(mcaRecord, r15ip);
    prt->papFldDes[mcaRecordR16LO]->size = sizeof(prec->r16lo);
    prt->papFldDes[mcaRecordR16LO]->offset = (unsigned short)offsetof(mcaRecord, r16lo);
    prt->papFldDes[mcaRecordR16HI]->size = sizeof(prec->r16hi);
    prt->papFldDes[mcaRecordR16HI]->offset = (unsigned short)offsetof(mcaRecord, r16hi);
    prt->papFldDes[mcaRecordR16BG]->size = sizeof(prec->r16bg);
    prt->papFldDes[mcaRecordR16BG]->offset = (unsigned short)offsetof(mcaRecord, r16bg);
    prt->papFldDes[mcaRecordR16IP]->size = sizeof(prec->r16ip);
    prt->papFldDes[mcaRecordR16IP]->offset = (unsigned short)offsetof(mcaRecord, r16ip);
    prt->papFldDes[mcaRecordR17LO]->size = sizeof(prec->r17lo);
    prt->papFldDes[mcaRecordR17LO]->offset = (unsigned short)offsetof(mcaRecord, r17lo);
    prt->papFldDes[mcaRecordR17HI]->size = sizeof(prec->r17hi);
    prt->papFldDes[mcaRecordR17HI]->offset = (unsigned short)offsetof(mcaRecord, r17hi);
    prt->papFldDes[mcaRecordR17BG]->size = sizeof(prec->r17bg);
    prt->papFldDes[mcaRecordR17BG]->offset = (unsigned short)offsetof(mcaRecord, r17bg);
    prt->papFldDes[mcaRecordR17IP]->size = sizeof(prec->r17ip);
    prt->papFldDes[mcaRecordR17IP]->offset = (unsigned short)offsetof(mcaRecord, r17ip);
    prt->papFldDes[mcaRecordR18LO]->size = sizeof(prec->r18lo);
    prt->papFldDes[mcaRecordR18LO]->offset = (unsigned short)offsetof(mcaRecord, r18lo);
    prt->papFldDes[mcaRecordR18HI]->size = sizeof(prec->r18hi);
    prt->papFldDes[mcaRecordR18HI]->offset = (unsigned short)offsetof(mcaRecord, r18hi);
    prt->papFldDes[mcaRecordR18BG]->size = sizeof(prec->r18bg);
    prt->papFldDes[mcaRecordR18BG]->offset = (unsigned short)offsetof(mcaRecord, r18bg);
    prt->papFldDes[mcaRecordR18IP]->size = sizeof(prec->r18ip);
    prt->papFldDes[mcaRecordR18IP]->offset = (unsigned short)offsetof(mcaRecord, r18ip);
    prt->papFldDes[mcaRecordR19LO]->size = sizeof(prec->r19lo);
    prt->papFldDes[mcaRecordR19LO]->offset = (unsigned short)offsetof(mcaRecord, r19lo);
    prt->papFldDes[mcaRecordR19HI]->size = sizeof(prec->r19hi);
    prt->papFldDes[mcaRecordR19HI]->offset = (unsigned short)offsetof(mcaRecord, r19hi);
    prt->papFldDes[mcaRecordR19BG]->size = sizeof(prec->r19bg);
    prt->papFldDes[mcaRecordR19BG]->offset = (unsigned short)offsetof(mcaRecord, r19bg);
    prt->papFldDes[mcaRecordR19IP]->size = sizeof(prec->r19ip);
    prt->papFldDes[mcaRecordR19IP]->offset = (unsigned short)offsetof(mcaRecord, r19ip);
    prt->papFldDes[mcaRecordR20LO]->size = sizeof(prec->r20lo);
    prt->papFldDes[mcaRecordR20LO]->offset = (unsigned short)offsetof(mcaRecord, r20lo);
    prt->papFldDes[mcaRecordR20HI]->size = sizeof(prec->r20hi);
    prt->papFldDes[mcaRecordR20HI]->offset = (unsigned short)offsetof(mcaRecord, r20hi);
    prt->papFldDes[mcaRecordR20BG]->size = sizeof(prec->r20bg);
    prt->papFldDes[mcaRecordR20BG]->offset = (unsigned short)offsetof(mcaRecord, r20bg);
    prt->papFldDes[mcaRecordR20IP]->size = sizeof(prec->r20ip);
    prt->papFldDes[mcaRecordR20IP]->offset = (unsigned short)offsetof(mcaRecord, r20ip);
    prt->papFldDes[mcaRecordR21LO]->size = sizeof(prec->r21lo);
    prt->papFldDes[mcaRecordR21LO]->offset = (unsigned short)offsetof(mcaRecord, r21lo);
    prt->papFldDes[mcaRecordR21HI]->size = sizeof(prec->r21hi);
    prt->papFldDes[mcaRecordR21HI]->offset = (unsigned short)offsetof(mcaRecord, r21hi);
    prt->papFldDes[mcaRecordR21BG]->size = sizeof(prec->r21bg);
    prt->papFldDes[mcaRecordR21BG]->offset = (unsigned short)offsetof(mcaRecord, r21bg);
    prt->papFldDes[mcaRecordR21IP]->size = sizeof(prec->r21ip);
    prt->papFldDes[mcaRecordR21IP]->offset = (unsigned short)offsetof(mcaRecord, r21ip);
    prt->papFldDes[mcaRecordR22LO]->size = sizeof(prec->r22lo);
    prt->papFldDes[mcaRecordR22LO]->offset = (unsigned short)offsetof(mcaRecord, r22lo);
    prt->papFldDes[mcaRecordR22HI]->size = sizeof(prec->r22hi);
    prt->papFldDes[mcaRecordR22HI]->offset = (unsigned short)offsetof(mcaRecord, r22hi);
    prt->papFldDes[mcaRecordR22BG]->size = sizeof(prec->r22bg);
    prt->papFldDes[mcaRecordR22BG]->offset = (unsigned short)offsetof(mcaRecord, r22bg);
    prt->papFldDes[mcaRecordR22IP]->size = sizeof(prec->r22ip);
    prt->papFldDes[mcaRecordR22IP]->offset = (unsigned short)offsetof(mcaRecord, r22ip);
    prt->papFldDes[mcaRecordR23LO]->size = sizeof(prec->r23lo);
    prt->papFldDes[mcaRecordR23LO]->offset = (unsigned short)offsetof(mcaRecord, r23lo);
    prt->papFldDes[mcaRecordR23HI]->size = sizeof(prec->r23hi);
    prt->papFldDes[mcaRecordR23HI]->offset = (unsigned short)offsetof(mcaRecord, r23hi);
    prt->papFldDes[mcaRecordR23BG]->size = sizeof(prec->r23bg);
    prt->papFldDes[mcaRecordR23BG]->offset = (unsigned short)offsetof(mcaRecord, r23bg);
    prt->papFldDes[mcaRecordR23IP]->size = sizeof(prec->r23ip);
    prt->papFldDes[mcaRecordR23IP]->offset = (unsigned short)offsetof(mcaRecord, r23ip);
    prt->papFldDes[mcaRecordR24LO]->size = sizeof(prec->r24lo);
    prt->papFldDes[mcaRecordR24LO]->offset = (unsigned short)offsetof(mcaRecord, r24lo);
    prt->papFldDes[mcaRecordR24HI]->size = sizeof(prec->r24hi);
    prt->papFldDes[mcaRecordR24HI]->offset = (unsigned short)offsetof(mcaRecord, r24hi);
    prt->papFldDes[mcaRecordR24BG]->size = sizeof(prec->r24bg);
    prt->papFldDes[mcaRecordR24BG]->offset = (unsigned short)offsetof(mcaRecord, r24bg);
    prt->papFldDes[mcaRecordR24IP]->size = sizeof(prec->r24ip);
    prt->papFldDes[mcaRecordR24IP]->offset = (unsigned short)offsetof(mcaRecord, r24ip);
    prt->papFldDes[mcaRecordR25LO]->size = sizeof(prec->r25lo);
    prt->papFldDes[mcaRecordR25LO]->offset = (unsigned short)offsetof(mcaRecord, r25lo);
    prt->papFldDes[mcaRecordR25HI]->size = sizeof(prec->r25hi);
    prt->papFldDes[mcaRecordR25HI]->offset = (unsigned short)offsetof(mcaRecord, r25hi);
    prt->papFldDes[mcaRecordR25BG]->size = sizeof(prec->r25bg);
    prt->papFldDes[mcaRecordR25BG]->offset = (unsigned short)offsetof(mcaRecord, r25bg);
    prt->papFldDes[mcaRecordR25IP]->size = sizeof(prec->r25ip);
    prt->papFldDes[mcaRecordR25IP]->offset = (unsigned short)offsetof(mcaRecord, r25ip);
    prt->papFldDes[mcaRecordR26LO]->size = sizeof(prec->r26lo);
    prt->papFldDes[mcaRecordR26LO]->offset = (unsigned short)offsetof(mcaRecord, r26lo);
    prt->papFldDes[mcaRecordR26HI]->size = sizeof(prec->r26hi);
    prt->papFldDes[mcaRecordR26HI]->offset = (unsigned short)offsetof(mcaRecord, r26hi);
    prt->papFldDes[mcaRecordR26BG]->size = sizeof(prec->r26bg);
    prt->papFldDes[mcaRecordR26BG]->offset = (unsigned short)offsetof(mcaRecord, r26bg);
    prt->papFldDes[mcaRecordR26IP]->size = sizeof(prec->r26ip);
    prt->papFldDes[mcaRecordR26IP]->offset = (unsigned short)offsetof(mcaRecord, r26ip);
    prt->papFldDes[mcaRecordR27LO]->size = sizeof(prec->r27lo);
    prt->papFldDes[mcaRecordR27LO]->offset = (unsigned short)offsetof(mcaRecord, r27lo);
    prt->papFldDes[mcaRecordR27HI]->size = sizeof(prec->r27hi);
    prt->papFldDes[mcaRecordR27HI]->offset = (unsigned short)offsetof(mcaRecord, r27hi);
    prt->papFldDes[mcaRecordR27BG]->size = sizeof(prec->r27bg);
    prt->papFldDes[mcaRecordR27BG]->offset = (unsigned short)offsetof(mcaRecord, r27bg);
    prt->papFldDes[mcaRecordR27IP]->size = sizeof(prec->r27ip);
    prt->papFldDes[mcaRecordR27IP]->offset = (unsigned short)offsetof(mcaRecord, r27ip);
    prt->papFldDes[mcaRecordR28LO]->size = sizeof(prec->r28lo);
    prt->papFldDes[mcaRecordR28LO]->offset = (unsigned short)offsetof(mcaRecord, r28lo);
    prt->papFldDes[mcaRecordR28HI]->size = sizeof(prec->r28hi);
    prt->papFldDes[mcaRecordR28HI]->offset = (unsigned short)offsetof(mcaRecord, r28hi);
    prt->papFldDes[mcaRecordR28BG]->size = sizeof(prec->r28bg);
    prt->papFldDes[mcaRecordR28BG]->offset = (unsigned short)offsetof(mcaRecord, r28bg);
    prt->papFldDes[mcaRecordR28IP]->size = sizeof(prec->r28ip);
    prt->papFldDes[mcaRecordR28IP]->offset = (unsigned short)offsetof(mcaRecord, r28ip);
    prt->papFldDes[mcaRecordR29LO]->size = sizeof(prec->r29lo);
    prt->papFldDes[mcaRecordR29LO]->offset = (unsigned short)offsetof(mcaRecord, r29lo);
    prt->papFldDes[mcaRecordR29HI]->size = sizeof(prec->r29hi);
    prt->papFldDes[mcaRecordR29HI]->offset = (unsigned short)offsetof(mcaRecord, r29hi);
    prt->papFldDes[mcaRecordR29BG]->size = sizeof(prec->r29bg);
    prt->papFldDes[mcaRecordR29BG]->offset = (unsigned short)offsetof(mcaRecord, r29bg);
    prt->papFldDes[mcaRecordR29IP]->size = sizeof(prec->r29ip);
    prt->papFldDes[mcaRecordR29IP]->offset = (unsigned short)offsetof(mcaRecord, r29ip);
    prt->papFldDes[mcaRecordR30LO]->size = sizeof(prec->r30lo);
    prt->papFldDes[mcaRecordR30LO]->offset = (unsigned short)offsetof(mcaRecord, r30lo);
    prt->papFldDes[mcaRecordR30HI]->size = sizeof(prec->r30hi);
    prt->papFldDes[mcaRecordR30HI]->offset = (unsigned short)offsetof(mcaRecord, r30hi);
    prt->papFldDes[mcaRecordR30BG]->size = sizeof(prec->r30bg);
    prt->papFldDes[mcaRecordR30BG]->offset = (unsigned short)offsetof(mcaRecord, r30bg);
    prt->papFldDes[mcaRecordR30IP]->size = sizeof(prec->r30ip);
    prt->papFldDes[mcaRecordR30IP]->offset = (unsigned short)offsetof(mcaRecord, r30ip);
    prt->papFldDes[mcaRecordR31LO]->size = sizeof(prec->r31lo);
    prt->papFldDes[mcaRecordR31LO]->offset = (unsigned short)offsetof(mcaRecord, r31lo);
    prt->papFldDes[mcaRecordR31HI]->size = sizeof(prec->r31hi);
    prt->papFldDes[mcaRecordR31HI]->offset = (unsigned short)offsetof(mcaRecord, r31hi);
    prt->papFldDes[mcaRecordR31BG]->size = sizeof(prec->r31bg);
    prt->papFldDes[mcaRecordR31BG]->offset = (unsigned short)offsetof(mcaRecord, r31bg);
    prt->papFldDes[mcaRecordR31IP]->size = sizeof(prec->r31ip);
    prt->papFldDes[mcaRecordR31IP]->offset = (unsigned short)offsetof(mcaRecord, r31ip);
    prt->papFldDes[mcaRecordR0]->size = sizeof(prec->r0);
    prt->papFldDes[mcaRecordR0]->offset = (unsigned short)offsetof(mcaRecord, r0);
    prt->papFldDes[mcaRecordR0N]->size = sizeof(prec->r0n);
    prt->papFldDes[mcaRecordR0N]->offset = (unsigned short)offsetof(mcaRecord, r0n);
    prt->papFldDes[mcaRecordR0P]->size = sizeof(prec->r0p);
    prt->papFldDes[mcaRecordR0P]->offset = (unsigned short)offsetof(mcaRecord, r0p);
    prt->papFldDes[mcaRecordR1]->size = sizeof(prec->r1);
    prt->papFldDes[mcaRecordR1]->offset = (unsigned short)offsetof(mcaRecord, r1);
    prt->papFldDes[mcaRecordR1N]->size = sizeof(prec->r1n);
    prt->papFldDes[mcaRecordR1N]->offset = (unsigned short)offsetof(mcaRecord, r1n);
    prt->papFldDes[mcaRecordR1P]->size = sizeof(prec->r1p);
    prt->papFldDes[mcaRecordR1P]->offset = (unsigned short)offsetof(mcaRecord, r1p);
    prt->papFldDes[mcaRecordR2]->size = sizeof(prec->r2);
    prt->papFldDes[mcaRecordR2]->offset = (unsigned short)offsetof(mcaRecord, r2);
    prt->papFldDes[mcaRecordR2N]->size = sizeof(prec->r2n);
    prt->papFldDes[mcaRecordR2N]->offset = (unsigned short)offsetof(mcaRecord, r2n);
    prt->papFldDes[mcaRecordR2P]->size = sizeof(prec->r2p);
    prt->papFldDes[mcaRecordR2P]->offset = (unsigned short)offsetof(mcaRecord, r2p);
    prt->papFldDes[mcaRecordR3]->size = sizeof(prec->r3);
    prt->papFldDes[mcaRecordR3]->offset = (unsigned short)offsetof(mcaRecord, r3);
    prt->papFldDes[mcaRecordR3N]->size = sizeof(prec->r3n);
    prt->papFldDes[mcaRecordR3N]->offset = (unsigned short)offsetof(mcaRecord, r3n);
    prt->papFldDes[mcaRecordR3P]->size = sizeof(prec->r3p);
    prt->papFldDes[mcaRecordR3P]->offset = (unsigned short)offsetof(mcaRecord, r3p);
    prt->papFldDes[mcaRecordR4]->size = sizeof(prec->r4);
    prt->papFldDes[mcaRecordR4]->offset = (unsigned short)offsetof(mcaRecord, r4);
    prt->papFldDes[mcaRecordR4N]->size = sizeof(prec->r4n);
    prt->papFldDes[mcaRecordR4N]->offset = (unsigned short)offsetof(mcaRecord, r4n);
    prt->papFldDes[mcaRecordR4P]->size = sizeof(prec->r4p);
    prt->papFldDes[mcaRecordR4P]->offset = (unsigned short)offsetof(mcaRecord, r4p);
    prt->papFldDes[mcaRecordR5]->size = sizeof(prec->r5);
    prt->papFldDes[mcaRecordR5]->offset = (unsigned short)offsetof(mcaRecord, r5);
    prt->papFldDes[mcaRecordR5N]->size = sizeof(prec->r5n);
    prt->papFldDes[mcaRecordR5N]->offset = (unsigned short)offsetof(mcaRecord, r5n);
    prt->papFldDes[mcaRecordR5P]->size = sizeof(prec->r5p);
    prt->papFldDes[mcaRecordR5P]->offset = (unsigned short)offsetof(mcaRecord, r5p);
    prt->papFldDes[mcaRecordR6]->size = sizeof(prec->r6);
    prt->papFldDes[mcaRecordR6]->offset = (unsigned short)offsetof(mcaRecord, r6);
    prt->papFldDes[mcaRecordR6N]->size = sizeof(prec->r6n);
    prt->papFldDes[mcaRecordR6N]->offset = (unsigned short)offsetof(mcaRecord, r6n);
    prt->papFldDes[mcaRecordR6P]->size = sizeof(prec->r6p);
    prt->papFldDes[mcaRecordR6P]->offset = (unsigned short)offsetof(mcaRecord, r6p);
    prt->papFldDes[mcaRecordR7]->size = sizeof(prec->r7);
    prt->papFldDes[mcaRecordR7]->offset = (unsigned short)offsetof(mcaRecord, r7);
    prt->papFldDes[mcaRecordR7N]->size = sizeof(prec->r7n);
    prt->papFldDes[mcaRecordR7N]->offset = (unsigned short)offsetof(mcaRecord, r7n);
    prt->papFldDes[mcaRecordR7P]->size = sizeof(prec->r7p);
    prt->papFldDes[mcaRecordR7P]->offset = (unsigned short)offsetof(mcaRecord, r7p);
    prt->papFldDes[mcaRecordR8]->size = sizeof(prec->r8);
    prt->papFldDes[mcaRecordR8]->offset = (unsigned short)offsetof(mcaRecord, r8);
    prt->papFldDes[mcaRecordR8N]->size = sizeof(prec->r8n);
    prt->papFldDes[mcaRecordR8N]->offset = (unsigned short)offsetof(mcaRecord, r8n);
    prt->papFldDes[mcaRecordR8P]->size = sizeof(prec->r8p);
    prt->papFldDes[mcaRecordR8P]->offset = (unsigned short)offsetof(mcaRecord, r8p);
    prt->papFldDes[mcaRecordR9]->size = sizeof(prec->r9);
    prt->papFldDes[mcaRecordR9]->offset = (unsigned short)offsetof(mcaRecord, r9);
    prt->papFldDes[mcaRecordR9N]->size = sizeof(prec->r9n);
    prt->papFldDes[mcaRecordR9N]->offset = (unsigned short)offsetof(mcaRecord, r9n);
    prt->papFldDes[mcaRecordR9P]->size = sizeof(prec->r9p);
    prt->papFldDes[mcaRecordR9P]->offset = (unsigned short)offsetof(mcaRecord, r9p);
    prt->papFldDes[mcaRecordR10]->size = sizeof(prec->r10);
    prt->papFldDes[mcaRecordR10]->offset = (unsigned short)offsetof(mcaRecord, r10);
    prt->papFldDes[mcaRecordR10N]->size = sizeof(prec->r10n);
    prt->papFldDes[mcaRecordR10N]->offset = (unsigned short)offsetof(mcaRecord, r10n);
    prt->papFldDes[mcaRecordR10P]->size = sizeof(prec->r10p);
    prt->papFldDes[mcaRecordR10P]->offset = (unsigned short)offsetof(mcaRecord, r10p);
    prt->papFldDes[mcaRecordR11]->size = sizeof(prec->r11);
    prt->papFldDes[mcaRecordR11]->offset = (unsigned short)offsetof(mcaRecord, r11);
    prt->papFldDes[mcaRecordR11N]->size = sizeof(prec->r11n);
    prt->papFldDes[mcaRecordR11N]->offset = (unsigned short)offsetof(mcaRecord, r11n);
    prt->papFldDes[mcaRecordR11P]->size = sizeof(prec->r11p);
    prt->papFldDes[mcaRecordR11P]->offset = (unsigned short)offsetof(mcaRecord, r11p);
    prt->papFldDes[mcaRecordR12]->size = sizeof(prec->r12);
    prt->papFldDes[mcaRecordR12]->offset = (unsigned short)offsetof(mcaRecord, r12);
    prt->papFldDes[mcaRecordR12N]->size = sizeof(prec->r12n);
    prt->papFldDes[mcaRecordR12N]->offset = (unsigned short)offsetof(mcaRecord, r12n);
    prt->papFldDes[mcaRecordR12P]->size = sizeof(prec->r12p);
    prt->papFldDes[mcaRecordR12P]->offset = (unsigned short)offsetof(mcaRecord, r12p);
    prt->papFldDes[mcaRecordR13]->size = sizeof(prec->r13);
    prt->papFldDes[mcaRecordR13]->offset = (unsigned short)offsetof(mcaRecord, r13);
    prt->papFldDes[mcaRecordR13N]->size = sizeof(prec->r13n);
    prt->papFldDes[mcaRecordR13N]->offset = (unsigned short)offsetof(mcaRecord, r13n);
    prt->papFldDes[mcaRecordR13P]->size = sizeof(prec->r13p);
    prt->papFldDes[mcaRecordR13P]->offset = (unsigned short)offsetof(mcaRecord, r13p);
    prt->papFldDes[mcaRecordR14]->size = sizeof(prec->r14);
    prt->papFldDes[mcaRecordR14]->offset = (unsigned short)offsetof(mcaRecord, r14);
    prt->papFldDes[mcaRecordR14N]->size = sizeof(prec->r14n);
    prt->papFldDes[mcaRecordR14N]->offset = (unsigned short)offsetof(mcaRecord, r14n);
    prt->papFldDes[mcaRecordR14P]->size = sizeof(prec->r14p);
    prt->papFldDes[mcaRecordR14P]->offset = (unsigned short)offsetof(mcaRecord, r14p);
    prt->papFldDes[mcaRecordR15]->size = sizeof(prec->r15);
    prt->papFldDes[mcaRecordR15]->offset = (unsigned short)offsetof(mcaRecord, r15);
    prt->papFldDes[mcaRecordR15N]->size = sizeof(prec->r15n);
    prt->papFldDes[mcaRecordR15N]->offset = (unsigned short)offsetof(mcaRecord, r15n);
    prt->papFldDes[mcaRecordR15P]->size = sizeof(prec->r15p);
    prt->papFldDes[mcaRecordR15P]->offset = (unsigned short)offsetof(mcaRecord, r15p);
    prt->papFldDes[mcaRecordR16]->size = sizeof(prec->r16);
    prt->papFldDes[mcaRecordR16]->offset = (unsigned short)offsetof(mcaRecord, r16);
    prt->papFldDes[mcaRecordR16N]->size = sizeof(prec->r16n);
    prt->papFldDes[mcaRecordR16N]->offset = (unsigned short)offsetof(mcaRecord, r16n);
    prt->papFldDes[mcaRecordR16P]->size = sizeof(prec->r16p);
    prt->papFldDes[mcaRecordR16P]->offset = (unsigned short)offsetof(mcaRecord, r16p);
    prt->papFldDes[mcaRecordR17]->size = sizeof(prec->r17);
    prt->papFldDes[mcaRecordR17]->offset = (unsigned short)offsetof(mcaRecord, r17);
    prt->papFldDes[mcaRecordR17N]->size = sizeof(prec->r17n);
    prt->papFldDes[mcaRecordR17N]->offset = (unsigned short)offsetof(mcaRecord, r17n);
    prt->papFldDes[mcaRecordR17P]->size = sizeof(prec->r17p);
    prt->papFldDes[mcaRecordR17P]->offset = (unsigned short)offsetof(mcaRecord, r17p);
    prt->papFldDes[mcaRecordR18]->size = sizeof(prec->r18);
    prt->papFldDes[mcaRecordR18]->offset = (unsigned short)offsetof(mcaRecord, r18);
    prt->papFldDes[mcaRecordR18N]->size = sizeof(prec->r18n);
    prt->papFldDes[mcaRecordR18N]->offset = (unsigned short)offsetof(mcaRecord, r18n);
    prt->papFldDes[mcaRecordR18P]->size = sizeof(prec->r18p);
    prt->papFldDes[mcaRecordR18P]->offset = (unsigned short)offsetof(mcaRecord, r18p);
    prt->papFldDes[mcaRecordR19]->size = sizeof(prec->r19);
    prt->papFldDes[mcaRecordR19]->offset = (unsigned short)offsetof(mcaRecord, r19);
    prt->papFldDes[mcaRecordR19N]->size = sizeof(prec->r19n);
    prt->papFldDes[mcaRecordR19N]->offset = (unsigned short)offsetof(mcaRecord, r19n);
    prt->papFldDes[mcaRecordR19P]->size = sizeof(prec->r19p);
    prt->papFldDes[mcaRecordR19P]->offset = (unsigned short)offsetof(mcaRecord, r19p);
    prt->papFldDes[mcaRecordR20]->size = sizeof(prec->r20);
    prt->papFldDes[mcaRecordR20]->offset = (unsigned short)offsetof(mcaRecord, r20);
    prt->papFldDes[mcaRecordR20N]->size = sizeof(prec->r20n);
    prt->papFldDes[mcaRecordR20N]->offset = (unsigned short)offsetof(mcaRecord, r20n);
    prt->papFldDes[mcaRecordR20P]->size = sizeof(prec->r20p);
    prt->papFldDes[mcaRecordR20P]->offset = (unsigned short)offsetof(mcaRecord, r20p);
    prt->papFldDes[mcaRecordR21]->size = sizeof(prec->r21);
    prt->papFldDes[mcaRecordR21]->offset = (unsigned short)offsetof(mcaRecord, r21);
    prt->papFldDes[mcaRecordR21N]->size = sizeof(prec->r21n);
    prt->papFldDes[mcaRecordR21N]->offset = (unsigned short)offsetof(mcaRecord, r21n);
    prt->papFldDes[mcaRecordR21P]->size = sizeof(prec->r21p);
    prt->papFldDes[mcaRecordR21P]->offset = (unsigned short)offsetof(mcaRecord, r21p);
    prt->papFldDes[mcaRecordR22]->size = sizeof(prec->r22);
    prt->papFldDes[mcaRecordR22]->offset = (unsigned short)offsetof(mcaRecord, r22);
    prt->papFldDes[mcaRecordR22N]->size = sizeof(prec->r22n);
    prt->papFldDes[mcaRecordR22N]->offset = (unsigned short)offsetof(mcaRecord, r22n);
    prt->papFldDes[mcaRecordR22P]->size = sizeof(prec->r22p);
    prt->papFldDes[mcaRecordR22P]->offset = (unsigned short)offsetof(mcaRecord, r22p);
    prt->papFldDes[mcaRecordR23]->size = sizeof(prec->r23);
    prt->papFldDes[mcaRecordR23]->offset = (unsigned short)offsetof(mcaRecord, r23);
    prt->papFldDes[mcaRecordR23N]->size = sizeof(prec->r23n);
    prt->papFldDes[mcaRecordR23N]->offset = (unsigned short)offsetof(mcaRecord, r23n);
    prt->papFldDes[mcaRecordR23P]->size = sizeof(prec->r23p);
    prt->papFldDes[mcaRecordR23P]->offset = (unsigned short)offsetof(mcaRecord, r23p);
    prt->papFldDes[mcaRecordR24]->size = sizeof(prec->r24);
    prt->papFldDes[mcaRecordR24]->offset = (unsigned short)offsetof(mcaRecord, r24);
    prt->papFldDes[mcaRecordR24N]->size = sizeof(prec->r24n);
    prt->papFldDes[mcaRecordR24N]->offset = (unsigned short)offsetof(mcaRecord, r24n);
    prt->papFldDes[mcaRecordR24P]->size = sizeof(prec->r24p);
    prt->papFldDes[mcaRecordR24P]->offset = (unsigned short)offsetof(mcaRecord, r24p);
    prt->papFldDes[mcaRecordR25]->size = sizeof(prec->r25);
    prt->papFldDes[mcaRecordR25]->offset = (unsigned short)offsetof(mcaRecord, r25);
    prt->papFldDes[mcaRecordR25N]->size = sizeof(prec->r25n);
    prt->papFldDes[mcaRecordR25N]->offset = (unsigned short)offsetof(mcaRecord, r25n);
    prt->papFldDes[mcaRecordR25P]->size = sizeof(prec->r25p);
    prt->papFldDes[mcaRecordR25P]->offset = (unsigned short)offsetof(mcaRecord, r25p);
    prt->papFldDes[mcaRecordR26]->size = sizeof(prec->r26);
    prt->papFldDes[mcaRecordR26]->offset = (unsigned short)offsetof(mcaRecord, r26);
    prt->papFldDes[mcaRecordR26N]->size = sizeof(prec->r26n);
    prt->papFldDes[mcaRecordR26N]->offset = (unsigned short)offsetof(mcaRecord, r26n);
    prt->papFldDes[mcaRecordR26P]->size = sizeof(prec->r26p);
    prt->papFldDes[mcaRecordR26P]->offset = (unsigned short)offsetof(mcaRecord, r26p);
    prt->papFldDes[mcaRecordR27]->size = sizeof(prec->r27);
    prt->papFldDes[mcaRecordR27]->offset = (unsigned short)offsetof(mcaRecord, r27);
    prt->papFldDes[mcaRecordR27N]->size = sizeof(prec->r27n);
    prt->papFldDes[mcaRecordR27N]->offset = (unsigned short)offsetof(mcaRecord, r27n);
    prt->papFldDes[mcaRecordR27P]->size = sizeof(prec->r27p);
    prt->papFldDes[mcaRecordR27P]->offset = (unsigned short)offsetof(mcaRecord, r27p);
    prt->papFldDes[mcaRecordR28]->size = sizeof(prec->r28);
    prt->papFldDes[mcaRecordR28]->offset = (unsigned short)offsetof(mcaRecord, r28);
    prt->papFldDes[mcaRecordR28N]->size = sizeof(prec->r28n);
    prt->papFldDes[mcaRecordR28N]->offset = (unsigned short)offsetof(mcaRecord, r28n);
    prt->papFldDes[mcaRecordR28P]->size = sizeof(prec->r28p);
    prt->papFldDes[mcaRecordR28P]->offset = (unsigned short)offsetof(mcaRecord, r28p);
    prt->papFldDes[mcaRecordR29]->size = sizeof(prec->r29);
    prt->papFldDes[mcaRecordR29]->offset = (unsigned short)offsetof(mcaRecord, r29);
    prt->papFldDes[mcaRecordR29N]->size = sizeof(prec->r29n);
    prt->papFldDes[mcaRecordR29N]->offset = (unsigned short)offsetof(mcaRecord, r29n);
    prt->papFldDes[mcaRecordR29P]->size = sizeof(prec->r29p);
    prt->papFldDes[mcaRecordR29P]->offset = (unsigned short)offsetof(mcaRecord, r29p);
    prt->papFldDes[mcaRecordR30]->size = sizeof(prec->r30);
    prt->papFldDes[mcaRecordR30]->offset = (unsigned short)offsetof(mcaRecord, r30);
    prt->papFldDes[mcaRecordR30N]->size = sizeof(prec->r30n);
    prt->papFldDes[mcaRecordR30N]->offset = (unsigned short)offsetof(mcaRecord, r30n);
    prt->papFldDes[mcaRecordR30P]->size = sizeof(prec->r30p);
    prt->papFldDes[mcaRecordR30P]->offset = (unsigned short)offsetof(mcaRecord, r30p);
    prt->papFldDes[mcaRecordR31]->size = sizeof(prec->r31);
    prt->papFldDes[mcaRecordR31]->offset = (unsigned short)offsetof(mcaRecord, r31);
    prt->papFldDes[mcaRecordR31N]->size = sizeof(prec->r31n);
    prt->papFldDes[mcaRecordR31N]->offset = (unsigned short)offsetof(mcaRecord, r31n);
    prt->papFldDes[mcaRecordR31P]->size = sizeof(prec->r31p);
    prt->papFldDes[mcaRecordR31P]->offset = (unsigned short)offsetof(mcaRecord, r31p);
    prt->papFldDes[mcaRecordR0NM]->size = sizeof(prec->r0nm);
    prt->papFldDes[mcaRecordR0NM]->offset = (unsigned short)offsetof(mcaRecord, r0nm);
    prt->papFldDes[mcaRecordR1NM]->size = sizeof(prec->r1nm);
    prt->papFldDes[mcaRecordR1NM]->offset = (unsigned short)offsetof(mcaRecord, r1nm);
    prt->papFldDes[mcaRecordR2NM]->size = sizeof(prec->r2nm);
    prt->papFldDes[mcaRecordR2NM]->offset = (unsigned short)offsetof(mcaRecord, r2nm);
    prt->papFldDes[mcaRecordR3NM]->size = sizeof(prec->r3nm);
    prt->papFldDes[mcaRecordR3NM]->offset = (unsigned short)offsetof(mcaRecord, r3nm);
    prt->papFldDes[mcaRecordR4NM]->size = sizeof(prec->r4nm);
    prt->papFldDes[mcaRecordR4NM]->offset = (unsigned short)offsetof(mcaRecord, r4nm);
    prt->papFldDes[mcaRecordR5NM]->size = sizeof(prec->r5nm);
    prt->papFldDes[mcaRecordR5NM]->offset = (unsigned short)offsetof(mcaRecord, r5nm);
    prt->papFldDes[mcaRecordR6NM]->size = sizeof(prec->r6nm);
    prt->papFldDes[mcaRecordR6NM]->offset = (unsigned short)offsetof(mcaRecord, r6nm);
    prt->papFldDes[mcaRecordR7NM]->size = sizeof(prec->r7nm);
    prt->papFldDes[mcaRecordR7NM]->offset = (unsigned short)offsetof(mcaRecord, r7nm);
    prt->papFldDes[mcaRecordR8NM]->size = sizeof(prec->r8nm);
    prt->papFldDes[mcaRecordR8NM]->offset = (unsigned short)offsetof(mcaRecord, r8nm);
    prt->papFldDes[mcaRecordR9NM]->size = sizeof(prec->r9nm);
    prt->papFldDes[mcaRecordR9NM]->offset = (unsigned short)offsetof(mcaRecord, r9nm);
    prt->papFldDes[mcaRecordR10NM]->size = sizeof(prec->r10nm);
    prt->papFldDes[mcaRecordR10NM]->offset = (unsigned short)offsetof(mcaRecord, r10nm);
    prt->papFldDes[mcaRecordR11NM]->size = sizeof(prec->r11nm);
    prt->papFldDes[mcaRecordR11NM]->offset = (unsigned short)offsetof(mcaRecord, r11nm);
    prt->papFldDes[mcaRecordR12NM]->size = sizeof(prec->r12nm);
    prt->papFldDes[mcaRecordR12NM]->offset = (unsigned short)offsetof(mcaRecord, r12nm);
    prt->papFldDes[mcaRecordR13NM]->size = sizeof(prec->r13nm);
    prt->papFldDes[mcaRecordR13NM]->offset = (unsigned short)offsetof(mcaRecord, r13nm);
    prt->papFldDes[mcaRecordR14NM]->size = sizeof(prec->r14nm);
    prt->papFldDes[mcaRecordR14NM]->offset = (unsigned short)offsetof(mcaRecord, r14nm);
    prt->papFldDes[mcaRecordR15NM]->size = sizeof(prec->r15nm);
    prt->papFldDes[mcaRecordR15NM]->offset = (unsigned short)offsetof(mcaRecord, r15nm);
    prt->papFldDes[mcaRecordR16NM]->size = sizeof(prec->r16nm);
    prt->papFldDes[mcaRecordR16NM]->offset = (unsigned short)offsetof(mcaRecord, r16nm);
    prt->papFldDes[mcaRecordR17NM]->size = sizeof(prec->r17nm);
    prt->papFldDes[mcaRecordR17NM]->offset = (unsigned short)offsetof(mcaRecord, r17nm);
    prt->papFldDes[mcaRecordR18NM]->size = sizeof(prec->r18nm);
    prt->papFldDes[mcaRecordR18NM]->offset = (unsigned short)offsetof(mcaRecord, r18nm);
    prt->papFldDes[mcaRecordR19NM]->size = sizeof(prec->r19nm);
    prt->papFldDes[mcaRecordR19NM]->offset = (unsigned short)offsetof(mcaRecord, r19nm);
    prt->papFldDes[mcaRecordR20NM]->size = sizeof(prec->r20nm);
    prt->papFldDes[mcaRecordR20NM]->offset = (unsigned short)offsetof(mcaRecord, r20nm);
    prt->papFldDes[mcaRecordR21NM]->size = sizeof(prec->r21nm);
    prt->papFldDes[mcaRecordR21NM]->offset = (unsigned short)offsetof(mcaRecord, r21nm);
    prt->papFldDes[mcaRecordR22NM]->size = sizeof(prec->r22nm);
    prt->papFldDes[mcaRecordR22NM]->offset = (unsigned short)offsetof(mcaRecord, r22nm);
    prt->papFldDes[mcaRecordR23NM]->size = sizeof(prec->r23nm);
    prt->papFldDes[mcaRecordR23NM]->offset = (unsigned short)offsetof(mcaRecord, r23nm);
    prt->papFldDes[mcaRecordR24NM]->size = sizeof(prec->r24nm);
    prt->papFldDes[mcaRecordR24NM]->offset = (unsigned short)offsetof(mcaRecord, r24nm);
    prt->papFldDes[mcaRecordR25NM]->size = sizeof(prec->r25nm);
    prt->papFldDes[mcaRecordR25NM]->offset = (unsigned short)offsetof(mcaRecord, r25nm);
    prt->papFldDes[mcaRecordR26NM]->size = sizeof(prec->r26nm);
    prt->papFldDes[mcaRecordR26NM]->offset = (unsigned short)offsetof(mcaRecord, r26nm);
    prt->papFldDes[mcaRecordR27NM]->size = sizeof(prec->r27nm);
    prt->papFldDes[mcaRecordR27NM]->offset = (unsigned short)offsetof(mcaRecord, r27nm);
    prt->papFldDes[mcaRecordR28NM]->size = sizeof(prec->r28nm);
    prt->papFldDes[mcaRecordR28NM]->offset = (unsigned short)offsetof(mcaRecord, r28nm);
    prt->papFldDes[mcaRecordR29NM]->size = sizeof(prec->r29nm);
    prt->papFldDes[mcaRecordR29NM]->offset = (unsigned short)offsetof(mcaRecord, r29nm);
    prt->papFldDes[mcaRecordR30NM]->size = sizeof(prec->r30nm);
    prt->papFldDes[mcaRecordR30NM]->offset = (unsigned short)offsetof(mcaRecord, r30nm);
    prt->papFldDes[mcaRecordR31NM]->size = sizeof(prec->r31nm);
    prt->papFldDes[mcaRecordR31NM]->offset = (unsigned short)offsetof(mcaRecord, r31nm);
