...
| ⋮                                                                                  ||||||||
| OUTP  | Output Spec P              | OUTLINK       | Yes |         | Yes  | Yes   | No    |
...
1. If OMSL is "closed\_loop" and DOL is not a constant link read the new value
...
5. Check severity and then send the value through the OUTA-OUTP links, depending
...
6. Value and archive monitors are posted on the VAL field if appropriate based on
