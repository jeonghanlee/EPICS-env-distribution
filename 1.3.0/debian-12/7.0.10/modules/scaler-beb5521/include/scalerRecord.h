...
static int scalerRecordSizeOffset(dbRecordType *prt)
{
    ...
    prt->papFldDes[scalerRecordNAME]->offset = (unsigned short)offsetof(scalerRecord, name);
    prt->papFldDes[scalerRecordDESC]->size = sizeof(prec->desc);
    prt->papFldDes[scalerRecordDESC]->offset = (unsigned short)offsetof(scalerRecord, desc);
    prt->papFldDes[scalerRecordASG]->size = sizeof(prec->asg);
    prt->papFldDes[scalerRecordASG]->offset = (unsigned short)offsetof(scalerRecord, asg);
    prt->papFldDes[scalerRecordSCAN]->size = sizeof(prec->scan);
    prt->papFldDes[scalerRecordSCAN]->offset = (unsigned short)offsetof(scalerRecord, scan);
    prt->papFldDes[scalerRecordPINI]->size = sizeof(prec->pini);
    prt->papFldDes[scalerRecordPINI]->offset = (unsigned short)offsetof(scalerRecord, pini);
    prt->papFldDes[scalerRecordPHAS]->size = sizeof(prec->phas);
    prt->papFldDes[scalerRecordPHAS]->offset = (unsigned short)offsetof(scalerRecord, phas);
    prt->papFldDes[scalerRecordEVNT]->size = sizeof(prec->evnt);
    prt->papFldDes[scalerRecordEVNT]->offset = (unsigned short)offsetof(scalerRecord, evnt);
    prt->papFldDes[scalerRecordTSE]->size = sizeof(prec->tse);
    prt->papFldDes[scalerRecordTSE]->offset = (unsigned short)offsetof(scalerRecord, tse);
    prt->papFldDes[scalerRecordTSEL]->size = sizeof(prec->tsel);
    prt->papFldDes[scalerRecordTSEL]->offset = (unsigned short)offsetof(scalerRecord, tsel);
    prt->papFldDes[scalerRecordDTYP]->size = sizeof(prec->dtyp);
    prt->papFldDes[scalerRecordDTYP]->offset = (unsigned short)offsetof(scalerRecord, dtyp);
    prt->papFldDes[scalerRecordDISV]->size = sizeof(prec->disv);
    prt->papFldDes[scalerRecordDISV]->offset = (unsigned short)offsetof(scalerRecord, disv);
    prt->papFldDes[scalerRecordDISA]->size = sizeof(prec->disa);
    prt->papFldDes[scalerRecordDISA]->offset = (unsigned short)offsetof(scalerRecord, disa);
    prt->papFldDes[scalerRecordSDIS]->size = sizeof(prec->sdis);
    prt->papFldDes[scalerRecordSDIS]->offset = (unsigned short)offsetof(scalerRecord, sdis);
    prt->papFldDes[scalerRecordMLOK]->size = sizeof(prec->mlok);
    prt->papFldDes[scalerRecordMLOK]->offset = (unsigned short)offsetof(scalerRecord, mlok);
    prt->papFldDes[scalerRecordMLIS]->size = sizeof(prec->mlis);
    prt->papFldDes[scalerRecordMLIS]->offset = (unsigned short)offsetof(scalerRecord, mlis);
    prt->papFldDes[scalerRecordBKLNK]->size = sizeof(prec->bklnk);
    prt->papFldDes[scalerRecordBKLNK]->offset = (unsigned short)offsetof(scalerRecord, bklnk);
    prt->papFldDes[scalerRecordDISP]->size = sizeof(prec->disp);
    prt->papFldDes[scalerRecordDISP]->offset = (unsigned short)offsetof(scalerRecord, disp);
    prt->papFldDes[scalerRecordPROC]->size = sizeof(prec->proc);
    prt->papFldDes[scalerRecordPROC]->offset = (unsigned short)offsetof(scalerRecord, proc);
    prt->papFldDes[scalerRecordSTAT]->size = sizeof(prec->stat);
    prt->papFldDes[scalerRecordSTAT]->offset = (unsigned short)offsetof(scalerRecord, stat);
    prt->papFldDes[scalerRecordSEVR]->size = sizeof(prec->sevr);
    prt->papFldDes[scalerRecordSEVR]->offset = (unsigned short)offsetof(scalerRecord, sevr);
    prt->papFldDes[scalerRecordAMSG]->size = sizeof(prec->amsg);
    prt->papFldDes[scalerRecordAMSG]->offset = (unsigned short)offsetof(scalerRecord, amsg);
    prt->papFldDes[scalerRecordNSTA]->size = sizeof(prec->nsta);
    prt->papFldDes[scalerRecordNSTA]->offset = (unsigned short)offsetof(scalerRecord, nsta);
    prt->papFldDes[scalerRecordNSEV]->size = sizeof(prec->nsev);
    prt->papFldDes[scalerRecordNSEV]->offset = (unsigned short)offsetof(scalerRecord, nsev);
    prt->papFldDes[scalerRecordNAMSG]->size = sizeof(prec->namsg);
    prt->papFldDes[scalerRecordNAMSG]->offset = (unsigned short)offsetof(scalerRecord, namsg);
    prt->papFldDes[scalerRecordACKS]->size = sizeof(prec->acks);
    prt->papFldDes[scalerRecordACKS]->offset = (unsigned short)offsetof(scalerRecord, acks);
    prt->papFldDes[scalerRecordACKT]->size = sizeof(prec->ackt);
    prt->papFldDes[scalerRecordACKT]->offset = (unsigned short)offsetof(scalerRecord, ackt);
    prt->papFldDes[scalerRecordDISS]->size = sizeof(prec->diss);
    prt->papFldDes[scalerRecordDISS]->offset = (unsigned short)offsetof(scalerRecord, diss);
    prt->papFldDes[scalerRecordLCNT]->size = sizeof(prec->lcnt);
    prt->papFldDes[scalerRecordLCNT]->offset = (unsigned short)offsetof(scalerRecord, lcnt);
    prt->papFldDes[scalerRecordPACT]->size = sizeof(prec->pact);
    prt->papFldDes[scalerRecordPACT]->offset = (unsigned short)offsetof(scalerRecord, pact);
    prt->papFldDes[scalerRecordPUTF]->size = sizeof(prec->putf);
    prt->papFldDes[scalerRecordPUTF]->offset = (unsigned short)offsetof(scalerRecord, putf);
    prt->papFldDes[scalerRecordRPRO]->size = sizeof(prec->rpro);
    prt->papFldDes[scalerRecordRPRO]->offset = (unsigned short)offsetof(scalerRecord, rpro);
    prt->papFldDes[scalerRecordASP]->size = sizeof(prec->asp);
    prt->papFldDes[scalerRecordASP]->offset = (unsigned short)offsetof(scalerRecord, asp);
    prt->papFldDes[scalerRecordPPN]->size = sizeof(prec->ppn);
    prt->papFldDes[scalerRecordPPN]->offset = (unsigned short)offsetof(scalerRecord, ppn);
    prt->papFldDes[scalerRecordPPNR]->size = sizeof(prec->ppnr);
    prt->papFldDes[scalerRecordPPNR]->offset = (unsigned short)offsetof(scalerRecord, ppnr);
    prt->papFldDes[scalerRecordSPVT]->size = sizeof(prec->spvt);
    prt->papFldDes[scalerRecordSPVT]->offset = (unsigned short)offsetof(scalerRecord, spvt);
    prt->papFldDes[scalerRecordRSET]->size = sizeof(prec->rset);
    prt->papFldDes[scalerRecordRSET]->offset = (unsigned short)offsetof(scalerRecord, rset);
    prt->papFldDes[scalerRecordDSET]->size = sizeof(prec->dset);
    prt->papFldDes[scalerRecordDSET]->offset = (unsigned short)offsetof(scalerRecord, dset);
    prt->papFldDes[scalerRecordDPVT]->size = sizeof(prec->dpvt);
    prt->papFldDes[scalerRecordDPVT]->offset = (unsigned short)offsetof(scalerRecord, dpvt);
    prt->papFldDes[scalerRecordRDES]->size = sizeof(prec->rdes);
    prt->papFldDes[scalerRecordRDES]->offset = (unsigned short)offsetof(scalerRecord, rdes);
    prt->papFldDes[scalerRecordLSET]->size = sizeof(prec->lset);
    prt->papFldDes[scalerRecordLSET]->offset = (unsigned short)offsetof(scalerRecord, lset);
    prt->papFldDes[scalerRecordPRIO]->size = sizeof(prec->prio);
    prt->papFldDes[scalerRecordPRIO]->offset = (unsigned short)offsetof(scalerRecord, prio);
    prt->papFldDes[scalerRecordTPRO]->size = sizeof(prec->tpro);
    prt->papFldDes[scalerRecordTPRO]->offset = (unsigned short)offsetof(scalerRecord, tpro);
    prt->papFldDes[scalerRecordBKPT]->size = sizeof(prec->bkpt);
    prt->papFldDes[scalerRecordBKPT]->offset = (unsigned short)offsetof(scalerRecord, bkpt);
    prt->papFldDes[scalerRecordUDF]->size = sizeof(prec->udf);
    prt->papFldDes[scalerRecordUDF]->offset = (unsigned short)offsetof(scalerRecord, udf);
    prt->papFldDes[scalerRecordUDFS]->size = sizeof(prec->udfs);
    prt->papFldDes[scalerRecordUDFS]->offset = (unsigned short)offsetof(scalerRecord, udfs);
    prt->papFldDes[scalerRecordTIME]->size = sizeof(prec->time);
    prt->papFldDes[scalerRecordTIME]->offset = (unsigned short)offsetof(scalerRecord, time);
    prt->papFldDes[scalerRecordUTAG]->size = sizeof(prec->utag);
    prt->papFldDes[scalerRecordUTAG]->offset = (unsigned short)offsetof(scalerRecord, utag);
    prt->papFldDes[scalerRecordFLNK]->size = sizeof(prec->flnk);
    prt->papFldDes[scalerRecordFLNK]->offset = (unsigned short)offsetof(scalerRecord, flnk);
    prt->papFldDes[scalerRecordVERS]->size = sizeof(prec->vers);
    prt->papFldDes[scalerRecordVERS]->offset = (unsigned short)offsetof(scalerRecord, vers);
    prt->papFldDes[scalerRecordRPVT]->size = sizeof(prec->rpvt);
    prt->papFldDes[scalerRecordRPVT]->offset = (unsigned short)offsetof(scalerRecord, rpvt);
    prt->papFldDes[scalerRecordVAL]->size = sizeof(prec->val);
    prt->papFldDes[scalerRecordVAL]->offset = (unsigned short)offsetof(scalerRecord, val);
    prt->papFldDes[scalerRecordFREQ]->size = sizeof(prec->freq);
    prt->papFldDes[scalerRecordFREQ]->offset = (unsigned short)offsetof(scalerRecord, freq);
    prt->papFldDes[scalerRecordCNT]->size = sizeof(prec->cnt);
    prt->papFldDes[scalerRecordCNT]->offset = (unsigned short)offsetof(scalerRecord, cnt);
    prt->papFldDes[scalerRecordPCNT]->size = sizeof(prec->pcnt);
    prt->papFldDes[scalerRecordPCNT]->offset = (unsigned short)offsetof(scalerRecord, pcnt);
    prt->papFldDes[scalerRecordSS]->size = sizeof(prec->ss);
    prt->papFldDes[scalerRecordSS]->offset = (unsigned short)offsetof(scalerRecord, ss);
    prt->papFldDes[scalerRecordUS]->size = sizeof(prec->us);
    prt->papFldDes[scalerRecordUS]->offset = (unsigned short)offsetof(scalerRecord, us);
    prt->papFldDes[scalerRecordCONT]->size = sizeof(prec->cont);
    prt->papFldDes[scalerRecordCONT]->offset = (unsigned short)offsetof(scalerRecord, cont);
    prt->papFldDes[scalerRecordOUT]->size = sizeof(prec->out);
    prt->papFldDes[scalerRecordOUT]->offset = (unsigned short)offsetof(scalerRecord, out);
    prt->papFldDes[scalerRecordRATE]->size = sizeof(prec->rate);
    prt->papFldDes[scalerRecordRATE]->offset = (unsigned short)offsetof(scalerRecord, rate);
    prt->papFldDes[scalerRecordRAT1]->size = sizeof(prec->rat1);
    prt->papFldDes[scalerRecordRAT1]->offset = (unsigned short)offsetof(scalerRecord, rat1);
    prt->papFldDes[scalerRecordDLY]->size = sizeof(prec->dly);
    prt->papFldDes[scalerRecordDLY]->offset = (unsigned short)offsetof(scalerRecord, dly);
    prt->papFldDes[scalerRecordDLY1]->size = sizeof(prec->dly1);
    prt->papFldDes[scalerRecordDLY1]->offset = (unsigned short)offsetof(scalerRecord, dly1);
    prt->papFldDes[scalerRecordNCH]->size = sizeof(prec->nch);
    prt->papFldDes[scalerRecordNCH]->offset = (unsigned short)offsetof(scalerRecord, nch);
    prt->papFldDes[scalerRecordD1]->size = sizeof(prec->d1);
    prt->papFldDes[scalerRecordD1]->offset = (unsigned short)offsetof(scalerRecord, d1);
    prt->papFldDes[scalerRecordD2]->size = sizeof(prec->d2);
    prt->papFldDes[scalerRecordD2]->offset = (unsigned short)offsetof(scalerRecord, d2);
    prt->papFldDes[scalerRecordD3]->size = sizeof(prec->d3);
    prt->papFldDes[scalerRecordD3]->offset = (unsigned short)offsetof(scalerRecord, d3);
    prt->papFldDes[scalerRecordD4]->size = sizeof(prec->d4);
    prt->papFldDes[scalerRecordD4]->offset = (unsigned short)offsetof(scalerRecord, d4);
    prt->papFldDes[scalerRecordD5]->size = sizeof(prec->d5);
    prt->papFldDes[scalerRecordD5]->offset = (unsigned short)offsetof(scalerRecord, d5);
    prt->papFldDes[scalerRecordD6]->size = sizeof(prec->d6);
    prt->papFldDes[scalerRecordD6]->offset = (unsigned short)offsetof(scalerRecord, d6);
    prt->papFldDes[scalerRecordD7]->size = sizeof(prec->d7);
    prt->papFldDes[scalerRecordD7]->offset = (unsigned short)offsetof(scalerRecord, d7);
    prt->papFldDes[scalerRecordD8]->size = sizeof(prec->d8);
    prt->papFldDes[scalerRecordD8]->offset = (unsigned short)offsetof(scalerRecord, d8);
    prt->papFldDes[scalerRecordD9]->size = sizeof(prec->d9);
    prt->papFldDes[scalerRecordD9]->offset = (unsigned short)offsetof(scalerRecord, d9);
    prt->papFldDes[scalerRecordD10]->size = sizeof(prec->d10);
    prt->papFldDes[scalerRecordD10]->offset = (unsigned short)offsetof(scalerRecord, d10);
    prt->papFldDes[scalerRecordD11]->size = sizeof(prec->d11);
    prt->papFldDes[scalerRecordD11]->offset = (unsigned short)offsetof(scalerRecord, d11);
    prt->papFldDes[scalerRecordD12]->size = sizeof(prec->d12);
    prt->papFldDes[scalerRecordD12]->offset = (unsigned short)offsetof(scalerRecord, d12);
    prt->papFldDes[scalerRecordD13]->size = sizeof(prec->d13);
    prt->papFldDes[scalerRecordD13]->offset = (unsigned short)offsetof(scalerRecord, d13);
    prt->papFldDes[scalerRecordD14]->size = sizeof(prec->d14);
    prt->papFldDes[scalerRecordD14]->offset = (unsigned short)offsetof(scalerRecord, d14);
    prt->papFldDes[scalerRecordD15]->size = sizeof(prec->d15);
    prt->papFldDes[scalerRecordD15]->offset = (unsigned short)offsetof(scalerRecord, d15);
    prt->papFldDes[scalerRecordD16]->size = sizeof(prec->d16);
    prt->papFldDes[scalerRecordD16]->offset = (unsigned short)offsetof(scalerRecord, d16);
    prt->papFldDes[scalerRecordD17]->size = sizeof(prec->d17);
    prt->papFldDes[scalerRecordD17]->offset = (unsigned short)offsetof(scalerRecord, d17);
    prt->papFldDes[scalerRecordD18]->size = sizeof(prec->d18);
    prt->papFldDes[scalerRecordD18]->offset = (unsigned short)offsetof(scalerRecord, d18);
    prt->papFldDes[scalerRecordD19]->size = sizeof(prec->d19);
    prt->papFldDes[scalerRecordD19]->offset = (unsigned short)offsetof(scalerRecord, d19);
    prt->papFldDes[scalerRecordD20]->size = sizeof(prec->d20);
    prt->papFldDes[scalerRecordD20]->offset = (unsigned short)offsetof(scalerRecord, d20);
    prt->papFldDes[scalerRecordD21]->size = sizeof(prec->d21);
    prt->papFldDes[scalerRecordD21]->offset = (unsigned short)offsetof(scalerRecord, d21);
    prt->papFldDes[scalerRecordD22]->size = sizeof(prec->d22);
    prt->papFldDes[scalerRecordD22]->offset = (unsigned short)offsetof(scalerRecord, d22);
    prt->papFldDes[scalerRecordD23]->size = sizeof(prec->d23);
    prt->papFldDes[scalerRecordD23]->offset = (unsigned short)offsetof(scalerRecord, d23);
    prt->papFldDes[scalerRecordD24]->size = sizeof(prec->d24);
    prt->papFldDes[scalerRecordD24]->offset = (unsigned short)offsetof(scalerRecord, d24);
    prt->papFldDes[scalerRecordD25]->size = sizeof(prec->d25);
    prt->papFldDes[scalerRecordD25]->offset = (unsigned short)offsetof(scalerRecord, d25);
    prt->papFldDes[scalerRecordD26]->size = sizeof(prec->d26);
    prt->papFldDes[scalerRecordD26]->offset = (unsigned short)offsetof(scalerRecord, d26);
    prt->papFldDes[scalerRecordD27]->size = sizeof(prec->d27);
    prt->papFldDes[scalerRecordD27]->offset = (unsigned short)offsetof(scalerRecord, d27);
    prt->papFldDes[scalerRecordD28]->size = sizeof(prec->d28);
    prt->papFldDes[scalerRecordD28]->offset = (unsigned short)offsetof(scalerRecord, d28);
    prt->papFldDes[scalerRecordD29]->size = sizeof(prec->d29);
    prt->papFldDes[scalerRecordD29]->offset = (unsigned short)offsetof(scalerRecord, d29);
    prt->papFldDes[scalerRecordD30]->size = sizeof(prec->d30);
    prt->papFldDes[scalerRecordD30]->offset = (unsigned short)offsetof(scalerRecord, d30);
    prt->papFldDes[scalerRecordD31]->size = sizeof(prec->d31);
    prt->papFldDes[scalerRecordD31]->offset = (unsigned short)offsetof(scalerRecord, d31);
    prt->papFldDes[scalerRecordD32]->size = sizeof(prec->d32);
    prt->papFldDes[scalerRecordD32]->offset = (unsigned short)offsetof(scalerRecord, d32);
    prt->papFldDes[scalerRecordD33]->size = sizeof(prec->d33);
    prt->papFldDes[scalerRecordD33]->offset = (unsigned short)offsetof(scalerRecord, d33);
    prt->papFldDes[scalerRecordD34]->size = sizeof(prec->d34);
    prt->papFldDes[scalerRecordD34]->offset = (unsigned short)offsetof(scalerRecord, d34);
    prt->papFldDes[scalerRecordD35]->size = sizeof(prec->d35);
    prt->papFldDes[scalerRecordD35]->offset = (unsigned short)offsetof(scalerRecord, d35);
    prt->papFldDes[scalerRecordD36]->size = sizeof(prec->d36);
    prt->papFldDes[scalerRecordD36]->offset = (unsigned short)offsetof(scalerRecord, d36);
    prt->papFldDes[scalerRecordD37]->size = sizeof(prec->d37);
    prt->papFldDes[scalerRecordD37]->offset = (unsigned short)offsetof(scalerRecord, d37);
    prt->papFldDes[scalerRecordD38]->size = sizeof(prec->d38);
    prt->papFldDes[scalerRecordD38]->offset = (unsigned short)offsetof(scalerRecord, d38);
    prt->papFldDes[scalerRecordD39]->size = sizeof(prec->d39);
    prt->papFldDes[scalerRecordD39]->offset = (unsigned short)offsetof(scalerRecord, d39);
    prt->papFldDes[scalerRecordD40]->size = sizeof(prec->d40);
    prt->papFldDes[scalerRecordD40]->offset = (unsigned short)offsetof(scalerRecord, d40);
    prt->papFldDes[scalerRecordD41]->size = sizeof(prec->d41);
    prt->papFldDes[scalerRecordD41]->offset = (unsigned short)offsetof(scalerRecord, d41);
    prt->papFldDes[scalerRecordD42]->size = sizeof(prec->d42);
    prt->papFldDes[scalerRecordD42]->offset = (unsigned short)offsetof(scalerRecord, d42);
    prt->papFldDes[scalerRecordD43]->size = sizeof(prec->d43);
    prt->papFldDes[scalerRecordD43]->offset = (unsigned short)offsetof(scalerRecord, d43);
    prt->papFldDes[scalerRecordD44]->size = sizeof(prec->d44);
    prt->papFldDes[scalerRecordD44]->offset = (unsigned short)offsetof(scalerRecord, d44);
    prt->papFldDes[scalerRecordD45]->size = sizeof(prec->d45);
    prt->papFldDes[scalerRecordD45]->offset = (unsigned short)offsetof(scalerRecord, d45);
    prt->papFldDes[scalerRecordD46]->size = sizeof(prec->d46);
    prt->papFldDes[scalerRecordD46]->offset = (unsigned short)offsetof(scalerRecord, d46);
    prt->papFldDes[scalerRecordD47]->size = sizeof(prec->d47);
    prt->papFldDes[scalerRecordD47]->offset = (unsigned short)offsetof(scalerRecord, d47);
    prt->papFldDes[scalerRecordD48]->size = sizeof(prec->d48);
    prt->papFldDes[scalerRecordD48]->offset = (unsigned short)offsetof(scalerRecord, d48);
    prt->papFldDes[scalerRecordD49]->size = sizeof(prec->d49);
    prt->papFldDes[scalerRecordD49]->offset = (unsigned short)offsetof(scalerRecord, d49);
    prt->papFldDes[scalerRecordD50]->size = sizeof(prec->d50);
    prt->papFldDes[scalerRecordD50]->offset = (unsigned short)offsetof(scalerRecord, d50);
    prt->papFldDes[scalerRecordD51]->size = sizeof(prec->d51);
    prt->papFldDes[scalerRecordD51]->offset = (unsigned short)offsetof(scalerRecord, d51);
    prt->papFldDes[scalerRecordD52]->size = sizeof(prec->d52);
    prt->papFldDes[scalerRecordD52]->offset = (unsigned short)offsetof(scalerRecord, d52);
    prt->papFldDes[scalerRecordD53]->size = sizeof(prec->d53);
    prt->papFldDes[scalerRecordD53]->offset = (unsigned short)offsetof(scalerRecord, d53);
    prt->papFldDes[scalerRecordD54]->size = sizeof(prec->d54);
    prt->papFldDes[scalerRecordD54]->offset = (unsigned short)offsetof(scalerRecord, d54);
    prt->papFldDes[scalerRecordD55]->size = sizeof(prec->d55);
    prt->papFldDes[scalerRecordD55]->offset = (unsigned short)offsetof(scalerRecord, d55);
    prt->papFldDes[scalerRecordD56]->size = sizeof(prec->d56);
    prt->papFldDes[scalerRecordD56]->offset = (unsigned short)offsetof(scalerRecord, d56);
    prt->papFldDes[scalerRecordD57]->size = sizeof(prec->d57);
    prt->papFldDes[scalerRecordD57]->offset = (unsigned short)offsetof(scalerRecord, d57);
    prt->papFldDes[scalerRecordD58]->size = sizeof(prec->d58);
    prt->papFldDes[scalerRecordD58]->offset = (unsigned short)offsetof(scalerRecord, d58);
    prt->papFldDes[scalerRecordD59]->size = sizeof(prec->d59);
    prt->papFldDes[scalerRecordD59]->offset = (unsigned short)offsetof(scalerRecord, d59);
    prt->papFldDes[scalerRecordD60]->size = sizeof(prec->d60);
    prt->papFldDes[scalerRecordD60]->offset = (unsigned short)offsetof(scalerRecord, d60);
    prt->papFldDes[scalerRecordD61]->size = sizeof(prec->d61);
    prt->papFldDes[scalerRecordD61]->offset = (unsigned short)offsetof(scalerRecord, d61);
    prt->papFldDes[scalerRecordD62]->size = sizeof(prec->d62);
    prt->papFldDes[scalerRecordD62]->offset = (unsigned short)offsetof(scalerRecord, d62);
    prt->papFldDes[scalerRecordD63]->size = sizeof(prec->d63);
    prt->papFldDes[scalerRecordD63]->offset = (unsigned short)offsetof(scalerRecord, d63);
    prt->papFldDes[scalerRecordD64]->size = sizeof(prec->d64);
    prt->papFldDes[scalerRecordD64]->offset = (unsigned short)offsetof(scalerRecord, d64);
    prt->papFldDes[scalerRecordG1]->size = sizeof(prec->g1);
    prt->papFldDes[scalerRecordG1]->offset = (unsigned short)offsetof(scalerRecord, g1);
    prt->papFldDes[scalerRecordG2]->size = sizeof(prec->g2);
    prt->papFldDes[scalerRecordG2]->offset = (unsigned short)offsetof(scalerRecord, g2);
    prt->papFldDes[scalerRecordG3]->size = sizeof(prec->g3);
    prt->papFldDes[scalerRecordG3]->offset = (unsigned short)offsetof(scalerRecord, g3);
    prt->papFldDes[scalerRecordG4]->size = sizeof(prec->g4);
    prt->papFldDes[scalerRecordG4]->offset = (unsigned short)offsetof(scalerRecord, g4);
    prt->papFldDes[scalerRecordG5]->size = sizeof(prec->g5);
    prt->papFldDes[scalerRecordG5]->offset = (unsigned short)offsetof(scalerRecord, g5);
    prt->papFldDes[scalerRecordG6]->size = sizeof(prec->g6);
    prt->papFldDes[scalerRecordG6]->offset = (unsigned short)offsetof(scalerRecord, g6);
    prt->papFldDes[scalerRecordG7]->size = sizeof(prec->g7);
    prt->papFldDes[scalerRecordG7]->offset = (unsigned short)offsetof(scalerRecord, g7);
    prt->papFldDes[scalerRecordG8]->size = sizeof(prec->g8);
    prt->papFldDes[scalerRecordG8]->offset = (unsigned short)offsetof(scalerRecord, g8);
    prt->papFldDes[scalerRecordG9]->size = sizeof(prec->g9);
    prt->papFldDes[scalerRecordG9]->offset = (unsigned short)offsetof(scalerRecord, g9);
    prt->papFldDes[scalerRecordG10]->size = sizeof(prec->g10);
    prt->papFldDes[scalerRecordG10]->offset = (unsigned short)offsetof(scalerRecord, g10);
    prt->papFldDes[scalerRecordG11]->size = sizeof(prec->g11);
    prt->papFldDes[scalerRecordG11]->offset = (unsigned short)offsetof(scalerRecord, g11);
    prt->papFldDes[scalerRecordG12]->size = sizeof(prec->g12);
    prt->papFldDes[scalerRecordG12]->offset = (unsigned short)offsetof(scalerRecord, g12);
    prt->papFldDes[scalerRecordG13]->size = sizeof(prec->g13);
    prt->papFldDes[scalerRecordG13]->offset = (unsigned short)offsetof(scalerRecord, g13);
    prt->papFldDes[scalerRecordG14]->size = sizeof(prec->g14);
    prt->papFldDes[scalerRecordG14]->offset = (unsigned short)offsetof(scalerRecord, g14);
    prt->papFldDes[scalerRecordG15]->size = sizeof(prec->g15);
    prt->papFldDes[scalerRecordG15]->offset = (unsigned short)offsetof(scalerRecord, g15);
    prt->papFldDes[scalerRecordG16]->size = sizeof(prec->g16);
    prt->papFldDes[scalerRecordG16]->offset = (unsigned short)offsetof(scalerRecord, g16);
    prt->papFldDes[scalerRecordG17]->size = sizeof(prec->g17);
    prt->papFldDes[scalerRecordG17]->offset = (unsigned short)offsetof(scalerRecord, g17);
    prt->papFldDes[scalerRecordG18]->size = sizeof(prec->g18);
    prt->papFldDes[scalerRecordG18]->offset = (unsigned short)offsetof(scalerRecord, g18);
    prt->papFldDes[scalerRecordG19]->size = sizeof(prec->g19);
    prt->papFldDes[scalerRecordG19]->offset = (unsigned short)offsetof(scalerRecord, g19);
    prt->papFldDes[scalerRecordG20]->size = sizeof(prec->g20);
    prt->papFldDes[scalerRecordG20]->offset = (unsigned short)offsetof(scalerRecord, g20);
    prt->papFldDes[scalerRecordG21]->size = sizeof(prec->g21);
    prt->papFldDes[scalerRecordG21]->offset = (unsigned short)offsetof(scalerRecord, g21);
    prt->papFldDes[scalerRecordG22]->size = sizeof(prec->g22);
    prt->papFldDes[scalerRecordG22]->offset = (unsigned short)offsetof(scalerRecord, g22);
    prt->papFldDes[scalerRecordG23]->size = sizeof(prec->g23);
    prt->papFldDes[scalerRecordG23]->offset = (unsigned short)offsetof(scalerRecord, g23);
    prt->papFldDes[scalerRecordG24]->size = sizeof(prec->g24);
    prt->papFldDes[scalerRecordG24]->offset = (unsigned short)offsetof(scalerRecord, g24);
    prt->papFldDes[scalerRecordG25]->size = sizeof(prec->g25);
    prt->papFldDes[scalerRecordG25]->offset = (unsigned short)offsetof(scalerRecord, g25);
    prt->papFldDes[scalerRecordG26]->size = sizeof(prec->g26);
    prt->papFldDes[scalerRecordG26]->offset = (unsigned short)offsetof(scalerRecord, g26);
    prt->papFldDes[scalerRecordG27]->size = sizeof(prec->g27);
    prt->papFldDes[scalerRecordG27]->offset = (unsigned short)offsetof(scalerRecord, g27);
    prt->papFldDes[scalerRecordG28]->size = sizeof(prec->g28);
    prt->papFldDes[scalerRecordG28]->offset = (unsigned short)offsetof(scalerRecord, g28);
    prt->papFldDes[scalerRecordG29]->size = sizeof(prec->g29);
    prt->papFldDes[scalerRecordG29]->offset = (unsigned short)offsetof(scalerRecord, g29);
    prt->papFldDes[scalerRecordG30]->size = sizeof(prec->g30);
    prt->papFldDes[scalerRecordG30]->offset = (unsigned short)offsetof(scalerRecord, g30);
    prt->papFldDes[scalerRecordG31]->size = sizeof(prec->g31);
    prt->papFldDes[scalerRecordG31]->offset = (unsigned short)offsetof(scalerRecord, g31);
    prt->papFldDes[scalerRecordG32]->size = sizeof(prec->g32);
    prt->papFldDes[scalerRecordG32]->offset = (unsigned short)offsetof(scalerRecord, g32);
    prt->papFldDes[scalerRecordG33]->size = sizeof(prec->g33);
    prt->papFldDes[scalerRecordG33]->offset = (unsigned short)offsetof(scalerRecord, g33);
    prt->papFldDes[scalerRecordG34]->size = sizeof(prec->g34);
    prt->papFldDes[scalerRecordG34]->offset = (unsigned short)offsetof(scalerRecord, g34);
    prt->papFldDes[scalerRecordG35]->size = sizeof(prec->g35);
    prt->papFldDes[scalerRecordG35]->offset = (unsigned short)offsetof(scalerRecord, g35);
    prt->papFldDes[scalerRecordG36]->size = sizeof(prec->g36);
    prt->papFldDes[scalerRecordG36]->offset = (unsigned short)offsetof(scalerRecord, g36);
    prt->papFldDes[scalerRecordG37]->size = sizeof(prec->g37);
    prt->papFldDes[scalerRecordG37]->offset = (unsigned short)offsetof(scalerRecord, g37);
    prt->papFldDes[scalerRecordG38]->size = sizeof(prec->g38);
    prt->papFldDes[scalerRecordG38]->offset = (unsigned short)offsetof(scalerRecord, g38);
    prt->papFldDes[scalerRecordG39]->size = sizeof(prec->g39);
    prt->papFldDes[scalerRecordG39]->offset = (unsigned short)offsetof(scalerRecord, g39);
    prt->papFldDes[scalerRecordG40]->size = sizeof(prec->g40);
    prt->papFldDes[scalerRecordG40]->offset = (unsigned short)offsetof(scalerRecord, g40);
    prt->papFldDes[scalerRecordG41]->size = sizeof(prec->g41);
    prt->papFldDes[scalerRecordG41]->offset = (unsigned short)offsetof(scalerRecord, g41);
    prt->papFldDes[scalerRecordG42]->size = sizeof(prec->g42);
    prt->papFldDes[scalerRecordG42]->offset = (unsigned short)offsetof(scalerRecord, g42);
    prt->papFldDes[scalerRecordG43]->size = sizeof(prec->g43);
    prt->papFldDes[scalerRecordG43]->offset = (unsigned short)offsetof(scalerRecord, g43);
    prt->papFldDes[scalerRecordG44]->size = sizeof(prec->g44);
    prt->papFldDes[scalerRecordG44]->offset = (unsigned short)offsetof(scalerRecord, g44);
    prt->papFldDes[scalerRecordG45]->size = sizeof(prec->g45);
    prt->papFldDes[scalerRecordG45]->offset = (unsigned short)offsetof(scalerRecord, g45);
    prt->papFldDes[scalerRecordG46]->size = sizeof(prec->g46);
    prt->papFldDes[scalerRecordG46]->offset = (unsigned short)offsetof(scalerRecord, g46);
    prt->papFldDes[scalerRecordG47]->size = sizeof(prec->g47);
    prt->papFldDes[scalerRecordG47]->offset = (unsigned short)offsetof(scalerRecord, g47);
    prt->papFldDes[scalerRecordG48]->size = sizeof(prec->g48);
    prt->papFldDes[scalerRecordG48]->offset = (unsigned short)offsetof(scalerRecord, g48);
    prt->papFldDes[scalerRecordG49]->size = sizeof(prec->g49);
    prt->papFldDes[scalerRecordG49]->offset = (unsigned short)offsetof(scalerRecord, g49);
    prt->papFldDes[scalerRecordG50]->size = sizeof(prec->g50);
    prt->papFldDes[scalerRecordG50]->offset = (unsigned short)offsetof(scalerRecord, g50);
    prt->papFldDes[scalerRecordG51]->size = sizeof(prec->g51);
    prt->papFldDes[scalerRecordG51]->offset = (unsigned short)offsetof(scalerRecord, g51);
    prt->papFldDes[scalerRecordG52]->size = sizeof(prec->g52);
    prt->papFldDes[scalerRecordG52]->offset = (unsigned short)offsetof(scalerRecord, g52);
    prt->papFldDes[scalerRecordG53]->size = sizeof(prec->g53);
    prt->papFldDes[scalerRecordG53]->offset = (unsigned short)offsetof(scalerRecord, g53);
    prt->papFldDes[scalerRecordG54]->size = sizeof(prec->g54);
    prt->papFldDes[scalerRecordG54]->offset = (unsigned short)offsetof(scalerRecord, g54);
    prt->papFldDes[scalerRecordG55]->size = sizeof(prec->g55);
    prt->papFldDes[scalerRecordG55]->offset = (unsigned short)offsetof(scalerRecord, g55);
    prt->papFldDes[scalerRecordG56]->size = sizeof(prec->g56);
    prt->papFldDes[scalerRecordG56]->offset = (unsigned short)offsetof(scalerRecord, g56);
    prt->papFldDes[scalerRecordG57]->size = sizeof(prec->g57);
    prt->papFldDes[scalerRecordG57]->offset = (unsigned short)offsetof(scalerRecord, g57);
    prt->papFldDes[scalerRecordG58]->size = sizeof(prec->g58);
    prt->papFldDes[scalerRecordG58]->offset = (unsigned short)offsetof(scalerRecord, g58);
    prt->papFldDes[scalerRecordG59]->size = sizeof(prec->g59);
    prt->papFldDes[scalerRecordG59]->offset = (unsigned short)offsetof(scalerRecord, g59);
    prt->papFldDes[scalerRecordG60]->size = sizeof(prec->g60);
    prt->papFldDes[scalerRecordG60]->offset = (unsigned short)offsetof(scalerRecord, g60);
    prt->papFldDes[scalerRecordG61]->size = sizeof(prec->g61);
    prt->papFldDes[scalerRecordG61]->offset = (unsigned short)offsetof(scalerRecord, g61);
    prt->papFldDes[scalerRecordG62]->size = sizeof(prec->g62);
    prt->papFldDes[scalerRecordG62]->offset = (unsigned short)offsetof(scalerRecord, g62);
    prt->papFldDes[scalerRecordG63]->size = sizeof(prec->g63);
    prt->papFldDes[scalerRecordG63]->offset = (unsigned short)offsetof(scalerRecord, g63);
    prt->papFldDes[scalerRecordG64]->size = sizeof(prec->g64);
    prt->papFldDes[scalerRecordG64]->offset = (unsigned short)offsetof(scalerRecord, g64);
    prt->papFldDes[scalerRecordTP]->size = sizeof(prec->tp);
    prt->papFldDes[scalerRecordTP]->offset = (unsigned short)offsetof(scalerRecord, tp);
    prt->papFldDes[scalerRecordTP1]->size = sizeof(prec->tp1);
    prt->papFldDes[scalerRecordTP1]->offset = (unsigned short)offsetof(scalerRecord, tp1);
    prt->papFldDes[scalerRecordPR1]->size = sizeof(prec->pr1);
    prt->papFldDes[scalerRecordPR1]->offset = (unsigned short)offsetof(scalerRecord, pr1);
    prt->papFldDes[scalerRecordPR2]->size = sizeof(prec->pr2);
    prt->papFldDes[scalerRecordPR2]->offset = (unsigned short)offsetof(scalerRecord, pr2);
    prt->papFldDes[scalerRecordPR3]->size = sizeof(prec->pr3);
    prt->papFldDes[scalerRecordPR3]->offset = (unsigned short)offsetof(scalerRecord, pr3);
    prt->papFldDes[scalerRecordPR4]->size = sizeof(prec->pr4);
    prt->papFldDes[scalerRecordPR4]->offset = (unsigned short)offsetof(scalerRecord, pr4);
    prt->papFldDes[scalerRecordPR5]->size = sizeof(prec->pr5);
    prt->papFldDes[scalerRecordPR5]->offset = (unsigned short)offsetof(scalerRecord, pr5);
    prt->papFldDes[scalerRecordPR6]->size = sizeof(prec->pr6);
    prt->papFldDes[scalerRecordPR6]->offset = (unsigned short)offsetof(scalerRecord, pr6);
    prt->papFldDes[scalerRecordPR7]->size = sizeof(prec->pr7);
    prt->papFldDes[scalerRecordPR7]->offset = (unsigned short)offsetof(scalerRecord, pr7);
    prt->papFldDes[scalerRecordPR8]->size = sizeof(prec->pr8);
    prt->papFldDes[scalerRecordPR8]->offset = (unsigned short)offsetof(scalerRecord, pr8);
    prt->papFldDes[scalerRecordPR9]->size = sizeof(prec->pr9);
    prt->papFldDes[scalerRecordPR9]->offset = (unsigned short)offsetof(scalerRecord, pr9);
    prt->papFldDes[scalerRecordPR10]->size = sizeof(prec->pr10);
    prt->papFldDes[scalerRecordPR10]->offset = (unsigned short)offsetof(scalerRecord, pr10);
    prt->papFldDes[scalerRecordPR11]->size = sizeof(prec->pr11);
    prt->papFldDes[scalerRecordPR11]->offset = (unsigned short)offsetof(scalerRecord, pr11);
    prt->papFldDes[scalerRecordPR12]->size = sizeof(prec->pr12);
    prt->papFldDes[scalerRecordPR12]->offset = (unsigned short)offsetof(scalerRecord, pr12);
    prt->papFldDes[scalerRecordPR13]->size = sizeof(prec->pr13);
    prt->papFldDes[scalerRecordPR13]->offset = (unsigned short)offsetof(scalerRecord, pr13);
    prt->papFldDes[scalerRecordPR14]->size = sizeof(prec->pr14);
    prt->papFldDes[scalerRecordPR14]->offset = (unsigned short)offsetof(scalerRecord, pr14);
    prt->papFldDes[scalerRecordPR15]->size = sizeof(prec->pr15);
    prt->papFldDes[scalerRecordPR15]->offset = (unsigned short)offsetof(scalerRecord, pr15);
    prt->papFldDes[scalerRecordPR16]->size = sizeof(prec->pr16);
    prt->papFldDes[scalerRecordPR16]->offset = (unsigned short)offsetof(scalerRecord, pr16);
    prt->papFldDes[scalerRecordPR17]->size = sizeof(prec->pr17);
    prt->papFldDes[scalerRecordPR17]->offset = (unsigned short)offsetof(scalerRecord, pr17);
    prt->papFldDes[scalerRecordPR18]->size = sizeof(prec->pr18);
    prt->papFldDes[scalerRecordPR18]->offset = (unsigned short)offsetof(scalerRecord, pr18);
    prt->papFldDes[scalerRecordPR19]->size = sizeof(prec->pr19);
    prt->papFldDes[scalerRecordPR19]->offset = (unsigned short)offsetof(scalerRecord, pr19);
    prt->papFldDes[scalerRecordPR20]->size = sizeof(prec->pr20);
    prt->papFldDes[scalerRecordPR20]->offset = (unsigned short)offsetof(scalerRecord, pr20);
    prt->papFldDes[scalerRecordPR21]->size = sizeof(prec->pr21);
    prt->papFldDes[scalerRecordPR21]->offset = (unsigned short)offsetof(scalerRecord, pr21);
    prt->papFldDes[scalerRecordPR22]->size = sizeof(prec->pr22);
    prt->papFldDes[scalerRecordPR22]->offset = (unsigned short)offsetof(scalerRecord, pr22);
    prt->papFldDes[scalerRecordPR23]->size = sizeof(prec->pr23);
    prt->papFldDes[scalerRecordPR23]->offset = (unsigned short)offsetof(scalerRecord, pr23);
    prt->papFldDes[scalerRecordPR24]->size = sizeof(prec->pr24);
    prt->papFldDes[scalerRecordPR24]->offset = (unsigned short)offsetof(scalerRecord, pr24);
    prt->papFldDes[scalerRecordPR25]->size = sizeof(prec->pr25);
    prt->papFldDes[scalerRecordPR25]->offset = (unsigned short)offsetof(scalerRecord, pr25);
    prt->papFldDes[scalerRecordPR26]->size = sizeof(prec->pr26);
    prt->papFldDes[scalerRecordPR26]->offset = (unsigned short)offsetof(scalerRecord, pr26);
    prt->papFldDes[scalerRecordPR27]->size = sizeof(prec->pr27);
    prt->papFldDes[scalerRecordPR27]->offset = (unsigned short)offsetof(scalerRecord, pr27);
    prt->papFldDes[scalerRecordPR28]->size = sizeof(prec->pr28);
    prt->papFldDes[scalerRecordPR28]->offset = (unsigned short)offsetof(scalerRecord, pr28);
    prt->papFldDes[scalerRecordPR29]->size = sizeof(prec->pr29);
    prt->papFldDes[scalerRecordPR29]->offset = (unsigned short)offsetof(scalerRecord, pr29);
    prt->papFldDes[scalerRecordPR30]->size = sizeof(prec->pr30);
    prt->papFldDes[scalerRecordPR30]->offset = (unsigned short)offsetof(scalerRecord, pr30);
    prt->papFldDes[scalerRecordPR31]->size = sizeof(prec->pr31);
    prt->papFldDes[scalerRecordPR31]->offset = (unsigned short)offsetof(scalerRecord, pr31);
    prt->papFldDes[scalerRecordPR32]->size = sizeof(prec->pr32);
    prt->papFldDes[scalerRecordPR32]->offset = (unsigned short)offsetof(scalerRecord, pr32);
    prt->papFldDes[scalerRecordPR33]->size = sizeof(prec->pr33);
    prt->papFldDes[scalerRecordPR33]->offset = (unsigned short)offsetof(scalerRecord, pr33);
    prt->papFldDes[scalerRecordPR34]->size = sizeof(prec->pr34);
    prt->papFldDes[scalerRecordPR34]->offset = (unsigned short)offsetof(scalerRecord, pr34);
    prt->papFldDes[scalerRecordPR35]->size = sizeof(prec->pr35);
    prt->papFldDes[scalerRecordPR35]->offset = (unsigned short)offsetof(scalerRecord, pr35);
    prt->papFldDes[scalerRecordPR36]->size = sizeof(prec->pr36);
    prt->papFldDes[scalerRecordPR36]->offset = (unsigned short)offsetof(scalerRecord, pr36);
    prt->papFldDes[scalerRecordPR37]->size = sizeof(prec->pr37);
    prt->papFldDes[scalerRecordPR37]->offset = (unsigned short)offsetof(scalerRecord, pr37);
    prt->papFldDes[scalerRecordPR38]->size = sizeof(prec->pr38);
    prt->papFldDes[scalerRecordPR38]->offset = (unsigned short)offsetof(scalerRecord, pr38);
    prt->papFldDes[scalerRecordPR39]->size = sizeof(prec->pr39);
    prt->papFldDes[scalerRecordPR39]->offset = (unsigned short)offsetof(scalerRecord, pr39);
    prt->papFldDes[scalerRecordPR40]->size = sizeof(prec->pr40);
    prt->papFldDes[scalerRecordPR40]->offset = (unsigned short)offsetof(scalerRecord, pr40);
    prt->papFldDes[scalerRecordPR41]->size = sizeof(prec->pr41);
    prt->papFldDes[scalerRecordPR41]->offset = (unsigned short)offsetof(scalerRecord, pr41);
    prt->papFldDes[scalerRecordPR42]->size = sizeof(prec->pr42);
    prt->papFldDes[scalerRecordPR42]->offset = (unsigned short)offsetof(scalerRecord, pr42);
    prt->papFldDes[scalerRecordPR43]->size = sizeof(prec->pr43);
    prt->papFldDes[scalerRecordPR43]->offset = (unsigned short)offsetof(scalerRecord, pr43);
    prt->papFldDes[scalerRecordPR44]->size = sizeof(prec->pr44);
    prt->papFldDes[scalerRecordPR44]->offset = (unsigned short)offsetof(scalerRecord, pr44);
    prt->papFldDes[scalerRecordPR45]->size = sizeof(prec->pr45);
    prt->papFldDes[scalerRecordPR45]->offset = (unsigned short)offsetof(scalerRecord, pr45);
    prt->papFldDes[scalerRecordPR46]->size = sizeof(prec->pr46);
    prt->papFldDes[scalerRecordPR46]->offset = (unsigned short)offsetof(scalerRecord, pr46);
    prt->papFldDes[scalerRecordPR47]->size = sizeof(prec->pr47);
    prt->papFldDes[scalerRecordPR47]->offset = (unsigned short)offsetof(scalerRecord, pr47);
    prt->papFldDes[scalerRecordPR48]->size = sizeof(prec->pr48);
    prt->papFldDes[scalerRecordPR48]->offset = (unsigned short)offsetof(scalerRecord, pr48);
    prt->papFldDes[scalerRecordPR49]->size = sizeof(prec->pr49);
    prt->papFldDes[scalerRecordPR49]->offset = (unsigned short)offsetof(scalerRecord, pr49);
    prt->papFldDes[scalerRecordPR50]->size = sizeof(prec->pr50);
    prt->papFldDes[scalerRecordPR50]->offset = (unsigned short)offsetof(scalerRecord, pr50);
    prt->papFldDes[scalerRecordPR51]->size = sizeof(prec->pr51);
    prt->papFldDes[scalerRecordPR51]->offset = (unsigned short)offsetof(scalerRecord, pr51);
    prt->papFldDes[scalerRecordPR52]->size = sizeof(prec->pr52);
    prt->papFldDes[scalerRecordPR52]->offset = (unsigned short)offsetof(scalerRecord, pr52);
    prt->papFldDes[scalerRecordPR53]->size = sizeof(prec->pr53);
    prt->papFldDes[scalerRecordPR53]->offset = (unsigned short)offsetof(scalerRecord, pr53);
    prt->papFldDes[scalerRecordPR54]->size = sizeof(prec->pr54);
    prt->papFldDes[scalerRecordPR54]->offset = (unsigned short)offsetof(scalerRecord, pr54);
    prt->papFldDes[scalerRecordPR55]->size = sizeof(prec->pr55);
    prt->papFldDes[scalerRecordPR55]->offset = (unsigned short)offsetof(scalerRecord, pr55);
    prt->papFldDes[scalerRecordPR56]->size = sizeof(prec->pr56);
    prt->papFldDes[scalerRecordPR56]->offset = (unsigned short)offsetof(scalerRecord, pr56);
    prt->papFldDes[scalerRecordPR57]->size = sizeof(prec->pr57);
    prt->papFldDes[scalerRecordPR57]->offset = (unsigned short)offsetof(scalerRecord, pr57);
    prt->papFldDes[scalerRecordPR58]->size = sizeof(prec->pr58);
    prt->papFldDes[scalerRecordPR58]->offset = (unsigned short)offsetof(scalerRecord, pr58);
    prt->papFldDes[scalerRecordPR59]->size = sizeof(prec->pr59);
    prt->papFldDes[scalerRecordPR59]->offset = (unsigned short)offsetof(scalerRecord, pr59);
    prt->papFldDes[scalerRecordPR60]->size = sizeof(prec->pr60);
    prt->papFldDes[scalerRecordPR60]->offset = (unsigned short)offsetof(scalerRecord, pr60);
    prt->papFldDes[scalerRecordPR61]->size = sizeof(prec->pr61);
    prt->papFldDes[scalerRecordPR61]->offset = (unsigned short)offsetof(scalerRecord, pr61);
    prt->papFldDes[scalerRecordPR62]->size = sizeof(prec->pr62);
    prt->papFldDes[scalerRecordPR62]->offset = (unsigned short)offsetof(scalerRecord, pr62);
    prt->papFldDes[scalerRecordPR63]->size = sizeof(prec->pr63);
    prt->papFldDes[scalerRecordPR63]->offset = (unsigned short)offsetof(scalerRecord, pr63);
    prt->papFldDes[scalerRecordPR64]->size = sizeof(prec->pr64);
    prt->papFldDes[scalerRecordPR64]->offset = (unsigned short)offsetof(scalerRecord, pr64);
    prt->papFldDes[scalerRecordT]->size = sizeof(prec->t);
    prt->papFldDes[scalerRecordT]->offset = (unsigned short)offsetof(scalerRecord, t);
    prt->papFldDes[scalerRecordS1]->size = sizeof(prec->s1);
    prt->papFldDes[scalerRecordS1]->offset = (unsigned short)offsetof(scalerRecord, s1);
    prt->papFldDes[scalerRecordS2]->size = sizeof(prec->s2);
    prt->papFldDes[scalerRecordS2]->offset = (unsigned short)offsetof(scalerRecord, s2);
    prt->papFldDes[scalerRecordS3]->size = sizeof(prec->s3);
    prt->papFldDes[scalerRecordS3]->offset = (unsigned short)offsetof(scalerRecord, s3);
    prt->papFldDes[scalerRecordS4]->size = sizeof(prec->s4);
    prt->papFldDes[scalerRecordS4]->offset = (unsigned short)offsetof(scalerRecord, s4);
    prt->papFldDes[scalerRecordS5]->size = sizeof(prec->s5);
    prt->papFldDes[scalerRecordS5]->offset = (unsigned short)offsetof(scalerRecord, s5);
    prt->papFldDes[scalerRecordS6]->size = sizeof(prec->s6);
    prt->papFldDes[scalerRecordS6]->offset = (unsigned short)offsetof(scalerRecord, s6);
    prt->papFldDes[scalerRecordS7]->size = sizeof(prec->s7);
    prt->papFldDes[scalerRecordS7]->offset = (unsigned short)offsetof(scalerRecord, s7);
    prt->papFldDes[scalerRecordS8]->size = sizeof(prec->s8);
    prt->papFldDes[scalerRecordS8]->offset = (unsigned short)offsetof(scalerRecord, s8);
    prt->papFldDes[scalerRecordS9]->size = sizeof(prec->s9);
    prt->papFldDes[scalerRecordS9]->offset = (unsigned short)offsetof(scalerRecord, s9);
    prt->papFldDes[scalerRecordS10]->size = sizeof(prec->s10);
    prt->papFldDes[scalerRecordS10]->offset = (unsigned short)offsetof(scalerRecord, s10);
    prt->papFldDes[scalerRecordS11]->size = sizeof(prec->s11);
    prt->papFldDes[scalerRecordS11]->offset = (unsigned short)offsetof(scalerRecord, s11);
    prt->papFldDes[scalerRecordS12]->size = sizeof(prec->s12);
    prt->papFldDes[scalerRecordS12]->offset = (unsigned short)offsetof(scalerRecord, s12);
    prt->papFldDes[scalerRecordS13]->size = sizeof(prec->s13);
    prt->papFldDes[scalerRecordS13]->offset = (unsigned short)offsetof(scalerRecord, s13);
    prt->papFldDes[scalerRecordS14]->size = sizeof(prec->s14);
    prt->papFldDes[scalerRecordS14]->offset = (unsigned short)offsetof(scalerRecord, s14);
    prt->papFldDes[scalerRecordS15]->size = sizeof(prec->s15);
    prt->papFldDes[scalerRecordS15]->offset = (unsigned short)offsetof(scalerRecord, s15);
    prt->papFldDes[scalerRecordS16]->size = sizeof(prec->s16);
    prt->papFldDes[scalerRecordS16]->offset = (unsigned short)offsetof(scalerRecord, s16);
    prt->papFldDes[scalerRecordS17]->size = sizeof(prec->s17);
    prt->papFldDes[scalerRecordS17]->offset = (unsigned short)offsetof(scalerRecord, s17);
    prt->papFldDes[scalerRecordS18]->size = sizeof(prec->s18);
    prt->papFldDes[scalerRecordS18]->offset = (unsigned short)offsetof(scalerRecord, s18);
    prt->papFldDes[scalerRecordS19]->size = sizeof(prec->s19);
    prt->papFldDes[scalerRecordS19]->offset = (unsigned short)offsetof(scalerRecord, s19);
    prt->papFldDes[scalerRecordS20]->size = sizeof(prec->s20);
    prt->papFldDes[scalerRecordS20]->offset = (unsigned short)offsetof(scalerRecord, s20);
    prt->papFldDes[scalerRecordS21]->size = sizeof(prec->s21);
    prt->papFldDes[scalerRecordS21]->offset = (unsigned short)offsetof(scalerRecord, s21);
    prt->papFldDes[scalerRecordS22]->size = sizeof(prec->s22);
    prt->papFldDes[scalerRecordS22]->offset = (unsigned short)offsetof(scalerRecord, s22);
    prt->papFldDes[scalerRecordS23]->size = sizeof(prec->s23);
    prt->papFldDes[scalerRecordS23]->offset = (unsigned short)offsetof(scalerRecord, s23);
    prt->papFldDes[scalerRecordS24]->size = sizeof(prec->s24);
    prt->papFldDes[scalerRecordS24]->offset = (unsigned short)offsetof(scalerRecord, s24);
    prt->papFldDes[scalerRecordS25]->size = sizeof(prec->s25);
    prt->papFldDes[scalerRecordS25]->offset = (unsigned short)offsetof(scalerRecord, s25);
    prt->papFldDes[scalerRecordS26]->size = sizeof(prec->s26);
    prt->papFldDes[scalerRecordS26]->offset = (unsigned short)offsetof(scalerRecord, s26);
    prt->papFldDes[scalerRecordS27]->size = sizeof(prec->s27);
    prt->papFldDes[scalerRecordS27]->offset = (unsigned short)offsetof(scalerRecord, s27);
    prt->papFldDes[scalerRecordS28]->size = sizeof(prec->s28);
    prt->papFldDes[scalerRecordS28]->offset = (unsigned short)offsetof(scalerRecord, s28);
    prt->papFldDes[scalerRecordS29]->size = sizeof(prec->s29);
    prt->papFldDes[scalerRecordS29]->offset = (unsigned short)offsetof(scalerRecord, s29);
    prt->papFldDes[scalerRecordS30]->size = sizeof(prec->s30);
    prt->papFldDes[scalerRecordS30]->offset = (unsigned short)offsetof(scalerRecord, s30);
    prt->papFldDes[scalerRecordS31]->size = sizeof(prec->s31);
    prt->papFldDes[scalerRecordS31]->offset = (unsigned short)offsetof(scalerRecord, s31);
    prt->papFldDes[scalerRecordS32]->size = sizeof(prec->s32);
    prt->papFldDes[scalerRecordS32]->offset = (unsigned short)offsetof(scalerRecord, s32);
    prt->papFldDes[scalerRecordS33]->size = sizeof(prec->s33);
    prt->papFldDes[scalerRecordS33]->offset = (unsigned short)offsetof(scalerRecord, s33);
    prt->papFldDes[scalerRecordS34]->size = sizeof(prec->s34);
    prt->papFldDes[scalerRecordS34]->offset = (unsigned short)offsetof(scalerRecord, s34);
    prt->papFldDes[scalerRecordS35]->size = sizeof(prec->s35);
    prt->papFldDes[scalerRecordS35]->offset = (unsigned short)offsetof(scalerRecord, s35);
    prt->papFldDes[scalerRecordS36]->size = sizeof(prec->s36);
    prt->papFldDes[scalerRecordS36]->offset = (unsigned short)offsetof(scalerRecord, s36);
    prt->papFldDes[scalerRecordS37]->size = sizeof(prec->s37);
    prt->papFldDes[scalerRecordS37]->offset = (unsigned short)offsetof(scalerRecord, s37);
    prt->papFldDes[scalerRecordS38]->size = sizeof(prec->s38);
    prt->papFldDes[scalerRecordS38]->offset = (unsigned short)offsetof(scalerRecord, s38);
    prt->papFldDes[scalerRecordS39]->size = sizeof(prec->s39);
    prt->papFldDes[scalerRecordS39]->offset = (unsigned short)offsetof(scalerRecord, s39);
    prt->papFldDes[scalerRecordS40]->size = sizeof(prec->s40);
    prt->papFldDes[scalerRecordS40]->offset = (unsigned short)offsetof(scalerRecord, s40);
    prt->papFldDes[scalerRecordS41]->size = sizeof(prec->s41);
    prt->papFldDes[scalerRecordS41]->offset = (unsigned short)offsetof(scalerRecord, s41);
    prt->papFldDes[scalerRecordS42]->size = sizeof(prec->s42);
    prt->papFldDes[scalerRecordS42]->offset = (unsigned short)offsetof(scalerRecord, s42);
    prt->papFldDes[scalerRecordS43]->size = sizeof(prec->s43);
    prt->papFldDes[scalerRecordS43]->offset = (unsigned short)offsetof(scalerRecord, s43);
    prt->papFldDes[scalerRecordS44]->size = sizeof(prec->s44);
    prt->papFldDes[scalerRecordS44]->offset = (unsigned short)offsetof(scalerRecord, s44);
    prt->papFldDes[scalerRecordS45]->size = sizeof(prec->s45);
    prt->papFldDes[scalerRecordS45]->offset = (unsigned short)offsetof(scalerRecord, s45);
    prt->papFldDes[scalerRecordS46]->size = sizeof(prec->s46);
    prt->papFldDes[scalerRecordS46]->offset = (unsigned short)offsetof(scalerRecord, s46);
    prt->papFldDes[scalerRecordS47]->size = sizeof(prec->s47);
    prt->papFldDes[scalerRecordS47]->offset = (unsigned short)offsetof(scalerRecord, s47);
    prt->papFldDes[scalerRecordS48]->size = sizeof(prec->s48);
    prt->papFldDes[scalerRecordS48]->offset = (unsigned short)offsetof(scalerRecord, s48);
    prt->papFldDes[scalerRecordS49]->size = sizeof(prec->s49);
    prt->papFldDes[scalerRecordS49]->offset = (unsigned short)offsetof(scalerRecord, s49);
    prt->papFldDes[scalerRecordS50]->size = sizeof(prec->s50);
    prt->papFldDes[scalerRecordS50]->offset = (unsigned short)offsetof(scalerRecord, s50);
    prt->papFldDes[scalerRecordS51]->size = sizeof(prec->s51);
    prt->papFldDes[scalerRecordS51]->offset = (unsigned short)offsetof(scalerRecord, s51);
    prt->papFldDes[scalerRecordS52]->size = sizeof(prec->s52);
    prt->papFldDes[scalerRecordS52]->offset = (unsigned short)offsetof(scalerRecord, s52);
    prt->papFldDes[scalerRecordS53]->size = sizeof(prec->s53);
    prt->papFldDes[scalerRecordS53]->offset = (unsigned short)offsetof(scalerRecord, s53);
    prt->papFldDes[scalerRecordS54]->size = sizeof(prec->s54);
    prt->papFldDes[scalerRecordS54]->offset = (unsigned short)offsetof(scalerRecord, s54);
    prt->papFldDes[scalerRecordS55]->size = sizeof(prec->s55);
    prt->papFldDes[scalerRecordS55]->offset = (unsigned short)offsetof(scalerRecord, s55);
    prt->papFldDes[scalerRecordS56]->size = sizeof(prec->s56);
    prt->papFldDes[scalerRecordS56]->offset = (unsigned short)offsetof(scalerRecord, s56);
    prt->papFldDes[scalerRecordS57]->size = sizeof(prec->s57);
    prt->papFldDes[scalerRecordS57]->offset = (unsigned short)offsetof(scalerRecord, s57);
    prt->papFldDes[scalerRecordS58]->size = sizeof(prec->s58);
    prt->papFldDes[scalerRecordS58]->offset = (unsigned short)offsetof(scalerRecord, s58);
    prt->papFldDes[scalerRecordS59]->size = sizeof(prec->s59);
    prt->papFldDes[scalerRecordS59]->offset = (unsigned short)offsetof(scalerRecord, s59);
    prt->papFldDes[scalerRecordS60]->size = sizeof(prec->s60);
    prt->papFldDes[scalerRecordS60]->offset = (unsigned short)offsetof(scalerRecord, s60);
    prt->papFldDes[scalerRecordS61]->size = sizeof(prec->s61);
    prt->papFldDes[scalerRecordS61]->offset = (unsigned short)offsetof(scalerRecord, s61);
    prt->papFldDes[scalerRecordS62]->size = sizeof(prec->s62);
    prt->papFldDes[scalerRecordS62]->offset = (unsigned short)offsetof(scalerRecord, s62);
    prt->papFldDes[scalerRecordS63]->size = sizeof(prec->s63);
    prt->papFldDes[scalerRecordS63]->offset = (unsigned short)offsetof(scalerRecord, s63);
    prt->papFldDes[scalerRecordS64]->size = sizeof(prec->s64);
    prt->papFldDes[scalerRecordS64]->offset = (unsigned short)offsetof(scalerRecord, s64);
    prt->papFldDes[scalerRecordNM1]->size = sizeof(prec->nm1);
    prt->papFldDes[scalerRecordNM1]->offset = (unsigned short)offsetof(scalerRecord, nm1);
    prt->papFldDes[scalerRecordNM2]->size = sizeof(prec->nm2);
    prt->papFldDes[scalerRecordNM2]->offset = (unsigned short)offsetof(scalerRecord, nm2);
    prt->papFldDes[scalerRecordNM3]->size = sizeof(prec->nm3);
    prt->papFldDes[scalerRecordNM3]->offset = (unsigned short)offsetof(scalerRecord, nm3);
    prt->papFldDes[scalerRecordNM4]->size = sizeof(prec->nm4);
    prt->papFldDes[scalerRecordNM4]->offset = (unsigned short)offsetof(scalerRecord, nm4);
    prt->papFldDes[scalerRecordNM5]->size = sizeof(prec->nm5);
    prt->papFldDes[scalerRecordNM5]->offset = (unsigned short)offsetof(scalerRecord, nm5);
    prt->papFldDes[scalerRecordNM6]->size = sizeof(prec->nm6);
    prt->papFldDes[scalerRecordNM6]->offset = (unsigned short)offsetof(scalerRecord, nm6);
    prt->papFldDes[scalerRecordNM7]->size = sizeof(prec->nm7);
    prt->papFldDes[scalerRecordNM7]->offset = (unsigned short)offsetof(scalerRecord, nm7);
    prt->papFldDes[scalerRecordNM8]->size = sizeof(prec->nm8);
    prt->papFldDes[scalerRecordNM8]->offset = (unsigned short)offsetof(scalerRecord, nm8);
    prt->papFldDes[scalerRecordNM9]->size = sizeof(prec->nm9);
    prt->papFldDes[scalerRecordNM9]->offset = (unsigned short)offsetof(scalerRecord, nm9);
    prt->papFldDes[scalerRecordNM10]->size = sizeof(prec->nm10);
    prt->papFldDes[scalerRecordNM10]->offset = (unsigned short)offsetof(scalerRecord, nm10);
    prt->papFldDes[scalerRecordNM11]->size = sizeof(prec->nm11);
    prt->papFldDes[scalerRecordNM11]->offset = (unsigned short)offsetof(scalerRecord, nm11);
    prt->papFldDes[scalerRecordNM12]->size = sizeof(prec->nm12);
    prt->papFldDes[scalerRecordNM12]->offset = (unsigned short)offsetof(scalerRecord, nm12);
    prt->papFldDes[scalerRecordNM13]->size = sizeof(prec->nm13);
    prt->papFldDes[scalerRecordNM13]->offset = (unsigned short)offsetof(scalerRecord, nm13);
    prt->papFldDes[scalerRecordNM14]->size = sizeof(prec->nm14);
    prt->papFldDes[scalerRecordNM14]->offset = (unsigned short)offsetof(scalerRecord, nm14);
    prt->papFldDes[scalerRecordNM15]->size = sizeof(prec->nm15);
    prt->papFldDes[scalerRecordNM15]->offset = (unsigned short)offsetof(scalerRecord, nm15);
    prt->papFldDes[scalerRecordNM16]->size = sizeof(prec->nm16);
    prt->papFldDes[scalerRecordNM16]->offset = (unsigned short)offsetof(scalerRecord, nm16);
    prt->papFldDes[scalerRecordNM17]->size = sizeof(prec->nm17);
    prt->papFldDes[scalerRecordNM17]->offset = (unsigned short)offsetof(scalerRecord, nm17);
    prt->papFldDes[scalerRecordNM18]->size = sizeof(prec->nm18);
    prt->papFldDes[scalerRecordNM18]->offset = (unsigned short)offsetof(scalerRecord, nm18);
    prt->papFldDes[scalerRecordNM19]->size = sizeof(prec->nm19);
    prt->papFldDes[scalerRecordNM19]->offset = (unsigned short)offsetof(scalerRecord, nm19);
    prt->papFldDes[scalerRecordNM20]->size = sizeof(prec->nm20);
    prt->papFldDes[scalerRecordNM20]->offset = (unsigned short)offsetof(scalerRecord, nm20);
    prt->papFldDes[scalerRecordNM21]->size = sizeof(prec->nm21);
    prt->papFldDes[scalerRecordNM21]->offset = (unsigned short)offsetof(scalerRecord, nm21);
    prt->papFldDes[scalerRecordNM22]->size = sizeof(prec->nm22);
    prt->papFldDes[scalerRecordNM22]->offset = (unsigned short)offsetof(scalerRecord, nm22);
    prt->papFldDes[scalerRecordNM23]->size = sizeof(prec->nm23);
    prt->papFldDes[scalerRecordNM23]->offset = (unsigned short)offsetof(scalerRecord, nm23);
    prt->papFldDes[scalerRecordNM24]->size = sizeof(prec->nm24);
    prt->papFldDes[scalerRecordNM24]->offset = (unsigned short)offsetof(scalerRecord, nm24);
    prt->papFldDes[scalerRecordNM25]->size = sizeof(prec->nm25);
    prt->papFldDes[scalerRecordNM25]->offset = (unsigned short)offsetof(scalerRecord, nm25);
    prt->papFldDes[scalerRecordNM26]->size = sizeof(prec->nm26);
    prt->papFldDes[scalerRecordNM26]->offset = (unsigned short)offsetof(scalerRecord, nm26);
    prt->papFldDes[scalerRecordNM27]->size = sizeof(prec->nm27);
    prt->papFldDes[scalerRecordNM27]->offset = (unsigned short)offsetof(scalerRecord, nm27);
    prt->papFldDes[scalerRecordNM28]->size = sizeof(prec->nm28);
    prt->papFldDes[scalerRecordNM28]->offset = (unsigned short)offsetof(scalerRecord, nm28);
    prt->papFldDes[scalerRecordNM29]->size = sizeof(prec->nm29);
    prt->papFldDes[scalerRecordNM29]->offset = (unsigned short)offsetof(scalerRecord, nm29);
    prt->papFldDes[scalerRecordNM30]->size = sizeof(prec->nm30);
    prt->papFldDes[scalerRecordNM30]->offset = (unsigned short)offsetof(scalerRecord, nm30);
    prt->papFldDes[scalerRecordNM31]->size = sizeof(prec->nm31);
    prt->papFldDes[scalerRecordNM31]->offset = (unsigned short)offsetof(scalerRecord, nm31);
    prt->papFldDes[scalerRecordNM32]->size = sizeof(prec->nm32);
    prt->papFldDes[scalerRecordNM32]->offset = (unsigned short)offsetof(scalerRecord, nm32);
    prt->papFldDes[scalerRecordNM33]->size = sizeof(prec->nm33);
    prt->papFldDes[scalerRecordNM33]->offset = (unsigned short)offsetof(scalerRecord, nm33);
    prt->papFldDes[scalerRecordNM34]->size = sizeof(prec->nm34);
    prt->papFldDes[scalerRecordNM34]->offset = (unsigned short)offsetof(scalerRecord, nm34);
    prt->papFldDes[scalerRecordNM35]->size = sizeof(prec->nm35);
    prt->papFldDes[scalerRecordNM35]->offset = (unsigned short)offsetof(scalerRecord, nm35);
    prt->papFldDes[scalerRecordNM36]->size = sizeof(prec->nm36);
    prt->papFldDes[scalerRecordNM36]->offset = (unsigned short)offsetof(scalerRecord, nm36);
    prt->papFldDes[scalerRecordNM37]->size = sizeof(prec->nm37);
    prt->papFldDes[scalerRecordNM37]->offset = (unsigned short)offsetof(scalerRecord, nm37);
    prt->papFldDes[scalerRecordNM38]->size = sizeof(prec->nm38);
    prt->papFldDes[scalerRecordNM38]->offset = (unsigned short)offsetof(scalerRecord, nm38);
    prt->papFldDes[scalerRecordNM39]->size = sizeof(prec->nm39);
    prt->papFldDes[scalerRecordNM39]->offset = (unsigned short)offsetof(scalerRecord, nm39);
    prt->papFldDes[scalerRecordNM40]->size = sizeof(prec->nm40);
    prt->papFldDes[scalerRecordNM40]->offset = (unsigned short)offsetof(scalerRecord, nm40);
    prt->papFldDes[scalerRecordNM41]->size = sizeof(prec->nm41);
    prt->papFldDes[scalerRecordNM41]->offset = (unsigned short)offsetof(scalerRecord, nm41);
    prt->papFldDes[scalerRecordNM42]->size = sizeof(prec->nm42);
    prt->papFldDes[scalerRecordNM42]->offset = (unsigned short)offsetof(scalerRecord, nm42);
    prt->papFldDes[scalerRecordNM43]->size = sizeof(prec->nm43);
    prt->papFldDes[scalerRecordNM43]->offset = (unsigned short)offsetof(scalerRecord, nm43);
    prt->papFldDes[scalerRecordNM44]->size = sizeof(prec->nm44);
    prt->papFldDes[scalerRecordNM44]->offset = (unsigned short)offsetof(scalerRecord, nm44);
    prt->papFldDes[scalerRecordNM45]->size = sizeof(prec->nm45);
    prt->papFldDes[scalerRecordNM45]->offset = (unsigned short)offsetof(scalerRecord, nm45);
    prt->papFldDes[scalerRecordNM46]->size = sizeof(prec->nm46);
    prt->papFldDes[scalerRecordNM46]->offset = (unsigned short)offsetof(scalerRecord, nm46);
    prt->papFldDes[scalerRecordNM47]->size = sizeof(prec->nm47);
    prt->papFldDes[scalerRecordNM47]->offset = (unsigned short)offsetof(scalerRecord, nm47);
    prt->papFldDes[scalerRecordNM48]->size = sizeof(prec->nm48);
    prt->papFldDes[scalerRecordNM48]->offset = (unsigned short)offsetof(scalerRecord, nm48);
    prt->papFldDes[scalerRecordNM49]->size = sizeof(prec->nm49);
    prt->papFldDes[scalerRecordNM49]->offset = (unsigned short)offsetof(scalerRecord, nm49);
    prt->papFldDes[scalerRecordNM50]->size = sizeof(prec->nm50);
    prt->papFldDes[scalerRecordNM50]->offset = (unsigned short)offsetof(scalerRecord, nm50);
    prt->papFldDes[scalerRecordNM51]->size = sizeof(prec->nm51);
    prt->papFldDes[scalerRecordNM51]->offset = (unsigned short)offsetof(scalerRecord, nm51);
    prt->papFldDes[scalerRecordNM52]->size = sizeof(prec->nm52);
    prt->papFldDes[scalerRecordNM52]->offset = (unsigned short)offsetof(scalerRecord, nm52);
    prt->papFldDes[scalerRecordNM53]->size = sizeof(prec->nm53);
    prt->papFldDes[scalerRecordNM53]->offset = (unsigned short)offsetof(scalerRecord, nm53);
    prt->papFldDes[scalerRecordNM54]->size = sizeof(prec->nm54);
    prt->papFldDes[scalerRecordNM54]->offset = (unsigned short)offsetof(scalerRecord, nm54);
    prt->papFldDes[scalerRecordNM55]->size = sizeof(prec->nm55);
    prt->papFldDes[scalerRecordNM55]->offset = (unsigned short)offsetof(scalerRecord, nm55);
    prt->papFldDes[scalerRecordNM56]->size = sizeof(prec->nm56);
    prt->papFldDes[scalerRecordNM56]->offset = (unsigned short)offsetof(scalerRecord, nm56);
    prt->papFldDes[scalerRecordNM57]->size = sizeof(prec->nm57);
    prt->papFldDes[scalerRecordNM57]->offset = (unsigned short)offsetof(scalerRecord, nm57);
    prt->papFldDes[scalerRecordNM58]->size = sizeof(prec->nm58);
    prt->papFldDes[scalerRecordNM58]->offset = (unsigned short)offsetof(scalerRecord, nm58);
    prt->papFldDes[scalerRecordNM59]->size = sizeof(prec->nm59);
    prt->papFldDes[scalerRecordNM59]->offset = (unsigned short)offsetof(scalerRecord, nm59);
    prt->papFldDes[scalerRecordNM60]->size = sizeof(prec->nm60);
    prt->papFldDes[scalerRecordNM60]->offset = (unsigned short)offsetof(scalerRecord, nm60);
    prt->papFldDes[scalerRecordNM61]->size = sizeof(prec->nm61);
    prt->papFldDes[scalerRecordNM61]->offset = (unsigned short)offsetof(scalerRecord, nm61);
    prt->papFldDes[scalerRecordNM62]->size = sizeof(prec->nm62);
    prt->papFldDes[scalerRecordNM62]->offset = (unsigned short)offsetof(scalerRecord, nm62);
    prt->papFldDes[scalerRecordNM63]->size = sizeof(prec->nm63);
    prt->papFldDes[scalerRecordNM63]->offset = (unsigned short)offsetof(scalerRecord, nm63);
    prt->papFldDes[scalerRecordNM64]->size = sizeof(prec->nm64);
    prt->papFldDes[scalerRecordNM64]->offset = (unsigned short)offsetof(scalerRecord, nm64);
    prt->papFldDes[scalerRecordEGU]->size = sizeof(prec->egu);
    prt->papFldDes[scalerRecordEGU]->offset = (unsigned short)offsetof(scalerRecord, egu);
    prt->papFldDes[scalerRecordPREC]->size = sizeof(prec->prec);
    prt->papFldDes[scalerRecordPREC]->offset = (unsigned short)offsetof(scalerRecord, prec);
    prt->papFldDes[scalerRecordCOUT]->size = sizeof(prec->cout);
    prt->papFldDes[scalerRecordCOUT]->offset = (unsigned short)offsetof(scalerRecord, cout);
    prt->papFldDes[scalerRecordCOUTP]->size = sizeof(prec->coutp);
    prt->papFldDes[scalerRecordCOUTP]->offset = (unsigned short)offsetof(scalerRecord, coutp);
