...
static int motorRecordSizeOffset(dbRecordType *prt)
{
    ...
    prt->papFldDes[motorRecordAMSG]->offset = (unsigned short)((char *)&prec->amsg - (char *)prec);
    ...
    prt->papFldDes[motorRecordNAMSG]->offset = (unsigned short)((char *)&prec->namsg - (char *)prec);
    ...
    prt->papFldDes[motorRecordUTAG]->offset = (unsigned short)((char *)&prec->utag - (char *)prec);
    ...
    prt->papFldDes[motorRecordACCS]->offset = (unsigned short)((char *)&prec->accs - (char *)prec);
    prt->papFldDes[motorRecordACCU]->size = sizeof(prec->accu);
    prt->papFldDes[motorRecordACCU]->offset = (unsigned short)((char *)&prec->accu - (char *)prec);
    ...
    prt->papFldDes[motorRecordRHLM]->offset = (unsigned short)((char *)&prec->rhlm - (char *)prec);
    prt->papFldDes[motorRecordRLLM]->size = sizeof(prec->rllm);
    prt->papFldDes[motorRecordRLLM]->offset = (unsigned short)((char *)&prec->rllm - (char *)prec);
    ...
    prt->papFldDes[motorRecordRSTM]->offset = (unsigned short)((char *)&prec->rstm - (char *)prec);
