...
static int statusRecordSizeOffset(dbRecordType *prt)
{
    ...
    prt->papFldDes[statusRecordNAME]->offset = (unsigned short)offsetof(statusRecord, name);
    prt->papFldDes[statusRecordDESC]->size = sizeof(prec->desc);
    prt->papFldDes[statusRecordDESC]->offset = (unsigned short)offsetof(statusRecord, desc);
    prt->papFldDes[statusRecordASG]->size = sizeof(prec->asg);
    prt->papFldDes[statusRecordASG]->offset = (unsigned short)offsetof(statusRecord, asg);
    prt->papFldDes[statusRecordSCAN]->size = sizeof(prec->scan);
    prt->papFldDes[statusRecordSCAN]->offset = (unsigned short)offsetof(statusRecord, scan);
    prt->papFldDes[statusRecordPINI]->size = sizeof(prec->pini);
    prt->papFldDes[statusRecordPINI]->offset = (unsigned short)offsetof(statusRecord, pini);
    prt->papFldDes[statusRecordPHAS]->size = sizeof(prec->phas);
    prt->papFldDes[statusRecordPHAS]->offset = (unsigned short)offsetof(statusRecord, phas);
    prt->papFldDes[statusRecordEVNT]->size = sizeof(prec->evnt);
    prt->papFldDes[statusRecordEVNT]->offset = (unsigned short)offsetof(statusRecord, evnt);
    prt->papFldDes[statusRecordTSE]->size = sizeof(prec->tse);
    prt->papFldDes[statusRecordTSE]->offset = (unsigned short)offsetof(statusRecord, tse);
    prt->papFldDes[statusRecordTSEL]->size = sizeof(prec->tsel);
    prt->papFldDes[statusRecordTSEL]->offset = (unsigned short)offsetof(statusRecord, tsel);
    prt->papFldDes[statusRecordDTYP]->size = sizeof(prec->dtyp);
    prt->papFldDes[statusRecordDTYP]->offset = (unsigned short)offsetof(statusRecord, dtyp);
    prt->papFldDes[statusRecordDISV]->size = sizeof(prec->disv);
    prt->papFldDes[statusRecordDISV]->offset = (unsigned short)offsetof(statusRecord, disv);
    prt->papFldDes[statusRecordDISA]->size = sizeof(prec->disa);
    prt->papFldDes[statusRecordDISA]->offset = (unsigned short)offsetof(statusRecord, disa);
    prt->papFldDes[statusRecordSDIS]->size = sizeof(prec->sdis);
    prt->papFldDes[statusRecordSDIS]->offset = (unsigned short)offsetof(statusRecord, sdis);
    prt->papFldDes[statusRecordMLOK]->size = sizeof(prec->mlok);
    prt->papFldDes[statusRecordMLOK]->offset = (unsigned short)offsetof(statusRecord, mlok);
    prt->papFldDes[statusRecordMLIS]->size = sizeof(prec->mlis);
    prt->papFldDes[statusRecordMLIS]->offset = (unsigned short)offsetof(statusRecord, mlis);
    prt->papFldDes[statusRecordBKLNK]->size = sizeof(prec->bklnk);
    prt->papFldDes[statusRecordBKLNK]->offset = (unsigned short)offsetof(statusRecord, bklnk);
    prt->papFldDes[statusRecordDISP]->size = sizeof(prec->disp);
    prt->papFldDes[statusRecordDISP]->offset = (unsigned short)offsetof(statusRecord, disp);
    prt->papFldDes[statusRecordPROC]->size = sizeof(prec->proc);
    prt->papFldDes[statusRecordPROC]->offset = (unsigned short)offsetof(statusRecord, proc);
    prt->papFldDes[statusRecordSTAT]->size = sizeof(prec->stat);
    prt->papFldDes[statusRecordSTAT]->offset = (unsigned short)offsetof(statusRecord, stat);
    prt->papFldDes[statusRecordSEVR]->size = sizeof(prec->sevr);
    prt->papFldDes[statusRecordSEVR]->offset = (unsigned short)offsetof(statusRecord, sevr);
    prt->papFldDes[statusRecordAMSG]->size = sizeof(prec->amsg);
    prt->papFldDes[statusRecordAMSG]->offset = (unsigned short)offsetof(statusRecord, amsg);
    prt->papFldDes[statusRecordNSTA]->size = sizeof(prec->nsta);
    prt->papFldDes[statusRecordNSTA]->offset = (unsigned short)offsetof(statusRecord, nsta);
    prt->papFldDes[statusRecordNSEV]->size = sizeof(prec->nsev);
    prt->papFldDes[statusRecordNSEV]->offset = (unsigned short)offsetof(statusRecord, nsev);
    prt->papFldDes[statusRecordNAMSG]->size = sizeof(prec->namsg);
    prt->papFldDes[statusRecordNAMSG]->offset = (unsigned short)offsetof(statusRecord, namsg);
    prt->papFldDes[statusRecordACKS]->size = sizeof(prec->acks);
    prt->papFldDes[statusRecordACKS]->offset = (unsigned short)offsetof(statusRecord, acks);
    prt->papFldDes[statusRecordACKT]->size = sizeof(prec->ackt);
    prt->papFldDes[statusRecordACKT]->offset = (unsigned short)offsetof(statusRecord, ackt);
    prt->papFldDes[statusRecordDISS]->size = sizeof(prec->diss);
    prt->papFldDes[statusRecordDISS]->offset = (unsigned short)offsetof(statusRecord, diss);
    prt->papFldDes[statusRecordLCNT]->size = sizeof(prec->lcnt);
    prt->papFldDes[statusRecordLCNT]->offset = (unsigned short)offsetof(statusRecord, lcnt);
    prt->papFldDes[statusRecordPACT]->size = sizeof(prec->pact);
    prt->papFldDes[statusRecordPACT]->offset = (unsigned short)offsetof(statusRecord, pact);
    prt->papFldDes[statusRecordPUTF]->size = sizeof(prec->putf);
    prt->papFldDes[statusRecordPUTF]->offset = (unsigned short)offsetof(statusRecord, putf);
    prt->papFldDes[statusRecordRPRO]->size = sizeof(prec->rpro);
    prt->papFldDes[statusRecordRPRO]->offset = (unsigned short)offsetof(statusRecord, rpro);
    prt->papFldDes[statusRecordASP]->size = sizeof(prec->asp);
    prt->papFldDes[statusRecordASP]->offset = (unsigned short)offsetof(statusRecord, asp);
    prt->papFldDes[statusRecordPPN]->size = sizeof(prec->ppn);
    prt->papFldDes[statusRecordPPN]->offset = (unsigned short)offsetof(statusRecord, ppn);
    prt->papFldDes[statusRecordPPNR]->size = sizeof(prec->ppnr);
    prt->papFldDes[statusRecordPPNR]->offset = (unsigned short)offsetof(statusRecord, ppnr);
    prt->papFldDes[statusRecordSPVT]->size = sizeof(prec->spvt);
    prt->papFldDes[statusRecordSPVT]->offset = (unsigned short)offsetof(statusRecord, spvt);
    prt->papFldDes[statusRecordRSET]->size = sizeof(prec->rset);
    prt->papFldDes[statusRecordRSET]->offset = (unsigned short)offsetof(statusRecord, rset);
    prt->papFldDes[statusRecordDSET]->size = sizeof(prec->dset);
    prt->papFldDes[statusRecordDSET]->offset = (unsigned short)offsetof(statusRecord, dset);
    prt->papFldDes[statusRecordDPVT]->size = sizeof(prec->dpvt);
    prt->papFldDes[statusRecordDPVT]->offset = (unsigned short)offsetof(statusRecord, dpvt);
    prt->papFldDes[statusRecordRDES]->size = sizeof(prec->rdes);
    prt->papFldDes[statusRecordRDES]->offset = (unsigned short)offsetof(statusRecord, rdes);
    prt->papFldDes[statusRecordLSET]->size = sizeof(prec->lset);
    prt->papFldDes[statusRecordLSET]->offset = (unsigned short)offsetof(statusRecord, lset);
    prt->papFldDes[statusRecordPRIO]->size = sizeof(prec->prio);
    prt->papFldDes[statusRecordPRIO]->offset = (unsigned short)offsetof(statusRecord, prio);
    prt->papFldDes[statusRecordTPRO]->size = sizeof(prec->tpro);
    prt->papFldDes[statusRecordTPRO]->offset = (unsigned short)offsetof(statusRecord, tpro);
    prt->papFldDes[statusRecordBKPT]->size = sizeof(prec->bkpt);
    prt->papFldDes[statusRecordBKPT]->offset = (unsigned short)offsetof(statusRecord, bkpt);
    prt->papFldDes[statusRecordUDF]->size = sizeof(prec->udf);
    prt->papFldDes[statusRecordUDF]->offset = (unsigned short)offsetof(statusRecord, udf);
    prt->papFldDes[statusRecordUDFS]->size = sizeof(prec->udfs);
    prt->papFldDes[statusRecordUDFS]->offset = (unsigned short)offsetof(statusRecord, udfs);
    prt->papFldDes[statusRecordTIME]->size = sizeof(prec->time);
    prt->papFldDes[statusRecordTIME]->offset = (unsigned short)offsetof(statusRecord, time);
    prt->papFldDes[statusRecordUTAG]->size = sizeof(prec->utag);
    prt->papFldDes[statusRecordUTAG]->offset = (unsigned short)offsetof(statusRecord, utag);
    prt->papFldDes[statusRecordFLNK]->size = sizeof(prec->flnk);
    prt->papFldDes[statusRecordFLNK]->offset = (unsigned short)offsetof(statusRecord, flnk);
    prt->papFldDes[statusRecordVERS]->size = sizeof(prec->vers);
    prt->papFldDes[statusRecordVERS]->offset = (unsigned short)offsetof(statusRecord, vers);
    prt->papFldDes[statusRecordVAL]->size = sizeof(prec->val);
    prt->papFldDes[statusRecordVAL]->offset = (unsigned short)offsetof(statusRecord, val);
    prt->papFldDes[statusRecordINP]->size = sizeof(prec->inp);
    prt->papFldDes[statusRecordINP]->offset = (unsigned short)offsetof(statusRecord, inp);
    prt->papFldDes[statusRecordEGU]->size = sizeof(prec->egu);
    prt->papFldDes[statusRecordEGU]->offset = (unsigned short)offsetof(statusRecord, egu);
    prt->papFldDes[statusRecordHOPR]->size = sizeof(prec->hopr);
    prt->papFldDes[statusRecordHOPR]->offset = (unsigned short)offsetof(statusRecord, hopr);
    prt->papFldDes[statusRecordLOPR]->size = sizeof(prec->lopr);
    prt->papFldDes[statusRecordLOPR]->offset = (unsigned short)offsetof(statusRecord, lopr);
    prt->papFldDes[statusRecordLVAL]->size = sizeof(prec->lval);
    prt->papFldDes[statusRecordLVAL]->offset = (unsigned short)offsetof(statusRecord, lval);
    prt->papFldDes[statusRecordBI00]->size = sizeof(prec->bi00);
    prt->papFldDes[statusRecordBI00]->offset = (unsigned short)offsetof(statusRecord, bi00);
    prt->papFldDes[statusRecordBI01]->size = sizeof(prec->bi01);
    prt->papFldDes[statusRecordBI01]->offset = (unsigned short)offsetof(statusRecord, bi01);
    prt->papFldDes[statusRecordBI02]->size = sizeof(prec->bi02);
    prt->papFldDes[statusRecordBI02]->offset = (unsigned short)offsetof(statusRecord, bi02);
    prt->papFldDes[statusRecordBI03]->size = sizeof(prec->bi03);
    prt->papFldDes[statusRecordBI03]->offset = (unsigned short)offsetof(statusRecord, bi03);
    prt->papFldDes[statusRecordBI04]->size = sizeof(prec->bi04);
    prt->papFldDes[statusRecordBI04]->offset = (unsigned short)offsetof(statusRecord, bi04);
    prt->papFldDes[statusRecordBI05]->size = sizeof(prec->bi05);
    prt->papFldDes[statusRecordBI05]->offset = (unsigned short)offsetof(statusRecord, bi05);
    prt->papFldDes[statusRecordBI06]->size = sizeof(prec->bi06);
    prt->papFldDes[statusRecordBI06]->offset = (unsigned short)offsetof(statusRecord, bi06);
    prt->papFldDes[statusRecordBI07]->size = sizeof(prec->bi07);
    prt->papFldDes[statusRecordBI07]->offset = (unsigned short)offsetof(statusRecord, bi07);
    prt->papFldDes[statusRecordBI08]->size = sizeof(prec->bi08);
    prt->papFldDes[statusRecordBI08]->offset = (unsigned short)offsetof(statusRecord, bi08);
    prt->papFldDes[statusRecordBI09]->size = sizeof(prec->bi09);
    prt->papFldDes[statusRecordBI09]->offset = (unsigned short)offsetof(statusRecord, bi09);
    prt->papFldDes[statusRecordBI10]->size = sizeof(prec->bi10);
    prt->papFldDes[statusRecordBI10]->offset = (unsigned short)offsetof(statusRecord, bi10);
    prt->papFldDes[statusRecordBI11]->size = sizeof(prec->bi11);
    prt->papFldDes[statusRecordBI11]->offset = (unsigned short)offsetof(statusRecord, bi11);
    prt->papFldDes[statusRecordBI12]->size = sizeof(prec->bi12);
    prt->papFldDes[statusRecordBI12]->offset = (unsigned short)offsetof(statusRecord, bi12);
    prt->papFldDes[statusRecordBI13]->size = sizeof(prec->bi13);
    prt->papFldDes[statusRecordBI13]->offset = (unsigned short)offsetof(statusRecord, bi13);
    prt->papFldDes[statusRecordBI14]->size = sizeof(prec->bi14);
    prt->papFldDes[statusRecordBI14]->offset = (unsigned short)offsetof(statusRecord, bi14);
    prt->papFldDes[statusRecordBI15]->size = sizeof(prec->bi15);
    prt->papFldDes[statusRecordBI15]->offset = (unsigned short)offsetof(statusRecord, bi15);
    prt->papFldDes[statusRecordBI16]->size = sizeof(prec->bi16);
    prt->papFldDes[statusRecordBI16]->offset = (unsigned short)offsetof(statusRecord, bi16);
    prt->papFldDes[statusRecordBI17]->size = sizeof(prec->bi17);
    prt->papFldDes[statusRecordBI17]->offset = (unsigned short)offsetof(statusRecord, bi17);
    prt->papFldDes[statusRecordBI18]->size = sizeof(prec->bi18);
    prt->papFldDes[statusRecordBI18]->offset = (unsigned short)offsetof(statusRecord, bi18);
    prt->papFldDes[statusRecordBI19]->size = sizeof(prec->bi19);
    prt->papFldDes[statusRecordBI19]->offset = (unsigned short)offsetof(statusRecord, bi19);
    prt->papFldDes[statusRecordBI20]->size = sizeof(prec->bi20);
    prt->papFldDes[statusRecordBI20]->offset = (unsigned short)offsetof(statusRecord, bi20);
    prt->papFldDes[statusRecordBI21]->size = sizeof(prec->bi21);
    prt->papFldDes[statusRecordBI21]->offset = (unsigned short)offsetof(statusRecord, bi21);
    prt->papFldDes[statusRecordBI22]->size = sizeof(prec->bi22);
    prt->papFldDes[statusRecordBI22]->offset = (unsigned short)offsetof(statusRecord, bi22);
    prt->papFldDes[statusRecordBI23]->size = sizeof(prec->bi23);
    prt->papFldDes[statusRecordBI23]->offset = (unsigned short)offsetof(statusRecord, bi23);
    prt->papFldDes[statusRecordBI24]->size = sizeof(prec->bi24);
    prt->papFldDes[statusRecordBI24]->offset = (unsigned short)offsetof(statusRecord, bi24);
    prt->papFldDes[statusRecordBI25]->size = sizeof(prec->bi25);
    prt->papFldDes[statusRecordBI25]->offset = (unsigned short)offsetof(statusRecord, bi25);
    prt->papFldDes[statusRecordBI26]->size = sizeof(prec->bi26);
    prt->papFldDes[statusRecordBI26]->offset = (unsigned short)offsetof(statusRecord, bi26);
    prt->papFldDes[statusRecordBI27]->size = sizeof(prec->bi27);
    prt->papFldDes[statusRecordBI27]->offset = (unsigned short)offsetof(statusRecord, bi27);
    prt->papFldDes[statusRecordBI28]->size = sizeof(prec->bi28);
    prt->papFldDes[statusRecordBI28]->offset = (unsigned short)offsetof(statusRecord, bi28);
    prt->papFldDes[statusRecordBI29]->size = sizeof(prec->bi29);
    prt->papFldDes[statusRecordBI29]->offset = (unsigned short)offsetof(statusRecord, bi29);
    prt->papFldDes[statusRecordBI30]->size = sizeof(prec->bi30);
    prt->papFldDes[statusRecordBI30]->offset = (unsigned short)offsetof(statusRecord, bi30);
    prt->papFldDes[statusRecordBI31]->size = sizeof(prec->bi31);
    prt->papFldDes[statusRecordBI31]->offset = (unsigned short)offsetof(statusRecord, bi31);
    prt->papFldDes[statusRecordLK00]->size = sizeof(prec->lk00);
    prt->papFldDes[statusRecordLK00]->offset = (unsigned short)offsetof(statusRecord, lk00);
    prt->papFldDes[statusRecordLK01]->size = sizeof(prec->lk01);
    prt->papFldDes[statusRecordLK01]->offset = (unsigned short)offsetof(statusRecord, lk01);
    prt->papFldDes[statusRecordLK02]->size = sizeof(prec->lk02);
    prt->papFldDes[statusRecordLK02]->offset = (unsigned short)offsetof(statusRecord, lk02);
    prt->papFldDes[statusRecordLK03]->size = sizeof(prec->lk03);
    prt->papFldDes[statusRecordLK03]->offset = (unsigned short)offsetof(statusRecord, lk03);
    prt->papFldDes[statusRecordLK04]->size = sizeof(prec->lk04);
    prt->papFldDes[statusRecordLK04]->offset = (unsigned short)offsetof(statusRecord, lk04);
    prt->papFldDes[statusRecordLK05]->size = sizeof(prec->lk05);
    prt->papFldDes[statusRecordLK05]->offset = (unsigned short)offsetof(statusRecord, lk05);
    prt->papFldDes[statusRecordLK06]->size = sizeof(prec->lk06);
    prt->papFldDes[statusRecordLK06]->offset = (unsigned short)offsetof(statusRecord, lk06);
    prt->papFldDes[statusRecordLK07]->size = sizeof(prec->lk07);
    prt->papFldDes[statusRecordLK07]->offset = (unsigned short)offsetof(statusRecord, lk07);
    prt->papFldDes[statusRecordLK08]->size = sizeof(prec->lk08);
    prt->papFldDes[statusRecordLK08]->offset = (unsigned short)offsetof(statusRecord, lk08);
    prt->papFldDes[statusRecordLK09]->size = sizeof(prec->lk09);
    prt->papFldDes[statusRecordLK09]->offset = (unsigned short)offsetof(statusRecord, lk09);
    prt->papFldDes[statusRecordLK10]->size = sizeof(prec->lk10);
    prt->papFldDes[statusRecordLK10]->offset = (unsigned short)offsetof(statusRecord, lk10);
    prt->papFldDes[statusRecordLK11]->size = sizeof(prec->lk11);
    prt->papFldDes[statusRecordLK11]->offset = (unsigned short)offsetof(statusRecord, lk11);
    prt->papFldDes[statusRecordLK12]->size = sizeof(prec->lk12);
    prt->papFldDes[statusRecordLK12]->offset = (unsigned short)offsetof(statusRecord, lk12);
    prt->papFldDes[statusRecordLK13]->size = sizeof(prec->lk13);
    prt->papFldDes[statusRecordLK13]->offset = (unsigned short)offsetof(statusRecord, lk13);
    prt->papFldDes[statusRecordLK14]->size = sizeof(prec->lk14);
    prt->papFldDes[statusRecordLK14]->offset = (unsigned short)offsetof(statusRecord, lk14);
    prt->papFldDes[statusRecordLK15]->size = sizeof(prec->lk15);
    prt->papFldDes[statusRecordLK15]->offset = (unsigned short)offsetof(statusRecord, lk15);
    prt->papFldDes[statusRecordLK16]->size = sizeof(prec->lk16);
    prt->papFldDes[statusRecordLK16]->offset = (unsigned short)offsetof(statusRecord, lk16);
    prt->papFldDes[statusRecordLK17]->size = sizeof(prec->lk17);
    prt->papFldDes[statusRecordLK17]->offset = (unsigned short)offsetof(statusRecord, lk17);
    prt->papFldDes[statusRecordLK18]->size = sizeof(prec->lk18);
    prt->papFldDes[statusRecordLK18]->offset = (unsigned short)offsetof(statusRecord, lk18);
    prt->papFldDes[statusRecordLK19]->size = sizeof(prec->lk19);
    prt->papFldDes[statusRecordLK19]->offset = (unsigned short)offsetof(statusRecord, lk19);
    prt->papFldDes[statusRecordLK20]->size = sizeof(prec->lk20);
    prt->papFldDes[statusRecordLK20]->offset = (unsigned short)offsetof(statusRecord, lk20);
    prt->papFldDes[statusRecordLK21]->size = sizeof(prec->lk21);
    prt->papFldDes[statusRecordLK21]->offset = (unsigned short)offsetof(statusRecord, lk21);
    prt->papFldDes[statusRecordLK22]->size = sizeof(prec->lk22);
    prt->papFldDes[statusRecordLK22]->offset = (unsigned short)offsetof(statusRecord, lk22);
    prt->papFldDes[statusRecordLK23]->size = sizeof(prec->lk23);
    prt->papFldDes[statusRecordLK23]->offset = (unsigned short)offsetof(statusRecord, lk23);
    prt->papFldDes[statusRecordLK24]->size = sizeof(prec->lk24);
    prt->papFldDes[statusRecordLK24]->offset = (unsigned short)offsetof(statusRecord, lk24);
    prt->papFldDes[statusRecordLK25]->size = sizeof(prec->lk25);
    prt->papFldDes[statusRecordLK25]->offset = (unsigned short)offsetof(statusRecord, lk25);
    prt->papFldDes[statusRecordLK26]->size = sizeof(prec->lk26);
    prt->papFldDes[statusRecordLK26]->offset = (unsigned short)offsetof(statusRecord, lk26);
    prt->papFldDes[statusRecordLK27]->size = sizeof(prec->lk27);
    prt->papFldDes[statusRecordLK27]->offset = (unsigned short)offsetof(statusRecord, lk27);
    prt->papFldDes[statusRecordLK28]->size = sizeof(prec->lk28);
    prt->papFldDes[statusRecordLK28]->offset = (unsigned short)offsetof(statusRecord, lk28);
    prt->papFldDes[statusRecordLK29]->size = sizeof(prec->lk29);
    prt->papFldDes[statusRecordLK29]->offset = (unsigned short)offsetof(statusRecord, lk29);
    prt->papFldDes[statusRecordLK30]->size = sizeof(prec->lk30);
    prt->papFldDes[statusRecordLK30]->offset = (unsigned short)offsetof(statusRecord, lk30);
    prt->papFldDes[statusRecordLK31]->size = sizeof(prec->lk31);
    prt->papFldDes[statusRecordLK31]->offset = (unsigned short)offsetof(statusRecord, lk31);
    prt->papFldDes[statusRecordHIHI]->size = sizeof(prec->hihi);
    prt->papFldDes[statusRecordHIHI]->offset = (unsigned short)offsetof(statusRecord, hihi);
    prt->papFldDes[statusRecordLOLO]->size = sizeof(prec->lolo);
    prt->papFldDes[statusRecordLOLO]->offset = (unsigned short)offsetof(statusRecord, lolo);
    prt->papFldDes[statusRecordHIGH]->size = sizeof(prec->high);
    prt->papFldDes[statusRecordHIGH]->offset = (unsigned short)offsetof(statusRecord, high);
    prt->papFldDes[statusRecordLOW]->size = sizeof(prec->low);
    prt->papFldDes[statusRecordLOW]->offset = (unsigned short)offsetof(statusRecord, low);
    prt->papFldDes[statusRecordHHSV]->size = sizeof(prec->hhsv);
    prt->papFldDes[statusRecordHHSV]->offset = (unsigned short)offsetof(statusRecord, hhsv);
    prt->papFldDes[statusRecordLLSV]->size = sizeof(prec->llsv);
    prt->papFldDes[statusRecordLLSV]->offset = (unsigned short)offsetof(statusRecord, llsv);
    prt->papFldDes[statusRecordHSV]->size = sizeof(prec->hsv);
    prt->papFldDes[statusRecordHSV]->offset = (unsigned short)offsetof(statusRecord, hsv);
    prt->papFldDes[statusRecordLSV]->size = sizeof(prec->lsv);
    prt->papFldDes[statusRecordLSV]->offset = (unsigned short)offsetof(statusRecord, lsv);
    prt->papFldDes[statusRecordHYST]->size = sizeof(prec->hyst);
    prt->papFldDes[statusRecordHYST]->offset = (unsigned short)offsetof(statusRecord, hyst);
    prt->papFldDes[statusRecordADEL]->size = sizeof(prec->adel);
    prt->papFldDes[statusRecordADEL]->offset = (unsigned short)offsetof(statusRecord, adel);
    prt->papFldDes[statusRecordMDEL]->size = sizeof(prec->mdel);
    prt->papFldDes[statusRecordMDEL]->offset = (unsigned short)offsetof(statusRecord, mdel);
    prt->papFldDes[statusRecordLALM]->size = sizeof(prec->lalm);
    prt->papFldDes[statusRecordLALM]->offset = (unsigned short)offsetof(statusRecord, lalm);
    prt->papFldDes[statusRecordALST]->size = sizeof(prec->alst);
    prt->papFldDes[statusRecordALST]->offset = (unsigned short)offsetof(statusRecord, alst);
    prt->papFldDes[statusRecordMLST]->size = sizeof(prec->mlst);
    prt->papFldDes[statusRecordMLST]->offset = (unsigned short)offsetof(statusRecord, mlst);
    prt->papFldDes[statusRecordSIOL]->size = sizeof(prec->siol);
    prt->papFldDes[statusRecordSIOL]->offset = (unsigned short)offsetof(statusRecord, siol);
    prt->papFldDes[statusRecordSVAL]->size = sizeof(prec->sval);
    prt->papFldDes[statusRecordSVAL]->offset = (unsigned short)offsetof(statusRecord, sval);
    prt->papFldDes[statusRecordSIML]->size = sizeof(prec->siml);
    prt->papFldDes[statusRecordSIML]->offset = (unsigned short)offsetof(statusRecord, siml);
    prt->papFldDes[statusRecordSIMM]->size = sizeof(prec->simm);
    prt->papFldDes[statusRecordSIMM]->offset = (unsigned short)offsetof(statusRecord, simm);
    prt->papFldDes[statusRecordSIMS]->size = sizeof(prec->sims);
    prt->papFldDes[statusRecordSIMS]->offset = (unsigned short)offsetof(statusRecord, sims);
