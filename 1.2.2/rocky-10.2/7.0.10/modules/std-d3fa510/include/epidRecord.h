...
static int epidRecordSizeOffset(dbRecordType *prt)
{
    ...
    prt->papFldDes[epidRecordNAME]->offset = (unsigned short)offsetof(epidRecord, name);
    prt->papFldDes[epidRecordDESC]->size = sizeof(prec->desc);
    prt->papFldDes[epidRecordDESC]->offset = (unsigned short)offsetof(epidRecord, desc);
    prt->papFldDes[epidRecordASG]->size = sizeof(prec->asg);
    prt->papFldDes[epidRecordASG]->offset = (unsigned short)offsetof(epidRecord, asg);
    prt->papFldDes[epidRecordSCAN]->size = sizeof(prec->scan);
    prt->papFldDes[epidRecordSCAN]->offset = (unsigned short)offsetof(epidRecord, scan);
    prt->papFldDes[epidRecordPINI]->size = sizeof(prec->pini);
    prt->papFldDes[epidRecordPINI]->offset = (unsigned short)offsetof(epidRecord, pini);
    prt->papFldDes[epidRecordPHAS]->size = sizeof(prec->phas);
    prt->papFldDes[epidRecordPHAS]->offset = (unsigned short)offsetof(epidRecord, phas);
    prt->papFldDes[epidRecordEVNT]->size = sizeof(prec->evnt);
    prt->papFldDes[epidRecordEVNT]->offset = (unsigned short)offsetof(epidRecord, evnt);
    prt->papFldDes[epidRecordTSE]->size = sizeof(prec->tse);
    prt->papFldDes[epidRecordTSE]->offset = (unsigned short)offsetof(epidRecord, tse);
    prt->papFldDes[epidRecordTSEL]->size = sizeof(prec->tsel);
    prt->papFldDes[epidRecordTSEL]->offset = (unsigned short)offsetof(epidRecord, tsel);
    prt->papFldDes[epidRecordDTYP]->size = sizeof(prec->dtyp);
    prt->papFldDes[epidRecordDTYP]->offset = (unsigned short)offsetof(epidRecord, dtyp);
    prt->papFldDes[epidRecordDISV]->size = sizeof(prec->disv);
    prt->papFldDes[epidRecordDISV]->offset = (unsigned short)offsetof(epidRecord, disv);
    prt->papFldDes[epidRecordDISA]->size = sizeof(prec->disa);
    prt->papFldDes[epidRecordDISA]->offset = (unsigned short)offsetof(epidRecord, disa);
    prt->papFldDes[epidRecordSDIS]->size = sizeof(prec->sdis);
    prt->papFldDes[epidRecordSDIS]->offset = (unsigned short)offsetof(epidRecord, sdis);
    prt->papFldDes[epidRecordMLOK]->size = sizeof(prec->mlok);
    prt->papFldDes[epidRecordMLOK]->offset = (unsigned short)offsetof(epidRecord, mlok);
    prt->papFldDes[epidRecordMLIS]->size = sizeof(prec->mlis);
    prt->papFldDes[epidRecordMLIS]->offset = (unsigned short)offsetof(epidRecord, mlis);
    prt->papFldDes[epidRecordBKLNK]->size = sizeof(prec->bklnk);
    prt->papFldDes[epidRecordBKLNK]->offset = (unsigned short)offsetof(epidRecord, bklnk);
    prt->papFldDes[epidRecordDISP]->size = sizeof(prec->disp);
    prt->papFldDes[epidRecordDISP]->offset = (unsigned short)offsetof(epidRecord, disp);
    prt->papFldDes[epidRecordPROC]->size = sizeof(prec->proc);
    prt->papFldDes[epidRecordPROC]->offset = (unsigned short)offsetof(epidRecord, proc);
    prt->papFldDes[epidRecordSTAT]->size = sizeof(prec->stat);
    prt->papFldDes[epidRecordSTAT]->offset = (unsigned short)offsetof(epidRecord, stat);
    prt->papFldDes[epidRecordSEVR]->size = sizeof(prec->sevr);
    prt->papFldDes[epidRecordSEVR]->offset = (unsigned short)offsetof(epidRecord, sevr);
    prt->papFldDes[epidRecordAMSG]->size = sizeof(prec->amsg);
    prt->papFldDes[epidRecordAMSG]->offset = (unsigned short)offsetof(epidRecord, amsg);
    prt->papFldDes[epidRecordNSTA]->size = sizeof(prec->nsta);
    prt->papFldDes[epidRecordNSTA]->offset = (unsigned short)offsetof(epidRecord, nsta);
    prt->papFldDes[epidRecordNSEV]->size = sizeof(prec->nsev);
    prt->papFldDes[epidRecordNSEV]->offset = (unsigned short)offsetof(epidRecord, nsev);
    prt->papFldDes[epidRecordNAMSG]->size = sizeof(prec->namsg);
    prt->papFldDes[epidRecordNAMSG]->offset = (unsigned short)offsetof(epidRecord, namsg);
    prt->papFldDes[epidRecordACKS]->size = sizeof(prec->acks);
    prt->papFldDes[epidRecordACKS]->offset = (unsigned short)offsetof(epidRecord, acks);
    prt->papFldDes[epidRecordACKT]->size = sizeof(prec->ackt);
    prt->papFldDes[epidRecordACKT]->offset = (unsigned short)offsetof(epidRecord, ackt);
    prt->papFldDes[epidRecordDISS]->size = sizeof(prec->diss);
    prt->papFldDes[epidRecordDISS]->offset = (unsigned short)offsetof(epidRecord, diss);
    prt->papFldDes[epidRecordLCNT]->size = sizeof(prec->lcnt);
    prt->papFldDes[epidRecordLCNT]->offset = (unsigned short)offsetof(epidRecord, lcnt);
    prt->papFldDes[epidRecordPACT]->size = sizeof(prec->pact);
    prt->papFldDes[epidRecordPACT]->offset = (unsigned short)offsetof(epidRecord, pact);
    prt->papFldDes[epidRecordPUTF]->size = sizeof(prec->putf);
    prt->papFldDes[epidRecordPUTF]->offset = (unsigned short)offsetof(epidRecord, putf);
    prt->papFldDes[epidRecordRPRO]->size = sizeof(prec->rpro);
    prt->papFldDes[epidRecordRPRO]->offset = (unsigned short)offsetof(epidRecord, rpro);
    prt->papFldDes[epidRecordASP]->size = sizeof(prec->asp);
    prt->papFldDes[epidRecordASP]->offset = (unsigned short)offsetof(epidRecord, asp);
    prt->papFldDes[epidRecordPPN]->size = sizeof(prec->ppn);
    prt->papFldDes[epidRecordPPN]->offset = (unsigned short)offsetof(epidRecord, ppn);
    prt->papFldDes[epidRecordPPNR]->size = sizeof(prec->ppnr);
    prt->papFldDes[epidRecordPPNR]->offset = (unsigned short)offsetof(epidRecord, ppnr);
    prt->papFldDes[epidRecordSPVT]->size = sizeof(prec->spvt);
    prt->papFldDes[epidRecordSPVT]->offset = (unsigned short)offsetof(epidRecord, spvt);
    prt->papFldDes[epidRecordRSET]->size = sizeof(prec->rset);
    prt->papFldDes[epidRecordRSET]->offset = (unsigned short)offsetof(epidRecord, rset);
    prt->papFldDes[epidRecordDSET]->size = sizeof(prec->dset);
    prt->papFldDes[epidRecordDSET]->offset = (unsigned short)offsetof(epidRecord, dset);
    prt->papFldDes[epidRecordDPVT]->size = sizeof(prec->dpvt);
    prt->papFldDes[epidRecordDPVT]->offset = (unsigned short)offsetof(epidRecord, dpvt);
    prt->papFldDes[epidRecordRDES]->size = sizeof(prec->rdes);
    prt->papFldDes[epidRecordRDES]->offset = (unsigned short)offsetof(epidRecord, rdes);
    prt->papFldDes[epidRecordLSET]->size = sizeof(prec->lset);
    prt->papFldDes[epidRecordLSET]->offset = (unsigned short)offsetof(epidRecord, lset);
    prt->papFldDes[epidRecordPRIO]->size = sizeof(prec->prio);
    prt->papFldDes[epidRecordPRIO]->offset = (unsigned short)offsetof(epidRecord, prio);
    prt->papFldDes[epidRecordTPRO]->size = sizeof(prec->tpro);
    prt->papFldDes[epidRecordTPRO]->offset = (unsigned short)offsetof(epidRecord, tpro);
    prt->papFldDes[epidRecordBKPT]->size = sizeof(prec->bkpt);
    prt->papFldDes[epidRecordBKPT]->offset = (unsigned short)offsetof(epidRecord, bkpt);
    prt->papFldDes[epidRecordUDF]->size = sizeof(prec->udf);
    prt->papFldDes[epidRecordUDF]->offset = (unsigned short)offsetof(epidRecord, udf);
    prt->papFldDes[epidRecordUDFS]->size = sizeof(prec->udfs);
    prt->papFldDes[epidRecordUDFS]->offset = (unsigned short)offsetof(epidRecord, udfs);
    prt->papFldDes[epidRecordTIME]->size = sizeof(prec->time);
    prt->papFldDes[epidRecordTIME]->offset = (unsigned short)offsetof(epidRecord, time);
    prt->papFldDes[epidRecordUTAG]->size = sizeof(prec->utag);
    prt->papFldDes[epidRecordUTAG]->offset = (unsigned short)offsetof(epidRecord, utag);
    prt->papFldDes[epidRecordFLNK]->size = sizeof(prec->flnk);
    prt->papFldDes[epidRecordFLNK]->offset = (unsigned short)offsetof(epidRecord, flnk);
    prt->papFldDes[epidRecordVAL]->size = sizeof(prec->val);
    prt->papFldDes[epidRecordVAL]->offset = (unsigned short)offsetof(epidRecord, val);
    prt->papFldDes[epidRecordSMSL]->size = sizeof(prec->smsl);
    prt->papFldDes[epidRecordSMSL]->offset = (unsigned short)offsetof(epidRecord, smsl);
    prt->papFldDes[epidRecordSTPL]->size = sizeof(prec->stpl);
    prt->papFldDes[epidRecordSTPL]->offset = (unsigned short)offsetof(epidRecord, stpl);
    prt->papFldDes[epidRecordINP]->size = sizeof(prec->inp);
    prt->papFldDes[epidRecordINP]->offset = (unsigned short)offsetof(epidRecord, inp);
    prt->papFldDes[epidRecordOUTL]->size = sizeof(prec->outl);
    prt->papFldDes[epidRecordOUTL]->offset = (unsigned short)offsetof(epidRecord, outl);
    prt->papFldDes[epidRecordTRIG]->size = sizeof(prec->trig);
    prt->papFldDes[epidRecordTRIG]->offset = (unsigned short)offsetof(epidRecord, trig);
    prt->papFldDes[epidRecordTVAL]->size = sizeof(prec->tval);
    prt->papFldDes[epidRecordTVAL]->offset = (unsigned short)offsetof(epidRecord, tval);
    prt->papFldDes[epidRecordCVAL]->size = sizeof(prec->cval);
    prt->papFldDes[epidRecordCVAL]->offset = (unsigned short)offsetof(epidRecord, cval);
    prt->papFldDes[epidRecordCVLP]->size = sizeof(prec->cvlp);
    prt->papFldDes[epidRecordCVLP]->offset = (unsigned short)offsetof(epidRecord, cvlp);
    prt->papFldDes[epidRecordOVAL]->size = sizeof(prec->oval);
    prt->papFldDes[epidRecordOVAL]->offset = (unsigned short)offsetof(epidRecord, oval);
    prt->papFldDes[epidRecordOVLP]->size = sizeof(prec->ovlp);
    prt->papFldDes[epidRecordOVLP]->offset = (unsigned short)offsetof(epidRecord, ovlp);
    prt->papFldDes[epidRecordPREC]->size = sizeof(prec->prec);
    prt->papFldDes[epidRecordPREC]->offset = (unsigned short)offsetof(epidRecord, prec);
    prt->papFldDes[epidRecordMDT]->size = sizeof(prec->mdt);
    prt->papFldDes[epidRecordMDT]->offset = (unsigned short)offsetof(epidRecord, mdt);
    prt->papFldDes[epidRecordFMOD]->size = sizeof(prec->fmod);
    prt->papFldDes[epidRecordFMOD]->offset = (unsigned short)offsetof(epidRecord, fmod);
    prt->papFldDes[epidRecordFBON]->size = sizeof(prec->fbon);
    prt->papFldDes[epidRecordFBON]->offset = (unsigned short)offsetof(epidRecord, fbon);
    prt->papFldDes[epidRecordFBOP]->size = sizeof(prec->fbop);
    prt->papFldDes[epidRecordFBOP]->offset = (unsigned short)offsetof(epidRecord, fbop);
    prt->papFldDes[epidRecordKP]->size = sizeof(prec->kp);
    prt->papFldDes[epidRecordKP]->offset = (unsigned short)offsetof(epidRecord, kp);
    prt->papFldDes[epidRecordKI]->size = sizeof(prec->ki);
    prt->papFldDes[epidRecordKI]->offset = (unsigned short)offsetof(epidRecord, ki);
    prt->papFldDes[epidRecordKD]->size = sizeof(prec->kd);
    prt->papFldDes[epidRecordKD]->offset = (unsigned short)offsetof(epidRecord, kd);
    prt->papFldDes[epidRecordEGU]->size = sizeof(prec->egu);
    prt->papFldDes[epidRecordEGU]->offset = (unsigned short)offsetof(epidRecord, egu);
    prt->papFldDes[epidRecordHOPR]->size = sizeof(prec->hopr);
    prt->papFldDes[epidRecordHOPR]->offset = (unsigned short)offsetof(epidRecord, hopr);
    prt->papFldDes[epidRecordLOPR]->size = sizeof(prec->lopr);
    prt->papFldDes[epidRecordLOPR]->offset = (unsigned short)offsetof(epidRecord, lopr);
    prt->papFldDes[epidRecordDRVH]->size = sizeof(prec->drvh);
    prt->papFldDes[epidRecordDRVH]->offset = (unsigned short)offsetof(epidRecord, drvh);
    prt->papFldDes[epidRecordDRVL]->size = sizeof(prec->drvl);
    prt->papFldDes[epidRecordDRVL]->offset = (unsigned short)offsetof(epidRecord, drvl);
    prt->papFldDes[epidRecordHIHI]->size = sizeof(prec->hihi);
    prt->papFldDes[epidRecordHIHI]->offset = (unsigned short)offsetof(epidRecord, hihi);
    prt->papFldDes[epidRecordLOLO]->size = sizeof(prec->lolo);
    prt->papFldDes[epidRecordLOLO]->offset = (unsigned short)offsetof(epidRecord, lolo);
    prt->papFldDes[epidRecordHIGH]->size = sizeof(prec->high);
    prt->papFldDes[epidRecordHIGH]->offset = (unsigned short)offsetof(epidRecord, high);
    prt->papFldDes[epidRecordLOW]->size = sizeof(prec->low);
    prt->papFldDes[epidRecordLOW]->offset = (unsigned short)offsetof(epidRecord, low);
    prt->papFldDes[epidRecordHHSV]->size = sizeof(prec->hhsv);
    prt->papFldDes[epidRecordHHSV]->offset = (unsigned short)offsetof(epidRecord, hhsv);
    prt->papFldDes[epidRecordLLSV]->size = sizeof(prec->llsv);
    prt->papFldDes[epidRecordLLSV]->offset = (unsigned short)offsetof(epidRecord, llsv);
    prt->papFldDes[epidRecordHSV]->size = sizeof(prec->hsv);
    prt->papFldDes[epidRecordHSV]->offset = (unsigned short)offsetof(epidRecord, hsv);
    prt->papFldDes[epidRecordLSV]->size = sizeof(prec->lsv);
    prt->papFldDes[epidRecordLSV]->offset = (unsigned short)offsetof(epidRecord, lsv);
    prt->papFldDes[epidRecordHYST]->size = sizeof(prec->hyst);
    prt->papFldDes[epidRecordHYST]->offset = (unsigned short)offsetof(epidRecord, hyst);
    prt->papFldDes[epidRecordADEL]->size = sizeof(prec->adel);
    prt->papFldDes[epidRecordADEL]->offset = (unsigned short)offsetof(epidRecord, adel);
    prt->papFldDes[epidRecordMDEL]->size = sizeof(prec->mdel);
    prt->papFldDes[epidRecordMDEL]->offset = (unsigned short)offsetof(epidRecord, mdel);
    prt->papFldDes[epidRecordODEL]->size = sizeof(prec->odel);
    prt->papFldDes[epidRecordODEL]->offset = (unsigned short)offsetof(epidRecord, odel);
    prt->papFldDes[epidRecordP]->size = sizeof(prec->p);
    prt->papFldDes[epidRecordP]->offset = (unsigned short)offsetof(epidRecord, p);
    prt->papFldDes[epidRecordPP]->size = sizeof(prec->pp);
    prt->papFldDes[epidRecordPP]->offset = (unsigned short)offsetof(epidRecord, pp);
    prt->papFldDes[epidRecordI]->size = sizeof(prec->i);
    prt->papFldDes[epidRecordI]->offset = (unsigned short)offsetof(epidRecord, i);
    prt->papFldDes[epidRecordIP]->size = sizeof(prec->ip);
    prt->papFldDes[epidRecordIP]->offset = (unsigned short)offsetof(epidRecord, ip);
    prt->papFldDes[epidRecordD]->size = sizeof(prec->d);
    prt->papFldDes[epidRecordD]->offset = (unsigned short)offsetof(epidRecord, d);
    prt->papFldDes[epidRecordDP]->size = sizeof(prec->dp);
    prt->papFldDes[epidRecordDP]->offset = (unsigned short)offsetof(epidRecord, dp);
    prt->papFldDes[epidRecordCT]->size = sizeof(prec->ct);
    prt->papFldDes[epidRecordCT]->offset = (unsigned short)offsetof(epidRecord, ct);
    prt->papFldDes[epidRecordCTP]->size = sizeof(prec->ctp);
    prt->papFldDes[epidRecordCTP]->offset = (unsigned short)offsetof(epidRecord, ctp);
    prt->papFldDes[epidRecordDT]->size = sizeof(prec->dt);
    prt->papFldDes[epidRecordDT]->offset = (unsigned short)offsetof(epidRecord, dt);
    prt->papFldDes[epidRecordDTP]->size = sizeof(prec->dtp);
    prt->papFldDes[epidRecordDTP]->offset = (unsigned short)offsetof(epidRecord, dtp);
    prt->papFldDes[epidRecordERR]->size = sizeof(prec->err);
    prt->papFldDes[epidRecordERR]->offset = (unsigned short)offsetof(epidRecord, err);
    prt->papFldDes[epidRecordERRP]->size = sizeof(prec->errp);
    prt->papFldDes[epidRecordERRP]->offset = (unsigned short)offsetof(epidRecord, errp);
    prt->papFldDes[epidRecordLALM]->size = sizeof(prec->lalm);
    prt->papFldDes[epidRecordLALM]->offset = (unsigned short)offsetof(epidRecord, lalm);
    prt->papFldDes[epidRecordALST]->size = sizeof(prec->alst);
    prt->papFldDes[epidRecordALST]->offset = (unsigned short)offsetof(epidRecord, alst);
    prt->papFldDes[epidRecordMLST]->size = sizeof(prec->mlst);
    prt->papFldDes[epidRecordMLST]->offset = (unsigned short)offsetof(epidRecord, mlst);
