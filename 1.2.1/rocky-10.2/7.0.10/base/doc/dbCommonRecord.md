...
See also [Fields Common to Input Record Types](dbCommonInput.md) and
[Fields Common to Output Record Types](dbCommonOutput.md).
...
The **PINI** field specifies record processing at initialization. It can have the
