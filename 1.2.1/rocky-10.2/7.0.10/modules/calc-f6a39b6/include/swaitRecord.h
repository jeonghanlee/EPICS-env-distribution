...
static int swaitRecordSizeOffset(dbRecordType *prt)
{
    ...
    prt->papFldDes[swaitRecordNAME]->offset = (unsigned short)offsetof(swaitRecord, name);
    prt->papFldDes[swaitRecordDESC]->size = sizeof(prec->desc);
    prt->papFldDes[swaitRecordDESC]->offset = (unsigned short)offsetof(swaitRecord, desc);
    prt->papFldDes[swaitRecordASG]->size = sizeof(prec->asg);
    prt->papFldDes[swaitRecordASG]->offset = (unsigned short)offsetof(swaitRecord, asg);
    prt->papFldDes[swaitRecordSCAN]->size = sizeof(prec->scan);
    prt->papFldDes[swaitRecordSCAN]->offset = (unsigned short)offsetof(swaitRecord, scan);
    prt->papFldDes[swaitRecordPINI]->size = sizeof(prec->pini);
    prt->papFldDes[swaitRecordPINI]->offset = (unsigned short)offsetof(swaitRecord, pini);
    prt->papFldDes[swaitRecordPHAS]->size = sizeof(prec->phas);
    prt->papFldDes[swaitRecordPHAS]->offset = (unsigned short)offsetof(swaitRecord, phas);
    prt->papFldDes[swaitRecordEVNT]->size = sizeof(prec->evnt);
    prt->papFldDes[swaitRecordEVNT]->offset = (unsigned short)offsetof(swaitRecord, evnt);
    prt->papFldDes[swaitRecordTSE]->size = sizeof(prec->tse);
    prt->papFldDes[swaitRecordTSE]->offset = (unsigned short)offsetof(swaitRecord, tse);
    prt->papFldDes[swaitRecordTSEL]->size = sizeof(prec->tsel);
    prt->papFldDes[swaitRecordTSEL]->offset = (unsigned short)offsetof(swaitRecord, tsel);
    prt->papFldDes[swaitRecordDTYP]->size = sizeof(prec->dtyp);
    prt->papFldDes[swaitRecordDTYP]->offset = (unsigned short)offsetof(swaitRecord, dtyp);
    prt->papFldDes[swaitRecordDISV]->size = sizeof(prec->disv);
    prt->papFldDes[swaitRecordDISV]->offset = (unsigned short)offsetof(swaitRecord, disv);
    prt->papFldDes[swaitRecordDISA]->size = sizeof(prec->disa);
    prt->papFldDes[swaitRecordDISA]->offset = (unsigned short)offsetof(swaitRecord, disa);
    prt->papFldDes[swaitRecordSDIS]->size = sizeof(prec->sdis);
    prt->papFldDes[swaitRecordSDIS]->offset = (unsigned short)offsetof(swaitRecord, sdis);
    prt->papFldDes[swaitRecordMLOK]->size = sizeof(prec->mlok);
    prt->papFldDes[swaitRecordMLOK]->offset = (unsigned short)offsetof(swaitRecord, mlok);
    prt->papFldDes[swaitRecordMLIS]->size = sizeof(prec->mlis);
    prt->papFldDes[swaitRecordMLIS]->offset = (unsigned short)offsetof(swaitRecord, mlis);
    prt->papFldDes[swaitRecordBKLNK]->size = sizeof(prec->bklnk);
    prt->papFldDes[swaitRecordBKLNK]->offset = (unsigned short)offsetof(swaitRecord, bklnk);
    prt->papFldDes[swaitRecordDISP]->size = sizeof(prec->disp);
    prt->papFldDes[swaitRecordDISP]->offset = (unsigned short)offsetof(swaitRecord, disp);
    prt->papFldDes[swaitRecordPROC]->size = sizeof(prec->proc);
    prt->papFldDes[swaitRecordPROC]->offset = (unsigned short)offsetof(swaitRecord, proc);
    prt->papFldDes[swaitRecordSTAT]->size = sizeof(prec->stat);
    prt->papFldDes[swaitRecordSTAT]->offset = (unsigned short)offsetof(swaitRecord, stat);
    prt->papFldDes[swaitRecordSEVR]->size = sizeof(prec->sevr);
    prt->papFldDes[swaitRecordSEVR]->offset = (unsigned short)offsetof(swaitRecord, sevr);
    prt->papFldDes[swaitRecordAMSG]->size = sizeof(prec->amsg);
    prt->papFldDes[swaitRecordAMSG]->offset = (unsigned short)offsetof(swaitRecord, amsg);
    prt->papFldDes[swaitRecordNSTA]->size = sizeof(prec->nsta);
    prt->papFldDes[swaitRecordNSTA]->offset = (unsigned short)offsetof(swaitRecord, nsta);
    prt->papFldDes[swaitRecordNSEV]->size = sizeof(prec->nsev);
    prt->papFldDes[swaitRecordNSEV]->offset = (unsigned short)offsetof(swaitRecord, nsev);
    prt->papFldDes[swaitRecordNAMSG]->size = sizeof(prec->namsg);
    prt->papFldDes[swaitRecordNAMSG]->offset = (unsigned short)offsetof(swaitRecord, namsg);
    prt->papFldDes[swaitRecordACKS]->size = sizeof(prec->acks);
    prt->papFldDes[swaitRecordACKS]->offset = (unsigned short)offsetof(swaitRecord, acks);
    prt->papFldDes[swaitRecordACKT]->size = sizeof(prec->ackt);
    prt->papFldDes[swaitRecordACKT]->offset = (unsigned short)offsetof(swaitRecord, ackt);
    prt->papFldDes[swaitRecordDISS]->size = sizeof(prec->diss);
    prt->papFldDes[swaitRecordDISS]->offset = (unsigned short)offsetof(swaitRecord, diss);
    prt->papFldDes[swaitRecordLCNT]->size = sizeof(prec->lcnt);
    prt->papFldDes[swaitRecordLCNT]->offset = (unsigned short)offsetof(swaitRecord, lcnt);
    prt->papFldDes[swaitRecordPACT]->size = sizeof(prec->pact);
    prt->papFldDes[swaitRecordPACT]->offset = (unsigned short)offsetof(swaitRecord, pact);
    prt->papFldDes[swaitRecordPUTF]->size = sizeof(prec->putf);
    prt->papFldDes[swaitRecordPUTF]->offset = (unsigned short)offsetof(swaitRecord, putf);
    prt->papFldDes[swaitRecordRPRO]->size = sizeof(prec->rpro);
    prt->papFldDes[swaitRecordRPRO]->offset = (unsigned short)offsetof(swaitRecord, rpro);
    prt->papFldDes[swaitRecordASP]->size = sizeof(prec->asp);
    prt->papFldDes[swaitRecordASP]->offset = (unsigned short)offsetof(swaitRecord, asp);
    prt->papFldDes[swaitRecordPPN]->size = sizeof(prec->ppn);
    prt->papFldDes[swaitRecordPPN]->offset = (unsigned short)offsetof(swaitRecord, ppn);
    prt->papFldDes[swaitRecordPPNR]->size = sizeof(prec->ppnr);
    prt->papFldDes[swaitRecordPPNR]->offset = (unsigned short)offsetof(swaitRecord, ppnr);
    prt->papFldDes[swaitRecordSPVT]->size = sizeof(prec->spvt);
    prt->papFldDes[swaitRecordSPVT]->offset = (unsigned short)offsetof(swaitRecord, spvt);
    prt->papFldDes[swaitRecordRSET]->size = sizeof(prec->rset);
    prt->papFldDes[swaitRecordRSET]->offset = (unsigned short)offsetof(swaitRecord, rset);
    prt->papFldDes[swaitRecordDSET]->size = sizeof(prec->dset);
    prt->papFldDes[swaitRecordDSET]->offset = (unsigned short)offsetof(swaitRecord, dset);
    prt->papFldDes[swaitRecordDPVT]->size = sizeof(prec->dpvt);
    prt->papFldDes[swaitRecordDPVT]->offset = (unsigned short)offsetof(swaitRecord, dpvt);
    prt->papFldDes[swaitRecordRDES]->size = sizeof(prec->rdes);
    prt->papFldDes[swaitRecordRDES]->offset = (unsigned short)offsetof(swaitRecord, rdes);
    prt->papFldDes[swaitRecordLSET]->size = sizeof(prec->lset);
    prt->papFldDes[swaitRecordLSET]->offset = (unsigned short)offsetof(swaitRecord, lset);
    prt->papFldDes[swaitRecordPRIO]->size = sizeof(prec->prio);
    prt->papFldDes[swaitRecordPRIO]->offset = (unsigned short)offsetof(swaitRecord, prio);
    prt->papFldDes[swaitRecordTPRO]->size = sizeof(prec->tpro);
    prt->papFldDes[swaitRecordTPRO]->offset = (unsigned short)offsetof(swaitRecord, tpro);
    prt->papFldDes[swaitRecordBKPT]->size = sizeof(prec->bkpt);
    prt->papFldDes[swaitRecordBKPT]->offset = (unsigned short)offsetof(swaitRecord, bkpt);
    prt->papFldDes[swaitRecordUDF]->size = sizeof(prec->udf);
    prt->papFldDes[swaitRecordUDF]->offset = (unsigned short)offsetof(swaitRecord, udf);
    prt->papFldDes[swaitRecordUDFS]->size = sizeof(prec->udfs);
    prt->papFldDes[swaitRecordUDFS]->offset = (unsigned short)offsetof(swaitRecord, udfs);
    prt->papFldDes[swaitRecordTIME]->size = sizeof(prec->time);
    prt->papFldDes[swaitRecordTIME]->offset = (unsigned short)offsetof(swaitRecord, time);
    prt->papFldDes[swaitRecordUTAG]->size = sizeof(prec->utag);
    prt->papFldDes[swaitRecordUTAG]->offset = (unsigned short)offsetof(swaitRecord, utag);
    prt->papFldDes[swaitRecordFLNK]->size = sizeof(prec->flnk);
    prt->papFldDes[swaitRecordFLNK]->offset = (unsigned short)offsetof(swaitRecord, flnk);
    prt->papFldDes[swaitRecordVERS]->size = sizeof(prec->vers);
    prt->papFldDes[swaitRecordVERS]->offset = (unsigned short)offsetof(swaitRecord, vers);
    prt->papFldDes[swaitRecordHOPR]->size = sizeof(prec->hopr);
    prt->papFldDes[swaitRecordHOPR]->offset = (unsigned short)offsetof(swaitRecord, hopr);
    prt->papFldDes[swaitRecordLOPR]->size = sizeof(prec->lopr);
    prt->papFldDes[swaitRecordLOPR]->offset = (unsigned short)offsetof(swaitRecord, lopr);
    prt->papFldDes[swaitRecordINIT]->size = sizeof(prec->init);
    prt->papFldDes[swaitRecordINIT]->offset = (unsigned short)offsetof(swaitRecord, init);
    prt->papFldDes[swaitRecordCBST]->size = sizeof(prec->cbst);
    prt->papFldDes[swaitRecordCBST]->offset = (unsigned short)offsetof(swaitRecord, cbst);
    prt->papFldDes[swaitRecordINAN]->size = sizeof(prec->inan);
    prt->papFldDes[swaitRecordINAN]->offset = (unsigned short)offsetof(swaitRecord, inan);
    prt->papFldDes[swaitRecordINBN]->size = sizeof(prec->inbn);
    prt->papFldDes[swaitRecordINBN]->offset = (unsigned short)offsetof(swaitRecord, inbn);
    prt->papFldDes[swaitRecordINCN]->size = sizeof(prec->incn);
    prt->papFldDes[swaitRecordINCN]->offset = (unsigned short)offsetof(swaitRecord, incn);
    prt->papFldDes[swaitRecordINDN]->size = sizeof(prec->indn);
    prt->papFldDes[swaitRecordINDN]->offset = (unsigned short)offsetof(swaitRecord, indn);
    prt->papFldDes[swaitRecordINEN]->size = sizeof(prec->inen);
    prt->papFldDes[swaitRecordINEN]->offset = (unsigned short)offsetof(swaitRecord, inen);
    prt->papFldDes[swaitRecordINFN]->size = sizeof(prec->infn);
    prt->papFldDes[swaitRecordINFN]->offset = (unsigned short)offsetof(swaitRecord, infn);
    prt->papFldDes[swaitRecordINGN]->size = sizeof(prec->ingn);
    prt->papFldDes[swaitRecordINGN]->offset = (unsigned short)offsetof(swaitRecord, ingn);
    prt->papFldDes[swaitRecordINHN]->size = sizeof(prec->inhn);
    prt->papFldDes[swaitRecordINHN]->offset = (unsigned short)offsetof(swaitRecord, inhn);
    prt->papFldDes[swaitRecordININ]->size = sizeof(prec->inin);
    prt->papFldDes[swaitRecordININ]->offset = (unsigned short)offsetof(swaitRecord, inin);
    prt->papFldDes[swaitRecordINJN]->size = sizeof(prec->injn);
    prt->papFldDes[swaitRecordINJN]->offset = (unsigned short)offsetof(swaitRecord, injn);
    prt->papFldDes[swaitRecordINKN]->size = sizeof(prec->inkn);
    prt->papFldDes[swaitRecordINKN]->offset = (unsigned short)offsetof(swaitRecord, inkn);
    prt->papFldDes[swaitRecordINLN]->size = sizeof(prec->inln);
    prt->papFldDes[swaitRecordINLN]->offset = (unsigned short)offsetof(swaitRecord, inln);
    prt->papFldDes[swaitRecordDOLN]->size = sizeof(prec->doln);
    prt->papFldDes[swaitRecordDOLN]->offset = (unsigned short)offsetof(swaitRecord, doln);
    prt->papFldDes[swaitRecordOUTN]->size = sizeof(prec->outn);
    prt->papFldDes[swaitRecordOUTN]->offset = (unsigned short)offsetof(swaitRecord, outn);
    prt->papFldDes[swaitRecordINAV]->size = sizeof(prec->inav);
    prt->papFldDes[swaitRecordINAV]->offset = (unsigned short)offsetof(swaitRecord, inav);
    prt->papFldDes[swaitRecordINBV]->size = sizeof(prec->inbv);
    prt->papFldDes[swaitRecordINBV]->offset = (unsigned short)offsetof(swaitRecord, inbv);
    prt->papFldDes[swaitRecordINCV]->size = sizeof(prec->incv);
    prt->papFldDes[swaitRecordINCV]->offset = (unsigned short)offsetof(swaitRecord, incv);
    prt->papFldDes[swaitRecordINDV]->size = sizeof(prec->indv);
    prt->papFldDes[swaitRecordINDV]->offset = (unsigned short)offsetof(swaitRecord, indv);
    prt->papFldDes[swaitRecordINEV]->size = sizeof(prec->inev);
    prt->papFldDes[swaitRecordINEV]->offset = (unsigned short)offsetof(swaitRecord, inev);
    prt->papFldDes[swaitRecordINFV]->size = sizeof(prec->infv);
    prt->papFldDes[swaitRecordINFV]->offset = (unsigned short)offsetof(swaitRecord, infv);
    prt->papFldDes[swaitRecordINGV]->size = sizeof(prec->ingv);
    prt->papFldDes[swaitRecordINGV]->offset = (unsigned short)offsetof(swaitRecord, ingv);
    prt->papFldDes[swaitRecordINHV]->size = sizeof(prec->inhv);
    prt->papFldDes[swaitRecordINHV]->offset = (unsigned short)offsetof(swaitRecord, inhv);
    prt->papFldDes[swaitRecordINIV]->size = sizeof(prec->iniv);
    prt->papFldDes[swaitRecordINIV]->offset = (unsigned short)offsetof(swaitRecord, iniv);
    prt->papFldDes[swaitRecordINJV]->size = sizeof(prec->injv);
    prt->papFldDes[swaitRecordINJV]->offset = (unsigned short)offsetof(swaitRecord, injv);
    prt->papFldDes[swaitRecordINKV]->size = sizeof(prec->inkv);
    prt->papFldDes[swaitRecordINKV]->offset = (unsigned short)offsetof(swaitRecord, inkv);
    prt->papFldDes[swaitRecordINLV]->size = sizeof(prec->inlv);
    prt->papFldDes[swaitRecordINLV]->offset = (unsigned short)offsetof(swaitRecord, inlv);
    prt->papFldDes[swaitRecordDOLV]->size = sizeof(prec->dolv);
    prt->papFldDes[swaitRecordDOLV]->offset = (unsigned short)offsetof(swaitRecord, dolv);
    prt->papFldDes[swaitRecordOUTV]->size = sizeof(prec->outv);
    prt->papFldDes[swaitRecordOUTV]->offset = (unsigned short)offsetof(swaitRecord, outv);
    prt->papFldDes[swaitRecordA]->size = sizeof(prec->a);
    prt->papFldDes[swaitRecordA]->offset = (unsigned short)offsetof(swaitRecord, a);
    prt->papFldDes[swaitRecordB]->size = sizeof(prec->b);
    prt->papFldDes[swaitRecordB]->offset = (unsigned short)offsetof(swaitRecord, b);
    prt->papFldDes[swaitRecordC]->size = sizeof(prec->c);
    prt->papFldDes[swaitRecordC]->offset = (unsigned short)offsetof(swaitRecord, c);
    prt->papFldDes[swaitRecordD]->size = sizeof(prec->d);
    prt->papFldDes[swaitRecordD]->offset = (unsigned short)offsetof(swaitRecord, d);
    prt->papFldDes[swaitRecordE]->size = sizeof(prec->e);
    prt->papFldDes[swaitRecordE]->offset = (unsigned short)offsetof(swaitRecord, e);
    prt->papFldDes[swaitRecordF]->size = sizeof(prec->f);
    prt->papFldDes[swaitRecordF]->offset = (unsigned short)offsetof(swaitRecord, f);
    prt->papFldDes[swaitRecordG]->size = sizeof(prec->g);
    prt->papFldDes[swaitRecordG]->offset = (unsigned short)offsetof(swaitRecord, g);
    prt->papFldDes[swaitRecordH]->size = sizeof(prec->h);
    prt->papFldDes[swaitRecordH]->offset = (unsigned short)offsetof(swaitRecord, h);
    prt->papFldDes[swaitRecordI]->size = sizeof(prec->i);
    prt->papFldDes[swaitRecordI]->offset = (unsigned short)offsetof(swaitRecord, i);
    prt->papFldDes[swaitRecordJ]->size = sizeof(prec->j);
    prt->papFldDes[swaitRecordJ]->offset = (unsigned short)offsetof(swaitRecord, j);
    prt->papFldDes[swaitRecordK]->size = sizeof(prec->k);
    prt->papFldDes[swaitRecordK]->offset = (unsigned short)offsetof(swaitRecord, k);
    prt->papFldDes[swaitRecordL]->size = sizeof(prec->l);
    prt->papFldDes[swaitRecordL]->offset = (unsigned short)offsetof(swaitRecord, l);
    prt->papFldDes[swaitRecordLA]->size = sizeof(prec->la);
    prt->papFldDes[swaitRecordLA]->offset = (unsigned short)offsetof(swaitRecord, la);
    prt->papFldDes[swaitRecordLB]->size = sizeof(prec->lb);
    prt->papFldDes[swaitRecordLB]->offset = (unsigned short)offsetof(swaitRecord, lb);
    prt->papFldDes[swaitRecordLC]->size = sizeof(prec->lc);
    prt->papFldDes[swaitRecordLC]->offset = (unsigned short)offsetof(swaitRecord, lc);
    prt->papFldDes[swaitRecordLD]->size = sizeof(prec->ld);
    prt->papFldDes[swaitRecordLD]->offset = (unsigned short)offsetof(swaitRecord, ld);
    prt->papFldDes[swaitRecordLE]->size = sizeof(prec->le);
    prt->papFldDes[swaitRecordLE]->offset = (unsigned short)offsetof(swaitRecord, le);
    prt->papFldDes[swaitRecordLF]->size = sizeof(prec->lf);
    prt->papFldDes[swaitRecordLF]->offset = (unsigned short)offsetof(swaitRecord, lf);
    prt->papFldDes[swaitRecordLG]->size = sizeof(prec->lg);
    prt->papFldDes[swaitRecordLG]->offset = (unsigned short)offsetof(swaitRecord, lg);
    prt->papFldDes[swaitRecordLH]->size = sizeof(prec->lh);
    prt->papFldDes[swaitRecordLH]->offset = (unsigned short)offsetof(swaitRecord, lh);
    prt->papFldDes[swaitRecordLI]->size = sizeof(prec->li);
    prt->papFldDes[swaitRecordLI]->offset = (unsigned short)offsetof(swaitRecord, li);
    prt->papFldDes[swaitRecordLJ]->size = sizeof(prec->lj);
    prt->papFldDes[swaitRecordLJ]->offset = (unsigned short)offsetof(swaitRecord, lj);
    prt->papFldDes[swaitRecordLK]->size = sizeof(prec->lk);
    prt->papFldDes[swaitRecordLK]->offset = (unsigned short)offsetof(swaitRecord, lk);
    prt->papFldDes[swaitRecordLL]->size = sizeof(prec->ll);
    prt->papFldDes[swaitRecordLL]->offset = (unsigned short)offsetof(swaitRecord, ll);
    prt->papFldDes[swaitRecordINAP]->size = sizeof(prec->inap);
    prt->papFldDes[swaitRecordINAP]->offset = (unsigned short)offsetof(swaitRecord, inap);
    prt->papFldDes[swaitRecordINBP]->size = sizeof(prec->inbp);
    prt->papFldDes[swaitRecordINBP]->offset = (unsigned short)offsetof(swaitRecord, inbp);
    prt->papFldDes[swaitRecordINCP]->size = sizeof(prec->incp);
    prt->papFldDes[swaitRecordINCP]->offset = (unsigned short)offsetof(swaitRecord, incp);
    prt->papFldDes[swaitRecordINDP]->size = sizeof(prec->indp);
    prt->papFldDes[swaitRecordINDP]->offset = (unsigned short)offsetof(swaitRecord, indp);
    prt->papFldDes[swaitRecordINEP]->size = sizeof(prec->inep);
    prt->papFldDes[swaitRecordINEP]->offset = (unsigned short)offsetof(swaitRecord, inep);
    prt->papFldDes[swaitRecordINFP]->size = sizeof(prec->infp);
    prt->papFldDes[swaitRecordINFP]->offset = (unsigned short)offsetof(swaitRecord, infp);
    prt->papFldDes[swaitRecordINGP]->size = sizeof(prec->ingp);
    prt->papFldDes[swaitRecordINGP]->offset = (unsigned short)offsetof(swaitRecord, ingp);
    prt->papFldDes[swaitRecordINHP]->size = sizeof(prec->inhp);
    prt->papFldDes[swaitRecordINHP]->offset = (unsigned short)offsetof(swaitRecord, inhp);
    prt->papFldDes[swaitRecordINIP]->size = sizeof(prec->inip);
    prt->papFldDes[swaitRecordINIP]->offset = (unsigned short)offsetof(swaitRecord, inip);
    prt->papFldDes[swaitRecordINJP]->size = sizeof(prec->injp);
    prt->papFldDes[swaitRecordINJP]->offset = (unsigned short)offsetof(swaitRecord, injp);
    prt->papFldDes[swaitRecordINKP]->size = sizeof(prec->inkp);
    prt->papFldDes[swaitRecordINKP]->offset = (unsigned short)offsetof(swaitRecord, inkp);
    prt->papFldDes[swaitRecordINLP]->size = sizeof(prec->inlp);
    prt->papFldDes[swaitRecordINLP]->offset = (unsigned short)offsetof(swaitRecord, inlp);
    prt->papFldDes[swaitRecordCALC]->size = sizeof(prec->calc);
    prt->papFldDes[swaitRecordCALC]->offset = (unsigned short)offsetof(swaitRecord, calc);
    prt->papFldDes[swaitRecordRPCL]->size = sizeof(prec->rpcl);
    prt->papFldDes[swaitRecordRPCL]->offset = (unsigned short)offsetof(swaitRecord, rpcl);
    prt->papFldDes[swaitRecordCLCV]->size = sizeof(prec->clcv);
    prt->papFldDes[swaitRecordCLCV]->offset = (unsigned short)offsetof(swaitRecord, clcv);
    prt->papFldDes[swaitRecordVAL]->size = sizeof(prec->val);
    prt->papFldDes[swaitRecordVAL]->offset = (unsigned short)offsetof(swaitRecord, val);
    prt->papFldDes[swaitRecordOVAL]->size = sizeof(prec->oval);
    prt->papFldDes[swaitRecordOVAL]->offset = (unsigned short)offsetof(swaitRecord, oval);
    prt->papFldDes[swaitRecordPREC]->size = sizeof(prec->prec);
    prt->papFldDes[swaitRecordPREC]->offset = (unsigned short)offsetof(swaitRecord, prec);
    prt->papFldDes[swaitRecordOOPT]->size = sizeof(prec->oopt);
    prt->papFldDes[swaitRecordOOPT]->offset = (unsigned short)offsetof(swaitRecord, oopt);
    prt->papFldDes[swaitRecordODLY]->size = sizeof(prec->odly);
    prt->papFldDes[swaitRecordODLY]->offset = (unsigned short)offsetof(swaitRecord, odly);
    prt->papFldDes[swaitRecordDOPT]->size = sizeof(prec->dopt);
    prt->papFldDes[swaitRecordDOPT]->offset = (unsigned short)offsetof(swaitRecord, dopt);
    prt->papFldDes[swaitRecordDOLD]->size = sizeof(prec->dold);
    prt->papFldDes[swaitRecordDOLD]->offset = (unsigned short)offsetof(swaitRecord, dold);
    prt->papFldDes[swaitRecordOEVT]->size = sizeof(prec->oevt);
    prt->papFldDes[swaitRecordOEVT]->offset = (unsigned short)offsetof(swaitRecord, oevt);
    prt->papFldDes[swaitRecordADEL]->size = sizeof(prec->adel);
    prt->papFldDes[swaitRecordADEL]->offset = (unsigned short)offsetof(swaitRecord, adel);
    prt->papFldDes[swaitRecordMDEL]->size = sizeof(prec->mdel);
    prt->papFldDes[swaitRecordMDEL]->offset = (unsigned short)offsetof(swaitRecord, mdel);
    prt->papFldDes[swaitRecordALST]->size = sizeof(prec->alst);
    prt->papFldDes[swaitRecordALST]->offset = (unsigned short)offsetof(swaitRecord, alst);
    prt->papFldDes[swaitRecordMLST]->size = sizeof(prec->mlst);
    prt->papFldDes[swaitRecordMLST]->offset = (unsigned short)offsetof(swaitRecord, mlst);
    prt->papFldDes[swaitRecordSIOL]->size = sizeof(prec->siol);
    prt->papFldDes[swaitRecordSIOL]->offset = (unsigned short)offsetof(swaitRecord, siol);
    prt->papFldDes[swaitRecordSVAL]->size = sizeof(prec->sval);
    prt->papFldDes[swaitRecordSVAL]->offset = (unsigned short)offsetof(swaitRecord, sval);
    prt->papFldDes[swaitRecordSIML]->size = sizeof(prec->siml);
    prt->papFldDes[swaitRecordSIML]->offset = (unsigned short)offsetof(swaitRecord, siml);
    prt->papFldDes[swaitRecordSIMM]->size = sizeof(prec->simm);
    prt->papFldDes[swaitRecordSIMM]->offset = (unsigned short)offsetof(swaitRecord, simm);
    prt->papFldDes[swaitRecordSIMS]->size = sizeof(prec->sims);
    prt->papFldDes[swaitRecordSIMS]->offset = (unsigned short)offsetof(swaitRecord, sims);
