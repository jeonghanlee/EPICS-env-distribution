...
static int sseqRecordSizeOffset(dbRecordType *prt)
{
    ...
    prt->papFldDes[sseqRecordNAME]->offset = (unsigned short)offsetof(sseqRecord, name);
    prt->papFldDes[sseqRecordDESC]->size = sizeof(prec->desc);
    prt->papFldDes[sseqRecordDESC]->offset = (unsigned short)offsetof(sseqRecord, desc);
    prt->papFldDes[sseqRecordASG]->size = sizeof(prec->asg);
    prt->papFldDes[sseqRecordASG]->offset = (unsigned short)offsetof(sseqRecord, asg);
    prt->papFldDes[sseqRecordSCAN]->size = sizeof(prec->scan);
    prt->papFldDes[sseqRecordSCAN]->offset = (unsigned short)offsetof(sseqRecord, scan);
    prt->papFldDes[sseqRecordPINI]->size = sizeof(prec->pini);
    prt->papFldDes[sseqRecordPINI]->offset = (unsigned short)offsetof(sseqRecord, pini);
    prt->papFldDes[sseqRecordPHAS]->size = sizeof(prec->phas);
    prt->papFldDes[sseqRecordPHAS]->offset = (unsigned short)offsetof(sseqRecord, phas);
    prt->papFldDes[sseqRecordEVNT]->size = sizeof(prec->evnt);
    prt->papFldDes[sseqRecordEVNT]->offset = (unsigned short)offsetof(sseqRecord, evnt);
    prt->papFldDes[sseqRecordTSE]->size = sizeof(prec->tse);
    prt->papFldDes[sseqRecordTSE]->offset = (unsigned short)offsetof(sseqRecord, tse);
    prt->papFldDes[sseqRecordTSEL]->size = sizeof(prec->tsel);
    prt->papFldDes[sseqRecordTSEL]->offset = (unsigned short)offsetof(sseqRecord, tsel);
    prt->papFldDes[sseqRecordDTYP]->size = sizeof(prec->dtyp);
    prt->papFldDes[sseqRecordDTYP]->offset = (unsigned short)offsetof(sseqRecord, dtyp);
    prt->papFldDes[sseqRecordDISV]->size = sizeof(prec->disv);
    prt->papFldDes[sseqRecordDISV]->offset = (unsigned short)offsetof(sseqRecord, disv);
    prt->papFldDes[sseqRecordDISA]->size = sizeof(prec->disa);
    prt->papFldDes[sseqRecordDISA]->offset = (unsigned short)offsetof(sseqRecord, disa);
    prt->papFldDes[sseqRecordSDIS]->size = sizeof(prec->sdis);
    prt->papFldDes[sseqRecordSDIS]->offset = (unsigned short)offsetof(sseqRecord, sdis);
    prt->papFldDes[sseqRecordMLOK]->size = sizeof(prec->mlok);
    prt->papFldDes[sseqRecordMLOK]->offset = (unsigned short)offsetof(sseqRecord, mlok);
    prt->papFldDes[sseqRecordMLIS]->size = sizeof(prec->mlis);
    prt->papFldDes[sseqRecordMLIS]->offset = (unsigned short)offsetof(sseqRecord, mlis);
    prt->papFldDes[sseqRecordBKLNK]->size = sizeof(prec->bklnk);
    prt->papFldDes[sseqRecordBKLNK]->offset = (unsigned short)offsetof(sseqRecord, bklnk);
    prt->papFldDes[sseqRecordDISP]->size = sizeof(prec->disp);
    prt->papFldDes[sseqRecordDISP]->offset = (unsigned short)offsetof(sseqRecord, disp);
    prt->papFldDes[sseqRecordPROC]->size = sizeof(prec->proc);
    prt->papFldDes[sseqRecordPROC]->offset = (unsigned short)offsetof(sseqRecord, proc);
    prt->papFldDes[sseqRecordSTAT]->size = sizeof(prec->stat);
    prt->papFldDes[sseqRecordSTAT]->offset = (unsigned short)offsetof(sseqRecord, stat);
    prt->papFldDes[sseqRecordSEVR]->size = sizeof(prec->sevr);
    prt->papFldDes[sseqRecordSEVR]->offset = (unsigned short)offsetof(sseqRecord, sevr);
    prt->papFldDes[sseqRecordAMSG]->size = sizeof(prec->amsg);
    prt->papFldDes[sseqRecordAMSG]->offset = (unsigned short)offsetof(sseqRecord, amsg);
    prt->papFldDes[sseqRecordNSTA]->size = sizeof(prec->nsta);
    prt->papFldDes[sseqRecordNSTA]->offset = (unsigned short)offsetof(sseqRecord, nsta);
    prt->papFldDes[sseqRecordNSEV]->size = sizeof(prec->nsev);
    prt->papFldDes[sseqRecordNSEV]->offset = (unsigned short)offsetof(sseqRecord, nsev);
    prt->papFldDes[sseqRecordNAMSG]->size = sizeof(prec->namsg);
    prt->papFldDes[sseqRecordNAMSG]->offset = (unsigned short)offsetof(sseqRecord, namsg);
    prt->papFldDes[sseqRecordACKS]->size = sizeof(prec->acks);
    prt->papFldDes[sseqRecordACKS]->offset = (unsigned short)offsetof(sseqRecord, acks);
    prt->papFldDes[sseqRecordACKT]->size = sizeof(prec->ackt);
    prt->papFldDes[sseqRecordACKT]->offset = (unsigned short)offsetof(sseqRecord, ackt);
    prt->papFldDes[sseqRecordDISS]->size = sizeof(prec->diss);
    prt->papFldDes[sseqRecordDISS]->offset = (unsigned short)offsetof(sseqRecord, diss);
    prt->papFldDes[sseqRecordLCNT]->size = sizeof(prec->lcnt);
    prt->papFldDes[sseqRecordLCNT]->offset = (unsigned short)offsetof(sseqRecord, lcnt);
    prt->papFldDes[sseqRecordPACT]->size = sizeof(prec->pact);
    prt->papFldDes[sseqRecordPACT]->offset = (unsigned short)offsetof(sseqRecord, pact);
    prt->papFldDes[sseqRecordPUTF]->size = sizeof(prec->putf);
    prt->papFldDes[sseqRecordPUTF]->offset = (unsigned short)offsetof(sseqRecord, putf);
    prt->papFldDes[sseqRecordRPRO]->size = sizeof(prec->rpro);
    prt->papFldDes[sseqRecordRPRO]->offset = (unsigned short)offsetof(sseqRecord, rpro);
    prt->papFldDes[sseqRecordASP]->size = sizeof(prec->asp);
    prt->papFldDes[sseqRecordASP]->offset = (unsigned short)offsetof(sseqRecord, asp);
    prt->papFldDes[sseqRecordPPN]->size = sizeof(prec->ppn);
    prt->papFldDes[sseqRecordPPN]->offset = (unsigned short)offsetof(sseqRecord, ppn);
    prt->papFldDes[sseqRecordPPNR]->size = sizeof(prec->ppnr);
    prt->papFldDes[sseqRecordPPNR]->offset = (unsigned short)offsetof(sseqRecord, ppnr);
    prt->papFldDes[sseqRecordSPVT]->size = sizeof(prec->spvt);
    prt->papFldDes[sseqRecordSPVT]->offset = (unsigned short)offsetof(sseqRecord, spvt);
    prt->papFldDes[sseqRecordRSET]->size = sizeof(prec->rset);
    prt->papFldDes[sseqRecordRSET]->offset = (unsigned short)offsetof(sseqRecord, rset);
    prt->papFldDes[sseqRecordDSET]->size = sizeof(prec->dset);
    prt->papFldDes[sseqRecordDSET]->offset = (unsigned short)offsetof(sseqRecord, dset);
    prt->papFldDes[sseqRecordDPVT]->size = sizeof(prec->dpvt);
    prt->papFldDes[sseqRecordDPVT]->offset = (unsigned short)offsetof(sseqRecord, dpvt);
    prt->papFldDes[sseqRecordRDES]->size = sizeof(prec->rdes);
    prt->papFldDes[sseqRecordRDES]->offset = (unsigned short)offsetof(sseqRecord, rdes);
    prt->papFldDes[sseqRecordLSET]->size = sizeof(prec->lset);
    prt->papFldDes[sseqRecordLSET]->offset = (unsigned short)offsetof(sseqRecord, lset);
    prt->papFldDes[sseqRecordPRIO]->size = sizeof(prec->prio);
    prt->papFldDes[sseqRecordPRIO]->offset = (unsigned short)offsetof(sseqRecord, prio);
    prt->papFldDes[sseqRecordTPRO]->size = sizeof(prec->tpro);
    prt->papFldDes[sseqRecordTPRO]->offset = (unsigned short)offsetof(sseqRecord, tpro);
    prt->papFldDes[sseqRecordBKPT]->size = sizeof(prec->bkpt);
    prt->papFldDes[sseqRecordBKPT]->offset = (unsigned short)offsetof(sseqRecord, bkpt);
    prt->papFldDes[sseqRecordUDF]->size = sizeof(prec->udf);
    prt->papFldDes[sseqRecordUDF]->offset = (unsigned short)offsetof(sseqRecord, udf);
    prt->papFldDes[sseqRecordUDFS]->size = sizeof(prec->udfs);
    prt->papFldDes[sseqRecordUDFS]->offset = (unsigned short)offsetof(sseqRecord, udfs);
    prt->papFldDes[sseqRecordTIME]->size = sizeof(prec->time);
    prt->papFldDes[sseqRecordTIME]->offset = (unsigned short)offsetof(sseqRecord, time);
    prt->papFldDes[sseqRecordUTAG]->size = sizeof(prec->utag);
    prt->papFldDes[sseqRecordUTAG]->offset = (unsigned short)offsetof(sseqRecord, utag);
    prt->papFldDes[sseqRecordFLNK]->size = sizeof(prec->flnk);
    prt->papFldDes[sseqRecordFLNK]->offset = (unsigned short)offsetof(sseqRecord, flnk);
    prt->papFldDes[sseqRecordVAL]->size = sizeof(prec->val);
    prt->papFldDes[sseqRecordVAL]->offset = (unsigned short)offsetof(sseqRecord, val);
    prt->papFldDes[sseqRecordSELM]->size = sizeof(prec->selm);
    prt->papFldDes[sseqRecordSELM]->offset = (unsigned short)offsetof(sseqRecord, selm);
    prt->papFldDes[sseqRecordSELN]->size = sizeof(prec->seln);
    prt->papFldDes[sseqRecordSELN]->offset = (unsigned short)offsetof(sseqRecord, seln);
    prt->papFldDes[sseqRecordSELL]->size = sizeof(prec->sell);
    prt->papFldDes[sseqRecordSELL]->offset = (unsigned short)offsetof(sseqRecord, sell);
    prt->papFldDes[sseqRecordPREC]->size = sizeof(prec->prec);
    prt->papFldDes[sseqRecordPREC]->offset = (unsigned short)offsetof(sseqRecord, prec);
    prt->papFldDes[sseqRecordDLY1]->size = sizeof(prec->dly1);
    prt->papFldDes[sseqRecordDLY1]->offset = (unsigned short)offsetof(sseqRecord, dly1);
    prt->papFldDes[sseqRecordDOL1]->size = sizeof(prec->dol1);
    prt->papFldDes[sseqRecordDOL1]->offset = (unsigned short)offsetof(sseqRecord, dol1);
    prt->papFldDes[sseqRecordDO1]->size = sizeof(prec->do1);
    prt->papFldDes[sseqRecordDO1]->offset = (unsigned short)offsetof(sseqRecord, do1);
    prt->papFldDes[sseqRecordLNK1]->size = sizeof(prec->lnk1);
    prt->papFldDes[sseqRecordLNK1]->offset = (unsigned short)offsetof(sseqRecord, lnk1);
    prt->papFldDes[sseqRecordSTR1]->size = sizeof(prec->str1);
    prt->papFldDes[sseqRecordSTR1]->offset = (unsigned short)offsetof(sseqRecord, str1);
    prt->papFldDes[sseqRecordDT1]->size = sizeof(prec->dt1);
    prt->papFldDes[sseqRecordDT1]->offset = (unsigned short)offsetof(sseqRecord, dt1);
    prt->papFldDes[sseqRecordLT1]->size = sizeof(prec->lt1);
    prt->papFldDes[sseqRecordLT1]->offset = (unsigned short)offsetof(sseqRecord, lt1);
    prt->papFldDes[sseqRecordWAIT1]->size = sizeof(prec->wait1);
    prt->papFldDes[sseqRecordWAIT1]->offset = (unsigned short)offsetof(sseqRecord, wait1);
    prt->papFldDes[sseqRecordWERR1]->size = sizeof(prec->werr1);
    prt->papFldDes[sseqRecordWERR1]->offset = (unsigned short)offsetof(sseqRecord, werr1);
    prt->papFldDes[sseqRecordWTG1]->size = sizeof(prec->wtg1);
    prt->papFldDes[sseqRecordWTG1]->offset = (unsigned short)offsetof(sseqRecord, wtg1);
    prt->papFldDes[sseqRecordIX1]->size = sizeof(prec->ix1);
    prt->papFldDes[sseqRecordIX1]->offset = (unsigned short)offsetof(sseqRecord, ix1);
    prt->papFldDes[sseqRecordDOL1V]->size = sizeof(prec->dol1v);
    prt->papFldDes[sseqRecordDOL1V]->offset = (unsigned short)offsetof(sseqRecord, dol1v);
    prt->papFldDes[sseqRecordLNK1V]->size = sizeof(prec->lnk1v);
    prt->papFldDes[sseqRecordLNK1V]->offset = (unsigned short)offsetof(sseqRecord, lnk1v);
    prt->papFldDes[sseqRecordDLY2]->size = sizeof(prec->dly2);
    prt->papFldDes[sseqRecordDLY2]->offset = (unsigned short)offsetof(sseqRecord, dly2);
    prt->papFldDes[sseqRecordDOL2]->size = sizeof(prec->dol2);
    prt->papFldDes[sseqRecordDOL2]->offset = (unsigned short)offsetof(sseqRecord, dol2);
    prt->papFldDes[sseqRecordDO2]->size = sizeof(prec->do2);
    prt->papFldDes[sseqRecordDO2]->offset = (unsigned short)offsetof(sseqRecord, do2);
    prt->papFldDes[sseqRecordLNK2]->size = sizeof(prec->lnk2);
    prt->papFldDes[sseqRecordLNK2]->offset = (unsigned short)offsetof(sseqRecord, lnk2);
    prt->papFldDes[sseqRecordSTR2]->size = sizeof(prec->str2);
    prt->papFldDes[sseqRecordSTR2]->offset = (unsigned short)offsetof(sseqRecord, str2);
    prt->papFldDes[sseqRecordDT2]->size = sizeof(prec->dt2);
    prt->papFldDes[sseqRecordDT2]->offset = (unsigned short)offsetof(sseqRecord, dt2);
    prt->papFldDes[sseqRecordLT2]->size = sizeof(prec->lt2);
    prt->papFldDes[sseqRecordLT2]->offset = (unsigned short)offsetof(sseqRecord, lt2);
    prt->papFldDes[sseqRecordWAIT2]->size = sizeof(prec->wait2);
    prt->papFldDes[sseqRecordWAIT2]->offset = (unsigned short)offsetof(sseqRecord, wait2);
    prt->papFldDes[sseqRecordWERR2]->size = sizeof(prec->werr2);
    prt->papFldDes[sseqRecordWERR2]->offset = (unsigned short)offsetof(sseqRecord, werr2);
    prt->papFldDes[sseqRecordWTG2]->size = sizeof(prec->wtg2);
    prt->papFldDes[sseqRecordWTG2]->offset = (unsigned short)offsetof(sseqRecord, wtg2);
    prt->papFldDes[sseqRecordIX2]->size = sizeof(prec->ix2);
    prt->papFldDes[sseqRecordIX2]->offset = (unsigned short)offsetof(sseqRecord, ix2);
    prt->papFldDes[sseqRecordDOL2V]->size = sizeof(prec->dol2v);
    prt->papFldDes[sseqRecordDOL2V]->offset = (unsigned short)offsetof(sseqRecord, dol2v);
    prt->papFldDes[sseqRecordLNK2V]->size = sizeof(prec->lnk2v);
    prt->papFldDes[sseqRecordLNK2V]->offset = (unsigned short)offsetof(sseqRecord, lnk2v);
    prt->papFldDes[sseqRecordDLY3]->size = sizeof(prec->dly3);
    prt->papFldDes[sseqRecordDLY3]->offset = (unsigned short)offsetof(sseqRecord, dly3);
    prt->papFldDes[sseqRecordDOL3]->size = sizeof(prec->dol3);
    prt->papFldDes[sseqRecordDOL3]->offset = (unsigned short)offsetof(sseqRecord, dol3);
    prt->papFldDes[sseqRecordDO3]->size = sizeof(prec->do3);
    prt->papFldDes[sseqRecordDO3]->offset = (unsigned short)offsetof(sseqRecord, do3);
    prt->papFldDes[sseqRecordLNK3]->size = sizeof(prec->lnk3);
    prt->papFldDes[sseqRecordLNK3]->offset = (unsigned short)offsetof(sseqRecord, lnk3);
    prt->papFldDes[sseqRecordSTR3]->size = sizeof(prec->str3);
    prt->papFldDes[sseqRecordSTR3]->offset = (unsigned short)offsetof(sseqRecord, str3);
    prt->papFldDes[sseqRecordDT3]->size = sizeof(prec->dt3);
    prt->papFldDes[sseqRecordDT3]->offset = (unsigned short)offsetof(sseqRecord, dt3);
    prt->papFldDes[sseqRecordLT3]->size = sizeof(prec->lt3);
    prt->papFldDes[sseqRecordLT3]->offset = (unsigned short)offsetof(sseqRecord, lt3);
    prt->papFldDes[sseqRecordWAIT3]->size = sizeof(prec->wait3);
    prt->papFldDes[sseqRecordWAIT3]->offset = (unsigned short)offsetof(sseqRecord, wait3);
    prt->papFldDes[sseqRecordWERR3]->size = sizeof(prec->werr3);
    prt->papFldDes[sseqRecordWERR3]->offset = (unsigned short)offsetof(sseqRecord, werr3);
    prt->papFldDes[sseqRecordWTG3]->size = sizeof(prec->wtg3);
    prt->papFldDes[sseqRecordWTG3]->offset = (unsigned short)offsetof(sseqRecord, wtg3);
    prt->papFldDes[sseqRecordIX3]->size = sizeof(prec->ix3);
    prt->papFldDes[sseqRecordIX3]->offset = (unsigned short)offsetof(sseqRecord, ix3);
    prt->papFldDes[sseqRecordDOL3V]->size = sizeof(prec->dol3v);
    prt->papFldDes[sseqRecordDOL3V]->offset = (unsigned short)offsetof(sseqRecord, dol3v);
    prt->papFldDes[sseqRecordLNK3V]->size = sizeof(prec->lnk3v);
    prt->papFldDes[sseqRecordLNK3V]->offset = (unsigned short)offsetof(sseqRecord, lnk3v);
    prt->papFldDes[sseqRecordDLY4]->size = sizeof(prec->dly4);
    prt->papFldDes[sseqRecordDLY4]->offset = (unsigned short)offsetof(sseqRecord, dly4);
    prt->papFldDes[sseqRecordDOL4]->size = sizeof(prec->dol4);
    prt->papFldDes[sseqRecordDOL4]->offset = (unsigned short)offsetof(sseqRecord, dol4);
    prt->papFldDes[sseqRecordDO4]->size = sizeof(prec->do4);
    prt->papFldDes[sseqRecordDO4]->offset = (unsigned short)offsetof(sseqRecord, do4);
    prt->papFldDes[sseqRecordLNK4]->size = sizeof(prec->lnk4);
    prt->papFldDes[sseqRecordLNK4]->offset = (unsigned short)offsetof(sseqRecord, lnk4);
    prt->papFldDes[sseqRecordSTR4]->size = sizeof(prec->str4);
    prt->papFldDes[sseqRecordSTR4]->offset = (unsigned short)offsetof(sseqRecord, str4);
    prt->papFldDes[sseqRecordDT4]->size = sizeof(prec->dt4);
    prt->papFldDes[sseqRecordDT4]->offset = (unsigned short)offsetof(sseqRecord, dt4);
    prt->papFldDes[sseqRecordLT4]->size = sizeof(prec->lt4);
    prt->papFldDes[sseqRecordLT4]->offset = (unsigned short)offsetof(sseqRecord, lt4);
    prt->papFldDes[sseqRecordWAIT4]->size = sizeof(prec->wait4);
    prt->papFldDes[sseqRecordWAIT4]->offset = (unsigned short)offsetof(sseqRecord, wait4);
    prt->papFldDes[sseqRecordWERR4]->size = sizeof(prec->werr4);
    prt->papFldDes[sseqRecordWERR4]->offset = (unsigned short)offsetof(sseqRecord, werr4);
    prt->papFldDes[sseqRecordWTG4]->size = sizeof(prec->wtg4);
    prt->papFldDes[sseqRecordWTG4]->offset = (unsigned short)offsetof(sseqRecord, wtg4);
    prt->papFldDes[sseqRecordIX4]->size = sizeof(prec->ix4);
    prt->papFldDes[sseqRecordIX4]->offset = (unsigned short)offsetof(sseqRecord, ix4);
    prt->papFldDes[sseqRecordDOL4V]->size = sizeof(prec->dol4v);
    prt->papFldDes[sseqRecordDOL4V]->offset = (unsigned short)offsetof(sseqRecord, dol4v);
    prt->papFldDes[sseqRecordLNK4V]->size = sizeof(prec->lnk4v);
    prt->papFldDes[sseqRecordLNK4V]->offset = (unsigned short)offsetof(sseqRecord, lnk4v);
    prt->papFldDes[sseqRecordDLY5]->size = sizeof(prec->dly5);
    prt->papFldDes[sseqRecordDLY5]->offset = (unsigned short)offsetof(sseqRecord, dly5);
    prt->papFldDes[sseqRecordDOL5]->size = sizeof(prec->dol5);
    prt->papFldDes[sseqRecordDOL5]->offset = (unsigned short)offsetof(sseqRecord, dol5);
    prt->papFldDes[sseqRecordDO5]->size = sizeof(prec->do5);
    prt->papFldDes[sseqRecordDO5]->offset = (unsigned short)offsetof(sseqRecord, do5);
    prt->papFldDes[sseqRecordLNK5]->size = sizeof(prec->lnk5);
    prt->papFldDes[sseqRecordLNK5]->offset = (unsigned short)offsetof(sseqRecord, lnk5);
    prt->papFldDes[sseqRecordSTR5]->size = sizeof(prec->str5);
    prt->papFldDes[sseqRecordSTR5]->offset = (unsigned short)offsetof(sseqRecord, str5);
    prt->papFldDes[sseqRecordDT5]->size = sizeof(prec->dt5);
    prt->papFldDes[sseqRecordDT5]->offset = (unsigned short)offsetof(sseqRecord, dt5);
    prt->papFldDes[sseqRecordLT5]->size = sizeof(prec->lt5);
    prt->papFldDes[sseqRecordLT5]->offset = (unsigned short)offsetof(sseqRecord, lt5);
    prt->papFldDes[sseqRecordWAIT5]->size = sizeof(prec->wait5);
    prt->papFldDes[sseqRecordWAIT5]->offset = (unsigned short)offsetof(sseqRecord, wait5);
    prt->papFldDes[sseqRecordWERR5]->size = sizeof(prec->werr5);
    prt->papFldDes[sseqRecordWERR5]->offset = (unsigned short)offsetof(sseqRecord, werr5);
    prt->papFldDes[sseqRecordWTG5]->size = sizeof(prec->wtg5);
    prt->papFldDes[sseqRecordWTG5]->offset = (unsigned short)offsetof(sseqRecord, wtg5);
    prt->papFldDes[sseqRecordIX5]->size = sizeof(prec->ix5);
    prt->papFldDes[sseqRecordIX5]->offset = (unsigned short)offsetof(sseqRecord, ix5);
    prt->papFldDes[sseqRecordDOL5V]->size = sizeof(prec->dol5v);
    prt->papFldDes[sseqRecordDOL5V]->offset = (unsigned short)offsetof(sseqRecord, dol5v);
    prt->papFldDes[sseqRecordLNK5V]->size = sizeof(prec->lnk5v);
    prt->papFldDes[sseqRecordLNK5V]->offset = (unsigned short)offsetof(sseqRecord, lnk5v);
    prt->papFldDes[sseqRecordDLY6]->size = sizeof(prec->dly6);
    prt->papFldDes[sseqRecordDLY6]->offset = (unsigned short)offsetof(sseqRecord, dly6);
    prt->papFldDes[sseqRecordDOL6]->size = sizeof(prec->dol6);
    prt->papFldDes[sseqRecordDOL6]->offset = (unsigned short)offsetof(sseqRecord, dol6);
    prt->papFldDes[sseqRecordDO6]->size = sizeof(prec->do6);
    prt->papFldDes[sseqRecordDO6]->offset = (unsigned short)offsetof(sseqRecord, do6);
    prt->papFldDes[sseqRecordLNK6]->size = sizeof(prec->lnk6);
    prt->papFldDes[sseqRecordLNK6]->offset = (unsigned short)offsetof(sseqRecord, lnk6);
    prt->papFldDes[sseqRecordSTR6]->size = sizeof(prec->str6);
    prt->papFldDes[sseqRecordSTR6]->offset = (unsigned short)offsetof(sseqRecord, str6);
    prt->papFldDes[sseqRecordDT6]->size = sizeof(prec->dt6);
    prt->papFldDes[sseqRecordDT6]->offset = (unsigned short)offsetof(sseqRecord, dt6);
    prt->papFldDes[sseqRecordLT6]->size = sizeof(prec->lt6);
    prt->papFldDes[sseqRecordLT6]->offset = (unsigned short)offsetof(sseqRecord, lt6);
    prt->papFldDes[sseqRecordWAIT6]->size = sizeof(prec->wait6);
    prt->papFldDes[sseqRecordWAIT6]->offset = (unsigned short)offsetof(sseqRecord, wait6);
    prt->papFldDes[sseqRecordWERR6]->size = sizeof(prec->werr6);
    prt->papFldDes[sseqRecordWERR6]->offset = (unsigned short)offsetof(sseqRecord, werr6);
    prt->papFldDes[sseqRecordWTG6]->size = sizeof(prec->wtg6);
    prt->papFldDes[sseqRecordWTG6]->offset = (unsigned short)offsetof(sseqRecord, wtg6);
    prt->papFldDes[sseqRecordIX6]->size = sizeof(prec->ix6);
    prt->papFldDes[sseqRecordIX6]->offset = (unsigned short)offsetof(sseqRecord, ix6);
    prt->papFldDes[sseqRecordDOL6V]->size = sizeof(prec->dol6v);
    prt->papFldDes[sseqRecordDOL6V]->offset = (unsigned short)offsetof(sseqRecord, dol6v);
    prt->papFldDes[sseqRecordLNK6V]->size = sizeof(prec->lnk6v);
    prt->papFldDes[sseqRecordLNK6V]->offset = (unsigned short)offsetof(sseqRecord, lnk6v);
    prt->papFldDes[sseqRecordDLY7]->size = sizeof(prec->dly7);
    prt->papFldDes[sseqRecordDLY7]->offset = (unsigned short)offsetof(sseqRecord, dly7);
    prt->papFldDes[sseqRecordDOL7]->size = sizeof(prec->dol7);
    prt->papFldDes[sseqRecordDOL7]->offset = (unsigned short)offsetof(sseqRecord, dol7);
    prt->papFldDes[sseqRecordDO7]->size = sizeof(prec->do7);
    prt->papFldDes[sseqRecordDO7]->offset = (unsigned short)offsetof(sseqRecord, do7);
    prt->papFldDes[sseqRecordLNK7]->size = sizeof(prec->lnk7);
    prt->papFldDes[sseqRecordLNK7]->offset = (unsigned short)offsetof(sseqRecord, lnk7);
    prt->papFldDes[sseqRecordSTR7]->size = sizeof(prec->str7);
    prt->papFldDes[sseqRecordSTR7]->offset = (unsigned short)offsetof(sseqRecord, str7);
    prt->papFldDes[sseqRecordDT7]->size = sizeof(prec->dt7);
    prt->papFldDes[sseqRecordDT7]->offset = (unsigned short)offsetof(sseqRecord, dt7);
    prt->papFldDes[sseqRecordLT7]->size = sizeof(prec->lt7);
    prt->papFldDes[sseqRecordLT7]->offset = (unsigned short)offsetof(sseqRecord, lt7);
    prt->papFldDes[sseqRecordWAIT7]->size = sizeof(prec->wait7);
    prt->papFldDes[sseqRecordWAIT7]->offset = (unsigned short)offsetof(sseqRecord, wait7);
    prt->papFldDes[sseqRecordWERR7]->size = sizeof(prec->werr7);
    prt->papFldDes[sseqRecordWERR7]->offset = (unsigned short)offsetof(sseqRecord, werr7);
    prt->papFldDes[sseqRecordWTG7]->size = sizeof(prec->wtg7);
    prt->papFldDes[sseqRecordWTG7]->offset = (unsigned short)offsetof(sseqRecord, wtg7);
    prt->papFldDes[sseqRecordIX7]->size = sizeof(prec->ix7);
    prt->papFldDes[sseqRecordIX7]->offset = (unsigned short)offsetof(sseqRecord, ix7);
    prt->papFldDes[sseqRecordDOL7V]->size = sizeof(prec->dol7v);
    prt->papFldDes[sseqRecordDOL7V]->offset = (unsigned short)offsetof(sseqRecord, dol7v);
    prt->papFldDes[sseqRecordLNK7V]->size = sizeof(prec->lnk7v);
    prt->papFldDes[sseqRecordLNK7V]->offset = (unsigned short)offsetof(sseqRecord, lnk7v);
    prt->papFldDes[sseqRecordDLY8]->size = sizeof(prec->dly8);
    prt->papFldDes[sseqRecordDLY8]->offset = (unsigned short)offsetof(sseqRecord, dly8);
    prt->papFldDes[sseqRecordDOL8]->size = sizeof(prec->dol8);
    prt->papFldDes[sseqRecordDOL8]->offset = (unsigned short)offsetof(sseqRecord, dol8);
    prt->papFldDes[sseqRecordDO8]->size = sizeof(prec->do8);
    prt->papFldDes[sseqRecordDO8]->offset = (unsigned short)offsetof(sseqRecord, do8);
    prt->papFldDes[sseqRecordLNK8]->size = sizeof(prec->lnk8);
    prt->papFldDes[sseqRecordLNK8]->offset = (unsigned short)offsetof(sseqRecord, lnk8);
    prt->papFldDes[sseqRecordSTR8]->size = sizeof(prec->str8);
    prt->papFldDes[sseqRecordSTR8]->offset = (unsigned short)offsetof(sseqRecord, str8);
    prt->papFldDes[sseqRecordDT8]->size = sizeof(prec->dt8);
    prt->papFldDes[sseqRecordDT8]->offset = (unsigned short)offsetof(sseqRecord, dt8);
    prt->papFldDes[sseqRecordLT8]->size = sizeof(prec->lt8);
    prt->papFldDes[sseqRecordLT8]->offset = (unsigned short)offsetof(sseqRecord, lt8);
    prt->papFldDes[sseqRecordWAIT8]->size = sizeof(prec->wait8);
    prt->papFldDes[sseqRecordWAIT8]->offset = (unsigned short)offsetof(sseqRecord, wait8);
    prt->papFldDes[sseqRecordWERR8]->size = sizeof(prec->werr8);
    prt->papFldDes[sseqRecordWERR8]->offset = (unsigned short)offsetof(sseqRecord, werr8);
    prt->papFldDes[sseqRecordWTG8]->size = sizeof(prec->wtg8);
    prt->papFldDes[sseqRecordWTG8]->offset = (unsigned short)offsetof(sseqRecord, wtg8);
    prt->papFldDes[sseqRecordIX8]->size = sizeof(prec->ix8);
    prt->papFldDes[sseqRecordIX8]->offset = (unsigned short)offsetof(sseqRecord, ix8);
    prt->papFldDes[sseqRecordDOL8V]->size = sizeof(prec->dol8v);
    prt->papFldDes[sseqRecordDOL8V]->offset = (unsigned short)offsetof(sseqRecord, dol8v);
    prt->papFldDes[sseqRecordLNK8V]->size = sizeof(prec->lnk8v);
    prt->papFldDes[sseqRecordLNK8V]->offset = (unsigned short)offsetof(sseqRecord, lnk8v);
    prt->papFldDes[sseqRecordDLY9]->size = sizeof(prec->dly9);
    prt->papFldDes[sseqRecordDLY9]->offset = (unsigned short)offsetof(sseqRecord, dly9);
    prt->papFldDes[sseqRecordDOL9]->size = sizeof(prec->dol9);
    prt->papFldDes[sseqRecordDOL9]->offset = (unsigned short)offsetof(sseqRecord, dol9);
    prt->papFldDes[sseqRecordDO9]->size = sizeof(prec->do9);
    prt->papFldDes[sseqRecordDO9]->offset = (unsigned short)offsetof(sseqRecord, do9);
    prt->papFldDes[sseqRecordLNK9]->size = sizeof(prec->lnk9);
    prt->papFldDes[sseqRecordLNK9]->offset = (unsigned short)offsetof(sseqRecord, lnk9);
    prt->papFldDes[sseqRecordSTR9]->size = sizeof(prec->str9);
    prt->papFldDes[sseqRecordSTR9]->offset = (unsigned short)offsetof(sseqRecord, str9);
    prt->papFldDes[sseqRecordDT9]->size = sizeof(prec->dt9);
    prt->papFldDes[sseqRecordDT9]->offset = (unsigned short)offsetof(sseqRecord, dt9);
    prt->papFldDes[sseqRecordLT9]->size = sizeof(prec->lt9);
    prt->papFldDes[sseqRecordLT9]->offset = (unsigned short)offsetof(sseqRecord, lt9);
    prt->papFldDes[sseqRecordWAIT9]->size = sizeof(prec->wait9);
    prt->papFldDes[sseqRecordWAIT9]->offset = (unsigned short)offsetof(sseqRecord, wait9);
    prt->papFldDes[sseqRecordWERR9]->size = sizeof(prec->werr9);
    prt->papFldDes[sseqRecordWERR9]->offset = (unsigned short)offsetof(sseqRecord, werr9);
    prt->papFldDes[sseqRecordWTG9]->size = sizeof(prec->wtg9);
    prt->papFldDes[sseqRecordWTG9]->offset = (unsigned short)offsetof(sseqRecord, wtg9);
    prt->papFldDes[sseqRecordIX9]->size = sizeof(prec->ix9);
    prt->papFldDes[sseqRecordIX9]->offset = (unsigned short)offsetof(sseqRecord, ix9);
    prt->papFldDes[sseqRecordDOL9V]->size = sizeof(prec->dol9v);
    prt->papFldDes[sseqRecordDOL9V]->offset = (unsigned short)offsetof(sseqRecord, dol9v);
    prt->papFldDes[sseqRecordLNK9V]->size = sizeof(prec->lnk9v);
    prt->papFldDes[sseqRecordLNK9V]->offset = (unsigned short)offsetof(sseqRecord, lnk9v);
    prt->papFldDes[sseqRecordDLYA]->size = sizeof(prec->dlya);
    prt->papFldDes[sseqRecordDLYA]->offset = (unsigned short)offsetof(sseqRecord, dlya);
    prt->papFldDes[sseqRecordDOLA]->size = sizeof(prec->dola);
    prt->papFldDes[sseqRecordDOLA]->offset = (unsigned short)offsetof(sseqRecord, dola);
    prt->papFldDes[sseqRecordDOA]->size = sizeof(prec->doa);
    prt->papFldDes[sseqRecordDOA]->offset = (unsigned short)offsetof(sseqRecord, doa);
    prt->papFldDes[sseqRecordLNKA]->size = sizeof(prec->lnka);
    prt->papFldDes[sseqRecordLNKA]->offset = (unsigned short)offsetof(sseqRecord, lnka);
    prt->papFldDes[sseqRecordSTRA]->size = sizeof(prec->stra);
    prt->papFldDes[sseqRecordSTRA]->offset = (unsigned short)offsetof(sseqRecord, stra);
    prt->papFldDes[sseqRecordDTA]->size = sizeof(prec->dta);
    prt->papFldDes[sseqRecordDTA]->offset = (unsigned short)offsetof(sseqRecord, dta);
    prt->papFldDes[sseqRecordLTA]->size = sizeof(prec->lta);
    prt->papFldDes[sseqRecordLTA]->offset = (unsigned short)offsetof(sseqRecord, lta);
    prt->papFldDes[sseqRecordWAITA]->size = sizeof(prec->waita);
    prt->papFldDes[sseqRecordWAITA]->offset = (unsigned short)offsetof(sseqRecord, waita);
    prt->papFldDes[sseqRecordWERRA]->size = sizeof(prec->werra);
    prt->papFldDes[sseqRecordWERRA]->offset = (unsigned short)offsetof(sseqRecord, werra);
    prt->papFldDes[sseqRecordWTGA]->size = sizeof(prec->wtga);
    prt->papFldDes[sseqRecordWTGA]->offset = (unsigned short)offsetof(sseqRecord, wtga);
    prt->papFldDes[sseqRecordIXA]->size = sizeof(prec->ixa);
    prt->papFldDes[sseqRecordIXA]->offset = (unsigned short)offsetof(sseqRecord, ixa);
    prt->papFldDes[sseqRecordDOLAV]->size = sizeof(prec->dolav);
    prt->papFldDes[sseqRecordDOLAV]->offset = (unsigned short)offsetof(sseqRecord, dolav);
    prt->papFldDes[sseqRecordLNKAV]->size = sizeof(prec->lnkav);
    prt->papFldDes[sseqRecordLNKAV]->offset = (unsigned short)offsetof(sseqRecord, lnkav);
    prt->papFldDes[sseqRecordABORT]->size = sizeof(prec->abort);
    prt->papFldDes[sseqRecordABORT]->offset = (unsigned short)offsetof(sseqRecord, abort);
    prt->papFldDes[sseqRecordABORTING]->size = sizeof(prec->aborting);
    prt->papFldDes[sseqRecordABORTING]->offset = (unsigned short)offsetof(sseqRecord, aborting);
    prt->papFldDes[sseqRecordBUSY]->size = sizeof(prec->busy);
    prt->papFldDes[sseqRecordBUSY]->offset = (unsigned short)offsetof(sseqRecord, busy);
