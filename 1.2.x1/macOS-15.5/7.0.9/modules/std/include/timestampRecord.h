...
static int timestampRecordSizeOffset(dbRecordType *prt)
{
    ...
    prt->papFldDes[timestampRecordNAME]->offset = (unsigned short)offsetof(timestampRecord, name);
    prt->papFldDes[timestampRecordDESC]->size = sizeof(prec->desc);
    prt->papFldDes[timestampRecordDESC]->offset = (unsigned short)offsetof(timestampRecord, desc);
    prt->papFldDes[timestampRecordASG]->size = sizeof(prec->asg);
    prt->papFldDes[timestampRecordASG]->offset = (unsigned short)offsetof(timestampRecord, asg);
    prt->papFldDes[timestampRecordSCAN]->size = sizeof(prec->scan);
    prt->papFldDes[timestampRecordSCAN]->offset = (unsigned short)offsetof(timestampRecord, scan);
    prt->papFldDes[timestampRecordPINI]->size = sizeof(prec->pini);
    prt->papFldDes[timestampRecordPINI]->offset = (unsigned short)offsetof(timestampRecord, pini);
    prt->papFldDes[timestampRecordPHAS]->size = sizeof(prec->phas);
    prt->papFldDes[timestampRecordPHAS]->offset = (unsigned short)offsetof(timestampRecord, phas);
    prt->papFldDes[timestampRecordEVNT]->size = sizeof(prec->evnt);
    prt->papFldDes[timestampRecordEVNT]->offset = (unsigned short)offsetof(timestampRecord, evnt);
    prt->papFldDes[timestampRecordTSE]->size = sizeof(prec->tse);
    prt->papFldDes[timestampRecordTSE]->offset = (unsigned short)offsetof(timestampRecord, tse);
    prt->papFldDes[timestampRecordTSEL]->size = sizeof(prec->tsel);
    prt->papFldDes[timestampRecordTSEL]->offset = (unsigned short)offsetof(timestampRecord, tsel);
    prt->papFldDes[timestampRecordDTYP]->size = sizeof(prec->dtyp);
    prt->papFldDes[timestampRecordDTYP]->offset = (unsigned short)offsetof(timestampRecord, dtyp);
    prt->papFldDes[timestampRecordDISV]->size = sizeof(prec->disv);
    prt->papFldDes[timestampRecordDISV]->offset = (unsigned short)offsetof(timestampRecord, disv);
    prt->papFldDes[timestampRecordDISA]->size = sizeof(prec->disa);
    prt->papFldDes[timestampRecordDISA]->offset = (unsigned short)offsetof(timestampRecord, disa);
    prt->papFldDes[timestampRecordSDIS]->size = sizeof(prec->sdis);
    prt->papFldDes[timestampRecordSDIS]->offset = (unsigned short)offsetof(timestampRecord, sdis);
    prt->papFldDes[timestampRecordMLOK]->size = sizeof(prec->mlok);
    prt->papFldDes[timestampRecordMLOK]->offset = (unsigned short)offsetof(timestampRecord, mlok);
    prt->papFldDes[timestampRecordMLIS]->size = sizeof(prec->mlis);
    prt->papFldDes[timestampRecordMLIS]->offset = (unsigned short)offsetof(timestampRecord, mlis);
    prt->papFldDes[timestampRecordBKLNK]->size = sizeof(prec->bklnk);
    prt->papFldDes[timestampRecordBKLNK]->offset = (unsigned short)offsetof(timestampRecord, bklnk);
    prt->papFldDes[timestampRecordDISP]->size = sizeof(prec->disp);
    prt->papFldDes[timestampRecordDISP]->offset = (unsigned short)offsetof(timestampRecord, disp);
    prt->papFldDes[timestampRecordPROC]->size = sizeof(prec->proc);
    prt->papFldDes[timestampRecordPROC]->offset = (unsigned short)offsetof(timestampRecord, proc);
    prt->papFldDes[timestampRecordSTAT]->size = sizeof(prec->stat);
    prt->papFldDes[timestampRecordSTAT]->offset = (unsigned short)offsetof(timestampRecord, stat);
    prt->papFldDes[timestampRecordSEVR]->size = sizeof(prec->sevr);
    prt->papFldDes[timestampRecordSEVR]->offset = (unsigned short)offsetof(timestampRecord, sevr);
    prt->papFldDes[timestampRecordAMSG]->size = sizeof(prec->amsg);
    prt->papFldDes[timestampRecordAMSG]->offset = (unsigned short)offsetof(timestampRecord, amsg);
    prt->papFldDes[timestampRecordNSTA]->size = sizeof(prec->nsta);
    prt->papFldDes[timestampRecordNSTA]->offset = (unsigned short)offsetof(timestampRecord, nsta);
    prt->papFldDes[timestampRecordNSEV]->size = sizeof(prec->nsev);
    prt->papFldDes[timestampRecordNSEV]->offset = (unsigned short)offsetof(timestampRecord, nsev);
    prt->papFldDes[timestampRecordNAMSG]->size = sizeof(prec->namsg);
    prt->papFldDes[timestampRecordNAMSG]->offset = (unsigned short)offsetof(timestampRecord, namsg);
    prt->papFldDes[timestampRecordACKS]->size = sizeof(prec->acks);
    prt->papFldDes[timestampRecordACKS]->offset = (unsigned short)offsetof(timestampRecord, acks);
    prt->papFldDes[timestampRecordACKT]->size = sizeof(prec->ackt);
    prt->papFldDes[timestampRecordACKT]->offset = (unsigned short)offsetof(timestampRecord, ackt);
    prt->papFldDes[timestampRecordDISS]->size = sizeof(prec->diss);
    prt->papFldDes[timestampRecordDISS]->offset = (unsigned short)offsetof(timestampRecord, diss);
    prt->papFldDes[timestampRecordLCNT]->size = sizeof(prec->lcnt);
    prt->papFldDes[timestampRecordLCNT]->offset = (unsigned short)offsetof(timestampRecord, lcnt);
    prt->papFldDes[timestampRecordPACT]->size = sizeof(prec->pact);
    prt->papFldDes[timestampRecordPACT]->offset = (unsigned short)offsetof(timestampRecord, pact);
    prt->papFldDes[timestampRecordPUTF]->size = sizeof(prec->putf);
    prt->papFldDes[timestampRecordPUTF]->offset = (unsigned short)offsetof(timestampRecord, putf);
    prt->papFldDes[timestampRecordRPRO]->size = sizeof(prec->rpro);
    prt->papFldDes[timestampRecordRPRO]->offset = (unsigned short)offsetof(timestampRecord, rpro);
    prt->papFldDes[timestampRecordASP]->size = sizeof(prec->asp);
    prt->papFldDes[timestampRecordASP]->offset = (unsigned short)offsetof(timestampRecord, asp);
    prt->papFldDes[timestampRecordPPN]->size = sizeof(prec->ppn);
    prt->papFldDes[timestampRecordPPN]->offset = (unsigned short)offsetof(timestampRecord, ppn);
    prt->papFldDes[timestampRecordPPNR]->size = sizeof(prec->ppnr);
    prt->papFldDes[timestampRecordPPNR]->offset = (unsigned short)offsetof(timestampRecord, ppnr);
    prt->papFldDes[timestampRecordSPVT]->size = sizeof(prec->spvt);
    prt->papFldDes[timestampRecordSPVT]->offset = (unsigned short)offsetof(timestampRecord, spvt);
    prt->papFldDes[timestampRecordRSET]->size = sizeof(prec->rset);
    prt->papFldDes[timestampRecordRSET]->offset = (unsigned short)offsetof(timestampRecord, rset);
    prt->papFldDes[timestampRecordDSET]->size = sizeof(prec->dset);
    prt->papFldDes[timestampRecordDSET]->offset = (unsigned short)offsetof(timestampRecord, dset);
    prt->papFldDes[timestampRecordDPVT]->size = sizeof(prec->dpvt);
    prt->papFldDes[timestampRecordDPVT]->offset = (unsigned short)offsetof(timestampRecord, dpvt);
    prt->papFldDes[timestampRecordRDES]->size = sizeof(prec->rdes);
    prt->papFldDes[timestampRecordRDES]->offset = (unsigned short)offsetof(timestampRecord, rdes);
    prt->papFldDes[timestampRecordLSET]->size = sizeof(prec->lset);
    prt->papFldDes[timestampRecordLSET]->offset = (unsigned short)offsetof(timestampRecord, lset);
    prt->papFldDes[timestampRecordPRIO]->size = sizeof(prec->prio);
    prt->papFldDes[timestampRecordPRIO]->offset = (unsigned short)offsetof(timestampRecord, prio);
    prt->papFldDes[timestampRecordTPRO]->size = sizeof(prec->tpro);
    prt->papFldDes[timestampRecordTPRO]->offset = (unsigned short)offsetof(timestampRecord, tpro);
    prt->papFldDes[timestampRecordBKPT]->size = sizeof(prec->bkpt);
    prt->papFldDes[timestampRecordBKPT]->offset = (unsigned short)offsetof(timestampRecord, bkpt);
    prt->papFldDes[timestampRecordUDF]->size = sizeof(prec->udf);
    prt->papFldDes[timestampRecordUDF]->offset = (unsigned short)offsetof(timestampRecord, udf);
    prt->papFldDes[timestampRecordUDFS]->size = sizeof(prec->udfs);
    prt->papFldDes[timestampRecordUDFS]->offset = (unsigned short)offsetof(timestampRecord, udfs);
    prt->papFldDes[timestampRecordTIME]->size = sizeof(prec->time);
    prt->papFldDes[timestampRecordTIME]->offset = (unsigned short)offsetof(timestampRecord, time);
    prt->papFldDes[timestampRecordUTAG]->size = sizeof(prec->utag);
    prt->papFldDes[timestampRecordUTAG]->offset = (unsigned short)offsetof(timestampRecord, utag);
    prt->papFldDes[timestampRecordFLNK]->size = sizeof(prec->flnk);
    prt->papFldDes[timestampRecordFLNK]->offset = (unsigned short)offsetof(timestampRecord, flnk);
    prt->papFldDes[timestampRecordVAL]->size = sizeof(prec->val);
    prt->papFldDes[timestampRecordVAL]->offset = (unsigned short)offsetof(timestampRecord, val);
    prt->papFldDes[timestampRecordOVAL]->size = sizeof(prec->oval);
    prt->papFldDes[timestampRecordOVAL]->offset = (unsigned short)offsetof(timestampRecord, oval);
    prt->papFldDes[timestampRecordRVAL]->size = sizeof(prec->rval);
    prt->papFldDes[timestampRecordRVAL]->offset = (unsigned short)offsetof(timestampRecord, rval);
    prt->papFldDes[timestampRecordTST]->size = sizeof(prec->tst);
    prt->papFldDes[timestampRecordTST]->offset = (unsigned short)offsetof(timestampRecord, tst);
